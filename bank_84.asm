...
fUnknown_848000:
  ...
  - PHX                                                        ;848005|DA      |      ;
    TXA                                                        ;848006|8A      |      ;
    JSL.L fUnknown_84887C                                      ;848007|227C8884|84887C;
    SEP #$20                                                   ;84800B|E220    |      ;
    REP #$10                                                   ;84800D|C210    |      ;
...
fUnknown_848020:
    REP #$30                                                   ;848020|C230    |      ;
    JSL.L fUnknown_84887C                                      ;848022|227C8884|84887C;
    SEP #$20                                                   ;848026|E220    |      ;
    REP #$10                                                   ;848028|C210    |      ;
...
fUnknown_84803F:
    ...
    REP #$30                                                   ;848045|C230    |      ;
    STX.B nTempVar1                                            ;848047|867E    |00007E;
    ...
    REP #$20                                                   ;84805E|C220    |      ;
    LDA.B nTempVar1                                            ;848060|A57E    |00007E;
    ASL A                                                      ;848062|0A      |      ;
    CLC                                                        ;848063|18      |      ;
    ADC.B nTempVar1                                            ;848064|657E    |00007E;
    TAY                                                        ;848066|A8      |      ;
    ...
    JSR.W fUnknown_848961                                      ;848093|206189  |848961;
    RTL                                                        ;848096|6B      |      ;
...
fUnknown_848097:
    REP #$30                                                   ;848097|C230    |      ;
    PHA                                                        ;848099|48      |      ;
    JSL.L fUnknown_84887C                                      ;84809A|227C8884|84887C;
    REP #$30                                                   ;84809E|C230    |      ;
    STX.B nTempVar1                                            ;8480A0|867E    |00007E;
    ...
    REP #$20                                                   ;8480B7|C220    |      ;
    LDA.B nTempVar1                                            ;8480B9|A57E    |00007E;
    ASL A                                                      ;8480BB|0A      |      ;
    CLC                                                        ;8480BC|18      |      ;
    ADC.B nTempVar1                                            ;8480BD|657E    |00007E;
    TAY                                                        ;8480BF|A8      |      ;
    ...
    JSR.W fUnknown_8488D4                                      ;8480E8|20D488  |8488D4;
    REP #$30                                                   ;8480EB|C230    |      ;
    PLA                                                        ;8480ED|68      |      ;
    SEP #$20                                                   ;8480EE|E220    |      ;
    REP #$10                                                   ;8480F0|C210    |      ;
...
fUnknown_8480F8:
    REP #$30                                                   ;8480F8|C230    |      ;
    PHA                                                        ;8480FA|48      |      ;
    JSL.L fUnknown_84887C                                      ;8480FB|227C8884|84887C;
    REP #$30                                                   ;8480FF|C230    |      ;
    STX.B nTempVar1                                            ;848101|867E    |00007E;
    ...
    REP #$20                                                   ;848118|C220    |      ;
    LDA.B nTempVar1                                            ;84811A|A57E    |00007E;
    ASL A                                                      ;84811C|0A      |      ;
    CLC                                                        ;84811D|18      |      ;
    ADC.B nTempVar1                                            ;84811E|657E    |00007E;
    TAY                                                        ;848120|A8      |      ;
    ...
    JSR.W fUnknown_8488D4                                      ;848149|20D488  |8488D4;
    REP #$30                                                   ;84814C|C230    |      ;
    PLA                                                        ;84814E|68      |      ;
    SEP #$20                                                   ;84814F|E220    |      ;
    REP #$10                                                   ;848151|C210    |      ;
...
fUnknown_84816F:
 ...
 -- REP #$30                                                   ;8481AA|C230    |      ;
  ...
  + JSR.W fUnknown_848249                                      ;8481DA|204982  |848249;
...
.label4:
  ...
  + REP #$30                                                   ;8481E7|C230    |      ;
    ...
    JSR.W fUnknown_848286                                      ;848206|208682  |848286;
...
fUnknown_848249:
    ...
    ASL A                                                      ;848268|0A      |      ;
    TAX                                                        ;848269|AA      |      ;
    JSR.W (pSubrutinesTable_849419,X)                          ;84826A|FC1994  |849419;
    REP #$30                                                   ;84826D|C230    |      ;
...
fUnknown_848286:
    ...
    JSR.W fUnknown_8483CC                                      ;848295|20CC83  |8483CC;
    JSR.W fUnknown_848331                                      ;848298|203183  |848331;
...
.label2:
    ...
    STA.B nTempVar1                                            ;8482F7|857E    |00007E;
    REP #$30                                                   ;8482F9|C230    |      ;
    LDY.W #$0018                                               ;8482FB|A01800  |      ;
    LDA.B [ptrUnknown0xCC],Y                                   ;8482FE|B7CC    |0000CC;
    CMP.B nTempVar1                                            ;848300|C57E    |00007E;
...
.label1:
    REP #$20                                                   ;84838B|C220    |      ;
    STA.B nTempVar1                                            ;84838D|857E    |00007E;
...
.label2:
    ...
    CLC                                                        ;8483B0|18      |      ;
    ADC.B nTempVar1                                            ;8483B1|657E    |00007E;
    REP #$30                                                   ;8483B3|C230    |      ;
...
.label3:
    ...
    REP #$20                                                   ;84847E|C220    |      ;
    STA.B nTempVar1                                            ;848480|857E    |00007E;
    REP #$30                                                   ;848482|C230    |      ;
    ...
    CLC                                                        ;848492|18      |      ;
    ADC.B nTempVar1                                            ;848493|657E    |00007E;
...
.label4:
    ...
    REP #$20                                                   ;8484AD|C220    |      ;
    STA.B nTempVar1                                            ;8484AF|857E    |00007E;
    REP #$30                                                   ;8484B1|C230    |      ;
    ...
    SEC                                                        ;8484C1|38      |      ;
    SBC.B nTempVar1                                            ;8484C2|E57E    |00007E;
...
.label5:
    ...
    REP #$20                                                   ;8484DC|C220    |      ;
    STA.B nTempVar1                                            ;8484DE|857E    |00007E;
    REP #$30                                                   ;8484E0|C230    |      ;
    ...
    CLC                                                        ;8484F0|18      |      ;
    ADC.B nTempVar1                                            ;8484F1|657E    |00007E;
...
.label6:
    ...
    REP #$20                                                   ;84850B|C220    |      ;
    STA.B nTempVar1                                            ;84850D|857E    |00007E;
    REP #$30                                                   ;84850F|C230    |      ;
    ...
    SEC                                                        ;84851F|38      |      ;
    SBC.B nTempVar1                                            ;848520|E57E    |00007E;
...
.case01:
    ...
    REP #$20                                                   ;848547|C220    |      ;
    STA.B nTempVar1                                            ;848549|857E    |00007E;
    REP #$30                                                   ;84854B|C230    |      ;
    ...
    CLC                                                        ;84855B|18      |      ;
    ADC.B nTempVar1                                            ;84855C|657E    |00007E;
...
.case02:
    ...
    REP #$20                                                   ;8485A9|C220    |      ;
    STA.B nTempVar1                                            ;8485AB|857E    |00007E;
    REP #$30                                                   ;8485AD|C230    |      ;
    ...
    SEC                                                        ;8485BD|38      |      ;
    SBC.B nTempVar1                                            ;8485BE|E57E    |00007E;
...
.case04:
    ...
    REP #$20                                                   ;84860B|C220    |      ;
    STA.B nTempVar1                                            ;84860D|857E    |00007E;
    REP #$30                                                   ;84860F|C230    |      ;
    ...
    CLC                                                        ;84861F|18      |      ;
    ADC.B nTempVar1                                            ;848620|657E    |00007E;
...
.case08:
    ...
    REP #$20                                                   ;84866D|C220    |      ;
    STA.B nTempVar1                                            ;84866F|857E    |00007E;
    REP #$30                                                   ;848671|C230    |      ;
    ...
    SEC                                                        ;848681|38      |      ;
    SBC.B nTempVar1                                            ;848682|E57E    |00007E;
...
.label11:
    ...
    JSL.L fUnknown_848895                                      ;8486D9|22958884|848895;
    SEP #$20                                                   ;8486DD|E220    |      ;
    REP #$10                                                   ;8486DF|C210    |      ;
...
.label12:
    ...
    JSL.L fUnknown_848895                                      ;848703|22958884|848895;
    SEP #$20                                                   ;848707|E220    |      ;
    REP #$10                                                   ;848709|C210    |      ;
...
fUnknown_84887C:
    ...
    ASL A                                                      ;848882|0A      |      ;
    ASL A                                                      ;848883|0A      |      ;
    STA.B nTempVar1                                            ;848884|857E    |00007E;
    LDA.W #$B586                                               ;848886|A986B5  |      ;
    CLC                                                        ;848889|18      |      ;
    ADC.B nTempVar1                                            ;84888A|657E    |00007E;
...
fUnknown_848895:
    ...
    REP #$20                                                   ;8488A5|C220    |      ;
    STA.B nTempVar1                                            ;8488A7|857E    |00007E;
    ASL A                                                      ;8488A9|0A      |      ;
    CLC                                                        ;8488AA|18      |      ;
    ADC.B nTempVar1                                            ;8488AB|657E    |00007E;
    TAY                                                        ;8488AD|A8      |      ;
    REP #$20                                                   ;8488AE|C220    |      ;
...
subUnknown849419_0x09:
    ...
    REP #$20                                                   ;848B31|C220    |      ;
    JSL.L fUnknown_84887C                                      ;848B33|227C8884|84887C;
    SEP #$20                                                   ;848B37|E220    |      ;
    REP #$10                                                   ;848B39|C210    |      ;
    PLA                                                        ;848B3B|68      |      ;
    SEP #$20                                                   ;848B3C|E220    |      ;
    ...
    JSR.W fUnknown_8488D4                                      ;848B5D|20D488  |8488D4;
    SEP #$20                                                   ;848B60|E220    |      ;
    PLA                                                        ;848B62|68      |      ;
    SEP #$20                                                   ;848B63|E220    |      ;
    REP #$10                                                   ;848B65|C210    |      ;
...
subUnknown849419_0x0E:
    ...
    JSL.L fUnknown_838401                                      ;848CB4|22018483|838401;
    RTS                                                        ;848CB8|60      |      ;
...
subUnknown849419_0x14:
    ...
    STA.B nTempVar1                                            ;848D7F|857E    |00007E;
    REP #$30                                                   ;848D81|C230    |      ;
    ...
    AND.B nTempVar1                                            ;848D8F|257E    |00007E;
...
subUnknown849419_0x1A:
    ...
    JSL.L fUnknown_848895                                      ;848F89|22958884|848895;
    REP #$30                                                   ;848F8D|C230    |      ;
...
.continue:
    ...
    JSL.L fUnknown_848895                                      ;849142|22958884|848895;
    SEP #$20                                                   ;849146|E220    |      ;
    REP #$10                                                   ;849148|C210    |      ;
...
subUnknown849419_0x21:
  ...
  + REP #$20                                                   ;84920B|C220    |      ;
    STA.B nTempVar1                                            ;84920D|857E    |00007E;
    REP #$30                                                   ;84920F|C230    |      ;
    ...
    REP #$20                                                   ;849220|C220    |      ;
    CLC                                                        ;849222|18      |      ;
    ADC.B nTempVar1                                            ;849223|657E    |00007E;
...
subUnknown849419_0x23:
    ...
    STA.B nTempVar1                                            ;849341|857E    |00007E;
    REP #$20                                                   ;849343|C220    |      ;
    LDA.B [ptrUnknown0x72]                                     ;849345|A772    |000072;
    ORA.B nTempVar1                                            ;849347|057E    |00007E;
...
subUnknown849419_0x25:
    ...
    REP #$20                                                   ;849392|C220    |      ;
    JSL.L fUnknown_84887C                                      ;849394|227C8884|84887C;
    REP #$30                                                   ;849398|C230    |      ;
...
subUnknown849419_0x26:
    ...
    STA.B nTempVar1                                            ;849404|857E    |00007E;
    REP #$20                                                   ;849406|C220    |      ;
    LDA.B [ptrUnknown0x72]                                     ;849408|A772    |000072;
    AND.B nTempVar1                                            ;84940A|257E    |00007E;
...
subUnknown849419_0x2B:
    ...
    JSL.L fUnknown_848895                                      ;8495D6|22958884|848895;
    REP #$30                                                   ;8495DA|C230    |      ;
...
.continue:
    ...
    JSL.L fUnknown_848895                                      ;84971C|22958884|848895;
    SEP #$20                                                   ;849720|E220    |      ;
    REP #$10                                                   ;849722|C210    |      ;
...
subUnknown849419_0x2F:
    ...
    JSL.L fUnknown_848895                                      ;84983E|22958884|848895;
    SEP #$20                                                   ;849842|E220    |      ;
    REP #$10                                                   ;849844|C210    |      ;
...
.label3:
  ...
  + LDA.L $7F1F5A                                              ;849A6D|AF5A1F7F|7F1F5A;
    ...
    STA.B $D2                                                  ;849AA9|85D2    |0000D2;
    REP #$30                                                   ;849AAB|C230    |      ;
    LDA.W #$0000                                               ;849AAD|A90000  |      ;
    STA.B $D4                                                  ;849AB0|85D4    |0000D4;
    SEP #$20                                                   ;849AB2|E220    |      ;
    REP #$10                                                   ;849AB4|C210    |      ;
...
CODE_849B9B:
    LDA.L $7F1F60                                              ;849B9B|AF601F7F|7F1F60;
...
CODE_849BBF:
    REP #$20                                                   ;849BBF|C220    |      ;
    LDA.L $7F1F5A                                              ;849BC1|AF5A1F7F|7F1F5A;
...
CODE_849BCD:
    REP #$20                                                   ;849BCD|C220    |      ;
    LDA.L $7F1F5A                                              ;849BCF|AF5A1F7F|7F1F5A;
...
CODE_849BDB:
    REP #$20                                                   ;849BDB|C220    |      ;
    LDA.L $7F1F5A                                              ;849BDD|AF5A1F7F|7F1F5A;
...
CODE_849F24:
    ...
    STA.B nTempVar1                                            ;849F29|857E    |00007E;
    SEP #$20                                                   ;849F2B|E220    |      ;
    REP #$10                                                   ;849F2D|C210    |      ;
    ...
    STA.B nTempVar1                                            ;849F3F|857E    |00007E;
...
CODE_849F43:
    ...
    STA.B nTempVar1                                            ;849F48|857E    |00007E;
    SEP #$20                                                   ;849F4A|E220    |      ;
    REP #$10                                                   ;849F4C|C210    |      ;
    ...
    STA.B nTempVar1                                            ;849F5E|857E    |00007E;
...
CODE_849F62:
    ...
    STA.B nTempVar1                                            ;849F67|857E    |00007E;
    SEP #$20                                                   ;849F69|E220    |      ;
    REP #$10                                                   ;849F6B|C210    |      ;
    ...
    STA.B nTempVar1                                            ;849F7D|857E    |00007E;
...
CODE_849F91:
    ...
    LDY.B nTempVar1                                            ;849FA2|A47E    |00007E;
...
CODE_84A46E:
    REP #$30                                                   ;84A46E|C230    |      ;
    LDA.L $7F1F5A                                              ;84A470|AF5A1F7F|7F1F5A;
...
CODE_84A47C:
    ...
    JMP.W CODE_84A607                                          ;84A487|4C07A6  |84A607;
...
CODE_84A498:
    REP #$30                                                   ;84A498|C230    |      ;
    LDA.L $7F1F5A                                              ;84A49A|AF5A1F7F|7F1F5A;
...
CODE_84A4A6:
    LDA.L $7F1F5A                                              ;84A4A6|AF5A1F7F|7F1F5A;
...
CODE_84A4F5:
    ...
    STA.B $D2                                                  ;84A515|85D2    |0000D2;
    REP #$30                                                   ;84A517|C230    |      ;
    LDA.W #$0000                                               ;84A519|A90000  |      ;
    STA.B $D4                                                  ;84A51C|85D4    |0000D4;
    SEP #$20                                                   ;84A51E|E220    |      ;
    REP #$10                                                   ;84A520|C210    |      ;
...
fUnknown_84A5D4:
    REP #$30                                                   ;84A5D4|C230    |      ;
    STA.B nTempVar1                                            ;84A5D6|857E    |00007E;
    LDA.W #$0000                                               ;84A5D8|A90000  |      ;
    SEP #$20                                                   ;84A5DB|E220    |      ;
    LDY.W #$0004                                               ;84A5DD|A00400  |      ;
    LDA.B [ptrUnknown0x72],Y                                   ;84A5E0|B772    |000072;
    REP #$20                                                   ;84A5E2|C220    |      ;
    STA.B $80                                                  ;84A5E4|8580    |000080;
    LDA.B $80                                                  ;84A5E6|A580    |000080;
    CLC                                                        ;84A5E8|18      |      ;
    ADC.B nTempVar1                                            ;84A5E9|657E    |00007E;
    BMI CODE_84A5F8                                            ;84A5EB|300B    |84A5F8;
    CMP.W #$0100                                               ;84A5ED|C90001  |      ;
    BCS CODE_84A600                                            ;84A5F0|B00E    |84A600;
    SEP #$20                                                   ;84A5F2|E220    |      ;
    STA.B [ptrUnknown0x72],Y                                   ;84A5F4|9772    |000072;
    BRA CODE_84A606                                            ;84A5F6|800E    |84A606;
...
CODE_84A5F8:
    ...
    BRA CODE_84A606                                            ;84A5FE|8006    |84A606;
...
CODE_84A84A:
    ...
    STA.B nTempVar1                                            ;84A85A|857E    |00007E;
...
CODE_84A860:
    ...
    INC A                                                      ;84A865|1A      |      ;
    STA.B nTempVar1                                            ;84A866|857E    |00007E;
    LDA.W #$0001                                               ;84A868|A90100  |      ;
    STA.B $82                                                  ;84A86B|8582    |000082;
...
CODE_84A88A:
    ...
    REP #$20                                                   ;84A897|C220    |      ;
    LDA.B $80                                                  ;84A899|A580    |000080;
    CMP.B nTempVar1                                            ;84A89B|C57E    |00007E;
...
CODE_84A974:
    ...
    JMP.W CODE_84AA1E                                          ;84A97D|4C1EAA  |84AA1E;
...
CODE_84A980:
    ...
    JMP.W CODE_84AA1E                                          ;84A989|4C1EAA  |84AA1E;
...
CODE_84A98C:
    ...
    JMP.W CODE_84AA1E                                          ;84A995|4C1EAA  |84AA1E;
...
CODE_84A9B7:
    ...
    JMP.W CODE_84AA1E                                          ;84A9C0|4C1EAA  |84AA1E;
...
CODE_84A9C3:
    ...
    JMP.W CODE_84AA1E                                          ;84A9CA|4C1EAA  |84AA1E;
...
CODE_84A9CD:
    ...
    JMP.W CODE_84AA1E                                          ;84A9D4|4C1EAA  |84AA1E;
...
CODE_84AA2E:
    ...
    BNE CODE_84AA40                                            ;84AA3B|D003    |84AA40;
...
CODE_84AA79:
    ...
    JMP.W CODE_84AB19                                          ;84AA82|4C19AB  |84AB19;
...
CODE_84AA85:
    ...
    JMP.W CODE_84AB19                                          ;84AA8E|4C19AB  |84AB19;
...
CODE_84AA91:
    ...
    JMP.W CODE_84AB19                                          ;84AA9A|4C19AB  |84AB19;
...
CODE_84AA9D:
    ...
    JMP.W CODE_84AB19                                          ;84AAA6|4C19AB  |84AB19;
...
CODE_84AAC8:
    ...
    JMP.W CODE_84AB19                                          ;84AACF|4C19AB  |84AB19;
...
subUnknown849419_0x35:
    ...
    BEQ CODE_84AB73                                            ;84AB48|F029    |84AB73;
    SEP #$20                                                   ;84AB4A|E220    |      ;
...
CODE_84AB73:
    REP #$20                                                   ;84AB73|C220    |      ;
    LDA.L $7F1F5C                                              ;84AB75|AF5C1F7F|7F1F5C;
    AND.W #$0040                                               ;84AB79|294000  |      ;
    BNE CODE_84AB81                                            ;84AB7C|D003    |84AB81;
    JMP.W CODE_84ABDF                                          ;84AB7E|4CDFAB  |84ABDF;
...
CODE_84AB81:
    ...
    BEQ CODE_84AB9A                                            ;84AB8C|F00C    |84AB9A;
    CMP.B #$01                                                 ;84AB8E|C901    |      ;
    BEQ CODE_84ABA7                                            ;84AB90|F015    |84ABA7;
    CMP.B #$02                                                 ;84AB92|C902    |      ;
    BEQ CODE_84ABB4                                            ;84AB94|F01E    |84ABB4;
    CMP.B #$03                                                 ;84AB96|C903    |      ;
    BEQ CODE_84ABC1                                            ;84AB98|F027    |84ABC1;
...
CODE_84AB9A:
    ...
    BRA CODE_84ABCE                                            ;84ABA5|8027    |84ABCE;
...
CODE_84ABA7:
    ...
    BRA CODE_84ABCE                                            ;84ABB2|801A    |84ABCE;
...
CODE_84ABB4:
    ...
    BRA CODE_84ABCE                                            ;84ABBF|800D    |84ABCE;
...
CODE_84ABC1:
    ...
    BRA CODE_84ABCE                                            ;84ABCC|8000    |84ABCE;
...
CODE_84ABCE:
    ...
    STA.L $7F1F5C                                              ;84ABDB|8F5C1F7F|7F1F5C;
 
CODE_84ABDF:
    REP #$30                                                   ;84ABDF|C230    |      ;
    LDA.L $7F1F5C                                              ;84ABE1|AF5C1F7F|7F1F5C;
    AND.W #$0800                                               ;84ABE5|290008  |      ;
    BEQ CODE_84ABED                                            ;84ABE8|F003    |84ABED;
    JMP.W CODE_84ACEE                                          ;84ABEA|4CEEAC  |84ACEE;
 
 
CODE_84ABED:
    LDA.L $7F1F5C                                              ;84ABED|AF5C1F7F|7F1F5C;
    AND.W #$0020                                               ;84ABF1|292000  |      ;
    BEQ CODE_84ABF9                                            ;84ABF4|F003    |84ABF9;
    JMP.W CODE_84ADA4                                          ;84ABF6|4CA4AD  |84ADA4;
...
CODE_84ABF9:
    ...
    BNE CODE_84AC09                                            ;84AC04|D003    |84AC09;
    JMP.W CODE_84ACEE                                          ;84AC06|4CEEAC  |84ACEE;
 
 
CODE_84AC09:
    REP #$30                                                   ;84AC09|C230    |      ;
    LDA.B $D4                                                  ;84AC0B|A5D4    |0000D4;
    CMP.W #$000A                                               ;84AC0D|C90A00  |      ;
    BNE CODE_84AC15                                            ;84AC10|D003    |84AC15;
    JMP.W CODE_84ACEE                                          ;84AC12|4CEEAC  |84ACEE;
 
 
CODE_84AC15:
    REP #$30                                                   ;84AC15|C230    |      ;
    LDA.B $D4                                                  ;84AC17|A5D4    |0000D4;
    CMP.W #$000C                                               ;84AC19|C90C00  |      ;
    BNE CODE_84AC21                                            ;84AC1C|D003    |84AC21;
    JMP.W CODE_84ACEE                                          ;84AC1E|4CEEAC  |84ACEE;
 
 
CODE_84AC21:
    REP #$30                                                   ;84AC21|C230    |      ;
    LDA.B $D4                                                  ;84AC23|A5D4    |0000D4;
    CMP.W #$000D                                               ;84AC25|C90D00  |      ;
    BNE CODE_84AC2D                                            ;84AC28|D003    |84AC2D;
    JMP.W CODE_84ACEE                                          ;84AC2A|4CEEAC  |84ACEE;
 
 
CODE_84AC2D:
    REP #$30                                                   ;84AC2D|C230    |      ;
    LDA.B $D4                                                  ;84AC2F|A5D4    |0000D4;
    CMP.W #$001B                                               ;84AC31|C91B00  |      ;
    BNE CODE_84AC39                                            ;84AC34|D003    |84AC39;
    JMP.W CODE_84ACEE                                          ;84AC36|4CEEAC  |84ACEE;
 
 
CODE_84AC39:
    REP #$20                                                   ;84AC39|C220    |      ;
    LDA.B $D2                                                  ;84AC3B|A5D2    |0000D2;
    AND.W #$0004                                               ;84AC3D|290400  |      ;
    BEQ CODE_84AC45                                            ;84AC40|F003    |84AC45;
    JMP.W CODE_84ACEE                                          ;84AC42|4CEEAC  |84ACEE;
 
 
CODE_84AC45:
    LDA.L $7F1F60                                              ;84AC45|AF601F7F|7F1F60;
    AND.W #$0006                                               ;84AC49|290600  |      ;
    BEQ CODE_84AC51                                            ;84AC4C|F003    |84AC51;
    JMP.W CODE_84ACEE                                          ;84AC4E|4CEEAC  |84ACEE;
 
 
CODE_84AC51:
    REP #$20                                                   ;84AC51|C220    |      ;
    LDA.L $7F1F5C                                              ;84AC53|AF5C1F7F|7F1F5C;
    ORA.W #$0010                                               ;84AC57|091000  |      ;
    STA.L $7F1F5C                                              ;84AC5A|8F5C1F7F|7F1F5C;
    REP #$20                                                   ;84AC5E|C220    |      ;
    LDA.W $0128                                                ;84AC60|AD2801  |000128;
    BIT.W #$0080                                               ;84AC63|898000  |      ;
    BNE CODE_84AC6B                                            ;84AC66|D003    |84AC6B;
    JMP.W CODE_84ACEE                                          ;84AC68|4CEEAC  |84ACEE;
...
CODE_84AC8C:
    ...
    BCS CODE_84AC9A                                            ;84AC95|B003    |84AC9A;
    JMP.W CODE_84ACEE                                          ;84AC97|4CEEAC  |84ACEE;
...
CODE_84AC9A:
    ...
    BCS CODE_84ACA8                                            ;84ACA3|B003    |84ACA8;
    JMP.W CODE_84ACEE                                          ;84ACA5|4CEEAC  |84ACEE;
...
CODE_84ACA8:
    ...
    JMP.W CODE_84ACEE                                          ;84ACBD|4CEEAC  |84ACEE;
 
 
CODE_84ACC0:
    REP #$30                                                   ;84ACC0|C230    |      ;
    LDA.B $D2                                                  ;84ACC2|A5D2    |0000D2;
    AND.W #$0002                                               ;84ACC4|290200  |      ;
    BEQ CODE_84ACCC                                            ;84ACC7|F003    |84ACCC;
    JMP.W CODE_84AD88                                          ;84ACC9|4C88AD  |84AD88;
 
 
CODE_84ACCC:
    REP #$30                                                   ;84ACCC|C230    |      ;
    LDA.B $D2                                                  ;84ACCE|A5D2    |0000D2;
    AND.W #$0800                                               ;84ACD0|290008  |      ;
    BEQ CODE_84ACD8                                            ;84ACD3|F003    |84ACD8;
    JMP.W CODE_84AD88                                          ;84ACD5|4C88AD  |84AD88;
 
 
CODE_84ACD8:
    REP #$30                                                   ;84ACD8|C230    |      ;
    LDA.B $D4                                                  ;84ACDA|A5D4    |0000D4;
    CMP.W #$0004                                               ;84ACDC|C90400  |      ;
    BNE CODE_84ACE4                                            ;84ACDF|D003    |84ACE4;
    JMP.W CODE_84AD88                                          ;84ACE1|4C88AD  |84AD88;
 
 
CODE_84ACE4:
    REP #$30                                                   ;84ACE4|C230    |      ;
    LDA.W #$0017                                               ;84ACE6|A91700  |      ;
    STA.B $D4                                                  ;84ACE9|85D4    |0000D4;
    JMP.W CODE_84AD88                                          ;84ACEB|4C88AD  |84AD88;
 
 
CODE_84ACEE:
    REP #$30                                                   ;84ACEE|C230    |      ;
    LDA.L $7F1F5C                                              ;84ACF0|AF5C1F7F|7F1F5C;
    AND.W #$F7FF                                               ;84ACF4|29FFF7  |      ;
    STA.L $7F1F5C                                              ;84ACF7|8F5C1F7F|7F1F5C;
    SEP #$20                                                   ;84ACFB|E220    |      ;
    LDA.W $0939                                                ;84ACFD|AD3909  |000939;
    CMP.B #$78                                                 ;84AD00|C978    |      ;
    BEQ CODE_84AD0B                                            ;84AD02|F007    |84AD0B;
    INC A                                                      ;84AD04|1A      |      ;
    STA.W $0939                                                ;84AD05|8D3909  |000939;
    JMP.W CODE_84AD88                                          ;84AD08|4C88AD  |84AD88;
...
CODE_84AD0B:
    ...
    BCC CODE_84AD2E                                            ;84AD16|9016    |84AD2E;
    CMP.B #$48                                                 ;84AD18|C948    |      ;
    BCC CODE_84AD2E                                            ;84AD1A|9012    |84AD2E;
    CMP.B #$6C                                                 ;84AD1C|C96C    |      ;
    BCC CODE_84AD40                                            ;84AD1E|9020    |84AD40;
    CMP.B #$90                                                 ;84AD20|C990    |      ;
    BCC CODE_84AD52                                            ;84AD22|902E    |84AD52;
    CMP.B #$B4                                                 ;84AD24|C9B4    |      ;
    BCC CODE_84AD64                                            ;84AD26|903C    |84AD64;
    CMP.B #$D8                                                 ;84AD28|C9D8    |      ;
    BCC CODE_84AD64                                            ;84AD2A|9038    |84AD64;
    BRA CODE_84AD76                                            ;84AD2C|8048    |84AD76;
...
CODE_84ADA4:
    REP #$30                                                   ;84ADA4|C230    |      ;
    LDA.B $D2                                                  ;84ADA6|A5D2    |0000D2;
    ORA.W #$0010                                               ;84ADA8|091000  |      ;
    STA.B $D2                                                  ;84ADAB|85D2    |0000D2;
    REP #$20                                                   ;84ADAD|C220    |      ;
    LDA.L $7F1F5C                                              ;84ADAF|AF5C1F7F|7F1F5C;
    AND.W #$FFDF                                               ;84ADB3|29DFFF  |      ;
    STA.L $7F1F5C                                              ;84ADB6|8F5C1F7F|7F1F5C;
    SEP #$20                                                   ;84ADBA|E220    |      ;
    REP #$10                                                   ;84ADBC|C210    |      ;
...
CODE_84ADF2:
    ...
    BEQ CODE_84AE01                                            ;84ADFC|F003    |84AE01;
...
CODE_84AE69:
    ...
    STA.B nTempVar1                                            ;84AE79|857E    |00007E;
    BMI CODE_84AE7F                                            ;84AE7B|3002    |84AE7F;
    BRA CODE_84AE8C                                            ;84AE7D|800D    |84AE8C;
...
CODE_84AE7F:
    ...
    INC A                                                      ;84AE84|1A      |      ;
    STA.B nTempVar1                                            ;84AE85|857E    |00007E;
...
CODE_84AE8C:
    ...
    BRA CODE_84AEA9                                            ;84AE9A|800D    |84AEA9;
...
CODE_84AEA9:
    ...
    CMP.B nTempVar1                                            ;84AEBA|C57E    |00007E;
    BCS CODE_84AEC6                                            ;84AEBC|B008    |84AEC6;
    REP #$20                                                   ;84AEBE|C220    |      ;
    LDA.B $82                                                  ;84AEC0|A582    |000082;
    BEQ CODE_84AEF8                                            ;84AEC2|F034    |84AEF8;
...
CODE_84AEC6:
    ...
    BEQ CODE_84AEDC                                            ;84AECA|F010    |84AEDC;
    BRA CODE_84AECE                                            ;84AECC|8000    |84AECE;
...
CODE_84AECE:
    ...
    JMP.W CODE_84AD96                                          ;84AED9|4C96AD  |84AD96;
...
CODE_84AEDC:
    ...
    JMP.W CODE_84AD96                                          ;84AEE7|4C96AD  |84AD96;
...
CODE_84AEF8:
    ...
    JMP.W CODE_84AD96                                          ;84AF03|4C96AD  |84AD96;
...
CODE_84AF38:
    ...
    JMP.W CODE_84AFF4                                          ;84AF41|4CF4AF  |84AFF4;
...
CODE_84AF44:
    ...
    JMP.W CODE_84AFF4                                          ;84AF4D|4CF4AF  |84AFF4;
...
CODE_84AF50:
    ...
    JMP.W CODE_84AFF4                                          ;84AF59|4CF4AF  |84AFF4;
...
CODE_84AF5C:
    ...
    JMP.W CODE_84AFF4                                          ;84AF65|4CF4AF  |84AFF4;
...
CODE_84AF68:
    ...
    JMP.W CODE_84AFF4                                          ;84AF71|4CF4AF  |84AFF4;
...
CODE_84AF8A:
    ...
    JMP.W CODE_84AFF4                                          ;84AF91|4CF4AF  |84AFF4;
...
CODE_84AF94:
    ...
    JMP.W CODE_84AFF4                                          ;84AF9D|4CF4AF  |84AFF4;
...
CODE_84AFA0:
    ...
    JMP.W CODE_84AFF4                                          ;84AFA7|4CF4AF  |84AFF4;
...
CODE_84AFAA:
    ...
    JMP.W CODE_84AFF4                                          ;84AFB1|4CF4AF  |84AFF4;
...
CODE_84AFB4:
    ...
    JMP.W CODE_84AFF4                                          ;84AFBB|4CF4AF  |84AFF4;
...
CODE_84B07E:
    ...
    BCC CODE_84B0A9                                            ;84B086|9021    |84B0A9;
    ...
    BRA CODE_84B0ED                                            ;84B094|8057    |84B0ED;
...
CODE_84B278:
    ...
    STA.B nTempVar1                                            ;84B2BE|857E    |00007E;
...
CODE_84B2C4:
    ...
    INC A                                                      ;84B2C9|1A      |      ;
    STA.B nTempVar1                                            ;84B2CA|857E    |00007E;
...
CODE_84B2EE:
    ...
    CMP.B nTempVar1                                            ;84B2FF|C57E    |00007E;
...
CODE_84B397:
    ...
    ASL A                                                      ;84B3AA|0A      |      ;
    TAX                                                        ;84B3AB|AA      |      ;
    LDA.L Table_84B4D2,X                                       ;84B3AC|BFD2B484|84B4D2;
...
CODE_84B435:
    ...
    ASL A                                                      ;84B448|0A      |      ;
    TAX                                                        ;84B449|AA      |      ;
    LDA.L Table_84B4D2,X                                       ;84B44A|BFD2B484|84B4D2;
    ORA.W $08FD                                                ;84B44E|0DFD08  |0008FD;
    STA.W $08FD                                                ;84B451|8DFD08  |0008FD;
    LDX.W #$0008                                               ;84B454|A20800  |      ;
    LDA.L Table_84B4D2,X                                       ;84B457|BFD2B484|84B4D2;
...
Table_84B4D2:
    dw $0400,$0800,$0100,$0200,$8000                           ;84B4D2|        |      ;
...
subUnknown849419_0x41:
    ...
    STA.B nTempVar1                                            ;84B5D9|857E    |00007E;
    REP #$30                                                   ;84B5DB|C230    |      ;
    ...
    CLC                                                        ;84B5E7|18      |      ;
    ADC.B nTempVar1                                            ;84B5E8|657E    |00007E;
    ...
    BRA CODE_84B601                                            ;84B5F8|8007    |84B601;
...
subUnknown849419_0x43:
    ...
    STA.B nTempVar1                                            ;84B696|857E    |00007E;
    REP #$30                                                   ;84B698|C230    |      ;
    ...
    CMP.B nTempVar1                                            ;84B6A6|C57E    |00007E;
...
subUnknown849419_0x44:
    ...
    STA.B nTempVar1                                            ;84B6EC|857E    |00007E;
    REP #$30                                                   ;84B6EE|C230    |      ;
    ...
    CMP.B nTempVar1                                            ;84B70C|C57E    |00007E;
    BNE CODE_84B722                                            ;84B70E|D012    |84B722;
    SEP #$20                                                   ;84B710|E220    |      ;
    LDY.W #$0002                                               ;84B712|A00200  |      ;
    LDA.B [ptrUnknown0x72],Y                                   ;84B715|B772    |000072;
    CMP.B $80                                                  ;84B717|C580    |000080;
    BNE CODE_84B722                                            ;84B719|D007    |84B722;
    REP #$20                                                   ;84B71B|C220    |      ;
...
subUnknown849419_0x45:
    ...
    STA.B nTempVar1                                            ;84B75D|857E    |00007E;
    REP #$30                                                   ;84B75F|C230    |      ;
    ...
    CMP.B nTempVar1                                            ;84B77E|C57E    |00007E;
...
subUnknown849419_0x46:
    ...
    STA.B nTempVar1                                            ;84B7CA|857E    |00007E;
    REP #$30                                                   ;84B7CC|C230    |      ;
    ...
    CMP.B nTempVar1                                            ;84B81C|C57E    |00007E;
    SEP #$20                                                   ;84B81E|E220    |      ;
...
subUnknown849419_0x49:
    ...
    JSL.L fUnknown_848895                                      ;84B92A|22958884|848895;
    REP #$30                                                   ;84B92E|C230    |      ;
...
subUnknown849419_0x4A:
    ...
    BNE CODE_84B958                                            ;84B953|D003    |84B958;
    JMP.W CODE_84BA02                                          ;84B955|4C02BA  |84BA02;
 
 
CODE_84B958:
    REP #$30                                                   ;84B958|C230    |      ;
    LDA.B $D4                                                  ;84B95A|A5D4    |0000D4;
    CMP.W #$000A                                               ;84B95C|C90A00  |      ;
    BNE CODE_84B964                                            ;84B95F|D003    |84B964;
    JMP.W CODE_84BA02                                          ;84B961|4C02BA  |84BA02;
 
 
CODE_84B964:
    REP #$30                                                   ;84B964|C230    |      ;
    LDA.B $D4                                                  ;84B966|A5D4    |0000D4;
    CMP.W #$000C                                               ;84B968|C90C00  |      ;
    BNE CODE_84B970                                            ;84B96B|D003    |84B970;
    JMP.W CODE_84BA02                                          ;84B96D|4C02BA  |84BA02;
 
 
CODE_84B970:
    REP #$30                                                   ;84B970|C230    |      ;
    LDA.B $D4                                                  ;84B972|A5D4    |0000D4;
    CMP.W #$000D                                               ;84B974|C90D00  |      ;
    BNE CODE_84B97C                                            ;84B977|D003    |84B97C;
    JMP.W CODE_84BA02                                          ;84B979|4C02BA  |84BA02;
 
 
CODE_84B97C:
    REP #$30                                                   ;84B97C|C230    |      ;
    LDA.B $D4                                                  ;84B97E|A5D4    |0000D4;
    CMP.W #$001B                                               ;84B980|C91B00  |      ;
    BNE CODE_84B988                                            ;84B983|D003    |84B988;
    JMP.W CODE_84BA02                                          ;84B985|4C02BA  |84BA02;
 
 
CODE_84B988:
    REP #$20                                                   ;84B988|C220    |      ;
    LDA.B $D2                                                  ;84B98A|A5D2    |0000D2;
    AND.W #$0004                                               ;84B98C|290400  |      ;
    BNE CODE_84BA02                                            ;84B98F|D071    |84BA02;
    LDA.L $7F1F60                                              ;84B991|AF601F7F|7F1F60;
    AND.W #$0006                                               ;84B995|290600  |      ;
    BNE CODE_84BA02                                            ;84B998|D068    |84BA02;
    REP #$20                                                   ;84B99A|C220    |      ;
    LDA.W $0128                                                ;84B99C|AD2801  |000128;
    BIT.W #$0080                                               ;84B99F|898000  |      ;
    BNE CODE_84B9A7                                            ;84B9A2|D003    |84B9A7;
    JMP.W CODE_84BA02                                          ;84B9A4|4C02BA  |84BA02;
 
 
CODE_84B9A7:
    REP #$30                                                   ;84B9A7|C230    |      ;
    LDA.B $D2                                                  ;84B9A9|A5D2    |0000D2;
    AND.W #$0800                                               ;84B9AB|290008  |      ;
    BEQ CODE_84B9B3                                            ;84B9AE|F003    |84B9B3;
    JMP.W CODE_84BA02                                          ;84B9B0|4C02BA  |84BA02;
 
 
CODE_84B9B3:
    LDA.B $D4                                                  ;84B9B3|A5D4    |0000D4;
    CMP.W #$0017                                               ;84B9B5|C91700  |      ;
    BNE CODE_84B9BD                                            ;84B9B8|D003    |84B9BD;
    JMP.W CODE_84BA02                                          ;84B9BA|4C02BA  |84BA02;
 
 
CODE_84B9BD:
    SEP #$20                                                   ;84B9BD|E220    |      ;
    LDA.W $091D                                                ;84B9BF|AD1D09  |00091D;
    BEQ CODE_84B9C7                                            ;84B9C2|F003    |84B9C7;
    JMP.W CODE_84BA02                                          ;84B9C4|4C02BA  |84BA02;
...
CODE_84BA9A:
    ...
    BNE CODE_84BAA8                                            ;84BAA3|D003    |84BAA8;
...
CODE_84BAA8:
    ...
    JSL.L fUnknown_848895                                      ;84BB00|22958884|848895;
    SEP #$20                                                   ;84BB04|E220    |      ;
    REP #$10                                                   ;84BB06|C210    |      ;
...
subUnknown849419_0x4E:
    ...
    REP #$20                                                   ;84BB3D|C220    |      ;
    LDA.L $7F1F5C                                              ;84BB3F|AF5C1F7F|7F1F5C;
    AND.W #$FFF7                                               ;84BB43|29F7FF  |      ;
    STA.L $7F1F5C                                              ;84BB46|8F5C1F7F|7F1F5C;
    RTS                                                        ;84BB4A|60      |      ;
...
subUnknown849419_0x50:
    ...
    BEQ CODE_84BC06                                            ;84BBEF|F015    |84BC06;
    CMP.B #$26                                                 ;84BBF1|C926    |      ;
    BEQ CODE_84BC06                                            ;84BBF3|F011    |84BC06;
    STZ.W $091D                                                ;84BBF5|9C1D09  |00091D;
    REP #$30                                                   ;84BBF8|C230    |      ;
    LDA.W #$0000                                               ;84BBFA|A90000  |      ;
    CLC                                                        ;84BBFD|18      |      ;
    ADC.B $DA                                                  ;84BBFE|65DA    |0000DA;
    STA.W $0901                                                ;84BC00|8D0109  |000901;
    JMP.W CODE_84BC9B                                          ;84BC03|4C9BBC  |84BC9B;
...
CODE_84BC06:
    ...
    CLC                                                        ;84BC54|18      |      ;
    ADC.B $DA                                                  ;84BC55|65DA    |0000DA;
    STA.W $0901                                                ;84BC57|8D0109  |000901;
    BRA CODE_84BC9B                                            ;84BC5A|803F    |84BC9B;
...
CODE_84BC5C:
    ...
    BNE CODE_84BC68                                            ;84BC63|D003    |84BC68;
...
CODE_84BC68:
    ...
    AND.B $D2                                                  ;84BC70|25D2    |0000D2;
    STA.B $D2                                                  ;84BC72|85D2    |0000D2;
    SEP #$20                                                   ;84BC74|E220    |      ;
    LDA.L nCurrentSeasonID                                     ;84BC76|AF191F7F|7F1F19;
    STA.L $7F1F30                                              ;84BC7A|8F301F7F|7F1F30;
    REP #$30                                                   ;84BC7E|C230    |      ;
    LDA.W #$0078                                               ;84BC80|A97800  |      ;
    STA.L $7F1F2C                                              ;84BC83|8F2C1F7F|7F1F2C;
    LDA.W #$01A8                                               ;84BC87|A9A801  |      ;
    STA.L $7F1F2E                                              ;84BC8A|8F2E1F7F|7F1F2E;
    REP #$30                                                   ;84BC8E|C230    |      ;
    LDA.W #$0000                                               ;84BC90|A90000  |      ;
    CLC                                                        ;84BC93|18      |      ;
    ADC.B $DA                                                  ;84BC94|65DA    |0000DA;
    STA.W $0901                                                ;84BC96|8D0109  |000901;
    BRA CODE_84BC9B                                            ;84BC99|8000    |84BC9B;
...
subUnknown849419_0x51:
    ...
    BEQ CODE_84BD0F                                            ;84BCAD|F060    |84BD0F;
    CMP.B #$25                                                 ;84BCAF|C925    |      ;
    BEQ CODE_84BCC4                                            ;84BCB1|F011    |84BCC4;
    CMP.B #$26                                                 ;84BCB3|C926    |      ;
    BEQ CODE_84BCC4                                            ;84BCB5|F00D    |84BCC4;
    CMP.B #$29                                                 ;84BCB7|C929    |      ;
    BEQ CODE_84BCBE                                            ;84BCB9|F003    |84BCBE;
    JMP.W CODE_84BD43                                          ;84BCBB|4C43BD  |84BD43;
 
 
CODE_84BCBE:
    STZ.W $091D                                                ;84BCBE|9C1D09  |00091D;
    JMP.W CODE_84BD43                                          ;84BCC1|4C43BD  |84BD43;
...
CODE_84BCC4:
    ...
    BRA CODE_84BD43                                            ;84BD0D|8034    |84BD43;
 
 
CODE_84BD0F:
    REP #$30                                                   ;84BD0F|C230    |      ;
    LDA.B $D2                                                  ;84BD11|A5D2    |0000D2;
    AND.W #$0800                                               ;84BD13|290008  |      ;
    BNE CODE_84BD1B                                            ;84BD16|D003    |84BD1B;
    JMP.W CODE_84BD43                                          ;84BD18|4C43BD  |84BD43;
...
CODE_84BD1B:
    ...
    AND.B $D2                                                  ;84BD23|25D2    |0000D2;
    STA.B $D2                                                  ;84BD25|85D2    |0000D2;
    SEP #$20                                                   ;84BD27|E220    |      ;
    LDA.L nCurrentSeasonID                                     ;84BD29|AF191F7F|7F1F19;
    STA.L $7F1F30                                              ;84BD2D|8F301F7F|7F1F30;
    REP #$30                                                   ;84BD31|C230    |      ;
    LDA.W #$0078                                               ;84BD33|A97800  |      ;
    STA.L $7F1F2C                                              ;84BD36|8F2C1F7F|7F1F2C;
    LDA.W #$01A8                                               ;84BD3A|A9A801  |      ;
    STA.L $7F1F2E                                              ;84BD3D|8F2E1F7F|7F1F2E;
    BRA CODE_84BD43                                            ;84BD41|8000    |84BD43;
...
subUnknown849419_0x52:
    ...
    BNE CODE_84BD60                                            ;84BD5B|D003    |84BD60;
    JMP.W CODE_84BDFF                                          ;84BD5D|4CFFBD  |84BDFF;
 
 
CODE_84BD60:
    REP #$30                                                   ;84BD60|C230    |      ;
    LDA.B $D4                                                  ;84BD62|A5D4    |0000D4;
    CMP.W #$000A                                               ;84BD64|C90A00  |      ;
    BNE CODE_84BD6C                                            ;84BD67|D003    |84BD6C;
    JMP.W CODE_84BDFF                                          ;84BD69|4CFFBD  |84BDFF;
 
 
CODE_84BD6C:
    REP #$30                                                   ;84BD6C|C230    |      ;
    LDA.B $D4                                                  ;84BD6E|A5D4    |0000D4;
    CMP.W #$000C                                               ;84BD70|C90C00  |      ;
    BNE CODE_84BD78                                            ;84BD73|D003    |84BD78;
    JMP.W CODE_84BDFF                                          ;84BD75|4CFFBD  |84BDFF;
 
 
CODE_84BD78:
    REP #$30                                                   ;84BD78|C230    |      ;
    LDA.B $D4                                                  ;84BD7A|A5D4    |0000D4;
    CMP.W #$000D                                               ;84BD7C|C90D00  |      ;
    BNE CODE_84BD84                                            ;84BD7F|D003    |84BD84;
    JMP.W CODE_84BDFF                                          ;84BD81|4CFFBD  |84BDFF;
 
 
CODE_84BD84:
    REP #$30                                                   ;84BD84|C230    |      ;
    LDA.B $D4                                                  ;84BD86|A5D4    |0000D4;
    CMP.W #$001B                                               ;84BD88|C91B00  |      ;
    BNE CODE_84BD90                                            ;84BD8B|D003    |84BD90;
    JMP.W CODE_84BDFF                                          ;84BD8D|4CFFBD  |84BDFF;
 
 
CODE_84BD90:
    REP #$20                                                   ;84BD90|C220    |      ;
    LDA.B $D2                                                  ;84BD92|A5D2    |0000D2;
    AND.W #$0004                                               ;84BD94|290400  |      ;
    BNE CODE_84BDFF                                            ;84BD97|D066    |84BDFF;
    LDA.L $7F1F60                                              ;84BD99|AF601F7F|7F1F60;
    AND.W #$0006                                               ;84BD9D|290600  |      ;
    BNE CODE_84BDFF                                            ;84BDA0|D05D    |84BDFF;
    REP #$20                                                   ;84BDA2|C220    |      ;
    LDA.W $0128                                                ;84BDA4|AD2801  |000128;
    BIT.W #$0080                                               ;84BDA7|898000  |      ;
    BNE CODE_84BDAF                                            ;84BDAA|D003    |84BDAF;
    JMP.W CODE_84BDFF                                          ;84BDAC|4CFFBD  |84BDFF;
 
 
CODE_84BDAF:
    REP #$30                                                   ;84BDAF|C230    |      ;
    LDA.B $D2                                                  ;84BDB1|A5D2    |0000D2;
    AND.W #$0800                                               ;84BDB3|290008  |      ;
    BEQ CODE_84BDBB                                            ;84BDB6|F003    |84BDBB;
    JMP.W CODE_84BDFF                                          ;84BDB8|4CFFBD  |84BDFF;
 
 
CODE_84BDBB:
    SEP #$20                                                   ;84BDBB|E220    |      ;
    LDA.W $091D                                                ;84BDBD|AD1D09  |00091D;
    BEQ CODE_84BDC5                                            ;84BDC0|F003    |84BDC5;
    JMP.W CODE_84BDFF                                          ;84BDC2|4CFFBD  |84BDFF;
...
CODE_84BDC5:
    ...
    REP #$30                                                   ;84BDF1|C230    |      ;
    LDA.L $7F1F60                                              ;84BDF3|AF601F7F|7F1F60;
    ORA.W #$0002                                               ;84BDF7|090200  |      ;
    STA.L $7F1F60                                              ;84BDFA|8F601F7F|7F1F60;
    RTS                                                        ;84BDFE|60      |      ;
...
subUnknown849419_0x53:
    ...
    BNE CODE_84BE29                                            ;84BE24|D003    |84BE29;
    JMP.W CODE_84BEC8                                          ;84BE26|4CC8BE  |84BEC8;
 
 
CODE_84BE29:
    REP #$30                                                   ;84BE29|C230    |      ;
    LDA.B $D4                                                  ;84BE2B|A5D4    |0000D4;
    CMP.W #$000A                                               ;84BE2D|C90A00  |      ;
    BNE CODE_84BE35                                            ;84BE30|D003    |84BE35;
    JMP.W CODE_84BEC8                                          ;84BE32|4CC8BE  |84BEC8;
 
 
CODE_84BE35:
    REP #$30                                                   ;84BE35|C230    |      ;
    LDA.B $D4                                                  ;84BE37|A5D4    |0000D4;
    CMP.W #$000C                                               ;84BE39|C90C00  |      ;
    BNE CODE_84BE41                                            ;84BE3C|D003    |84BE41;
    JMP.W CODE_84BEC8                                          ;84BE3E|4CC8BE  |84BEC8;
 
 
CODE_84BE41:
    REP #$30                                                   ;84BE41|C230    |      ;
    LDA.B $D4                                                  ;84BE43|A5D4    |0000D4;
    CMP.W #$000D                                               ;84BE45|C90D00  |      ;
    BNE CODE_84BE4D                                            ;84BE48|D003    |84BE4D;
    JMP.W CODE_84BEC8                                          ;84BE4A|4CC8BE  |84BEC8;
 
 
CODE_84BE4D:
    REP #$30                                                   ;84BE4D|C230    |      ;
    LDA.B $D4                                                  ;84BE4F|A5D4    |0000D4;
    CMP.W #$001B                                               ;84BE51|C91B00  |      ;
    BNE CODE_84BE59                                            ;84BE54|D003    |84BE59;
    JMP.W CODE_84BEC8                                          ;84BE56|4CC8BE  |84BEC8;
 
 
CODE_84BE59:
    REP #$20                                                   ;84BE59|C220    |      ;
    LDA.B $D2                                                  ;84BE5B|A5D2    |0000D2;
    AND.W #$0004                                               ;84BE5D|290400  |      ;
    BNE CODE_84BEC8                                            ;84BE60|D066    |84BEC8;
    LDA.L $7F1F60                                              ;84BE62|AF601F7F|7F1F60;
    AND.W #$0006                                               ;84BE66|290600  |      ;
    BNE CODE_84BEC8                                            ;84BE69|D05D    |84BEC8;
    REP #$20                                                   ;84BE6B|C220    |      ;
    LDA.W $0128                                                ;84BE6D|AD2801  |000128;
    BIT.W #$0080                                               ;84BE70|898000  |      ;
    BNE CODE_84BE78                                            ;84BE73|D003    |84BE78;
    JMP.W CODE_84BEC8                                          ;84BE75|4CC8BE  |84BEC8;
 
 
CODE_84BE78:
    REP #$30                                                   ;84BE78|C230    |      ;
    LDA.B $D2                                                  ;84BE7A|A5D2    |0000D2;
    AND.W #$0800                                               ;84BE7C|290008  |      ;
    BEQ CODE_84BE84                                            ;84BE7F|F003    |84BE84;
    JMP.W CODE_84BEC8                                          ;84BE81|4CC8BE  |84BEC8;
 
 
CODE_84BE84:
    SEP #$20                                                   ;84BE84|E220    |      ;
    LDA.W $091D                                                ;84BE86|AD1D09  |00091D;
    BEQ CODE_84BE8E                                            ;84BE89|F003    |84BE8E;
    JMP.W CODE_84BEC8                                          ;84BE8B|4CC8BE  |84BEC8;
...
CODE_84BE8E:
    ...
    REP #$30                                                   ;84BEBA|C230    |      ;
    LDA.L $7F1F60                                              ;84BEBC|AF601F7F|7F1F60;
    ORA.W #$0004                                               ;84BEC0|090400  |      ;
    STA.L $7F1F60                                              ;84BEC3|8F601F7F|7F1F60;
    RTS                                                        ;84BEC7|60      |      ;
...
subUnknown849419_0x55:
    ...
    ASL A                                                      ;84BF55|0A      |      ;
    TAX                                                        ;84BF56|AA      |      ;
    LDA.L Table_84C014,X                                       ;84BF57|BF14C084|84C014;
    STA.B nTempVar1                                            ;84BF5B|857E    |00007E;
    REP #$30                                                   ;84BF5D|C230    |      ;
    ...
    AND.B nTempVar1                                            ;84BF6B|257E    |00007E;
...
Table_84C014:
    dw $0001,$0002,$0004,$0008,$0010,$0020                     ;84C014|        |      ;
...
CODE_84C0DB:
    ...
    STA.W nSoundRegisterValue0                                 ;84C0E1|8D1401  |000114;
    LDA.B #$06                                                 ;84C0E4|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C0E6|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C0E9|22328383|838332;
    RTL                                                        ;84C0ED|6B      |      ;
...
CODE_84C0EE:
    ...
    JSL.L fUnknown_82EBAC                                      ;84C0F3|22ACEB82|82EBAC;
    REP #$20                                                   ;84C0F7|C220    |      ;
    CMP.W #$0001                                               ;84C0F9|C90100  |      ;
    BEQ CODE_84C157                                            ;84C0FC|F059    |84C157;
    CMP.W #$0002                                               ;84C0FE|C90200  |      ;
    BEQ CODE_84C17E                                            ;84C101|F07B    |84C17E;
    CMP.W #$0003                                               ;84C103|C90300  |      ;
    BNE CODE_84C10B                                            ;84C106|D003    |84C10B;
    JMP.W CODE_84C1A8                                          ;84C108|4CA8C1  |84C1A8;
...
CODE_84C113:
    ...
    JSL.L fUnknown_82EBAC                                      ;84C121|22ACEB82|82EBAC;
    SEP #$20                                                   ;84C125|E220    |      ;
    PHA                                                        ;84C127|48      |      ;
...
CODE_84C144:
    ...
    STA.W nSoundRegisterValue0                                 ;84C14A|8D1401  |000114;
    LDA.B #$06                                                 ;84C14D|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C14F|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C152|22328383|838332;
    RTL                                                        ;84C156|6B      |      ;
...
CODE_84C157:
    ...
    STA.W nSoundRegisterValue0                                 ;84C171|8D1401  |000114;
    LDA.B #$06                                                 ;84C174|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C176|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C179|22328383|838332;
    RTL                                                        ;84C17D|6B      |      ;
...
CODE_84C17E:
    ...
    STA.W nSoundRegisterValue0                                 ;84C19B|8D1401  |000114;
    LDA.B #$06                                                 ;84C19E|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C1A0|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C1A3|22328383|838332;
    RTL                                                        ;84C1A7|6B      |      ;
...
CODE_84C1A8:
    ...
    STA.W nSoundRegisterValue0                                 ;84C1C5|8D1401  |000114;
    LDA.B #$06                                                 ;84C1C8|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C1CA|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C1CD|22328383|838332;
    RTL                                                        ;84C1D1|6B      |      ;
...
CODE_84C1D2:
    ...
    STA.W nSoundRegisterValue0                                 ;84C1E4|8D1401  |000114;
    LDA.B #$06                                                 ;84C1E7|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C1E9|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C1EC|22328383|838332;
    RTL                                                        ;84C1F0|6B      |      ;
...
CODE_84C1F1:
    ...
    STA.W nSoundRegisterValue0                                 ;84C1F7|8D1401  |000114;
    LDA.B #$06                                                 ;84C1FA|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C1FC|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C1FF|22328383|838332;
    RTL                                                        ;84C203|6B      |      ;
...
CODE_84C204:
    ...
    STA.W nSoundRegisterValue0                                 ;84C218|8D1401  |000114;
    LDA.B #$06                                                 ;84C21B|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C21D|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C220|22328383|838332;
    RTL                                                        ;84C224|6B      |      ;
...
CODE_84C225:
    ...
    STA.W nSoundRegisterValue0                                 ;84C239|8D1401  |000114;
    LDA.B #$06                                                 ;84C23C|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C23E|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C241|22328383|838332;
    RTL                                                        ;84C245|6B      |      ;
...
CODE_84C246:
    ...
    STA.W nSoundRegisterValue0                                 ;84C25A|8D1401  |000114;
    LDA.B #$06                                                 ;84C25D|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C25F|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C262|22328383|838332;
    RTL                                                        ;84C266|6B      |      ;
...
CODE_84C267:
    ...
    STA.W nSoundRegisterValue0                                 ;84C27B|8D1401  |000114;
    LDA.B #$06                                                 ;84C27E|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C280|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C283|22328383|838332;
    RTL                                                        ;84C287|6B      |      ;
...
CODE_84C2D8:
    ...
    STA.W nSoundRegisterValue0                                 ;84C2E4|8D1401  |000114;
    LDA.B #$06                                                 ;84C2E7|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C2E9|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C2EC|22328383|838332;
    REP #$20                                                   ;84C2F0|C220    |      ;
...
CODE_84C32D:
    ...
    STA.W nSoundRegisterValue0                                 ;84C341|8D1401  |000114;
    LDA.B #$06                                                 ;84C344|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C346|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C349|22328383|838332;
    RTL                                                        ;84C34D|6B      |      ;
...
CODE_84C34E:
    ...
    STA.W nSoundRegisterValue0                                 ;84C35A|8D1401  |000114;
    LDA.B #$06                                                 ;84C35D|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C35F|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C362|22328383|838332;
    RTL                                                        ;84C366|6B      |      ;
...
CODE_84C367:
    ...
    STA.W nSoundRegisterValue0                                 ;84C373|8D1401  |000114;
    LDA.B #$06                                                 ;84C376|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C378|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C37B|22328383|838332;
    RTL                                                        ;84C37F|6B      |      ;
...
CODE_84C3AF:
    ...
    STA.W nSoundRegisterValue0                                 ;84C3C3|8D1401  |000114;
    LDA.B #$06                                                 ;84C3C6|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C3C8|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C3CB|22328383|838332;
    RTL                                                        ;84C3CF|6B      |      ;
...
CODE_84C3D0:
    ...
    STA.W nSoundRegisterValue0                                 ;84C3DC|8D1401  |000114;
    LDA.B #$06                                                 ;84C3DF|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C3E1|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C3E4|22328383|838332;
    RTL                                                        ;84C3E8|6B      |      ;
...
CODE_84C3E9:
    ...
    STA.W nSoundRegisterValue0                                 ;84C408|8D1401  |000114;
    LDA.B #$06                                                 ;84C40B|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C40D|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C410|22328383|838332;
    RTL                                                        ;84C414|6B      |      ;
...
CODE_84C415:
    ...
    STA.W nSoundRegisterValue0                                 ;84C41B|8D1401  |000114;
    LDA.B #$06                                                 ;84C41E|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C420|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C423|22328383|838332;
    RTL                                                        ;84C427|6B      |      ;
...
CODE_84C43F:
    ...
    STA.W nSoundRegisterValue0                                 ;84C44B|8D1401  |000114;
    LDA.B #$06                                                 ;84C44E|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C450|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C453|22328383|838332;
    RTL                                                        ;84C457|6B      |      ;
...
CODE_84C47C:
    ...
    STA.W nSoundRegisterValue0                                 ;84C497|8D1401  |000114;
    LDA.B #$06                                                 ;84C49A|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C49C|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C49F|22328383|838332;
    RTL                                                        ;84C4A3|6B      |      ;
...
CODE_84C4A4:
    ...
    STA.W nSoundRegisterValue0                                 ;84C4B7|8D1401  |000114;
    LDA.B #$06                                                 ;84C4BA|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C4BC|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C4BF|22328383|838332;
    RTL                                                        ;84C4C3|6B      |      ;
...
CODE_84C4C4:
    ...
    STA.W nSoundRegisterValue0                                 ;84C4DD|8D1401  |000114;
    LDA.B #$06                                                 ;84C4E0|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C4E2|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C4E5|22328383|838332;
    RTL                                                        ;84C4E9|6B      |      ;
...
CODE_84C4EA:
    ...
    STA.W nSoundRegisterValue0                                 ;84C4FF|8D1401  |000114;
    LDA.B #$06                                                 ;84C502|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C504|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C507|22328383|838332;
    RTL                                                        ;84C50B|6B      |      ;
...
CODE_84C52D:
    ...
    STA.W nSoundRegisterValue0                                 ;84C533|8D1401  |000114;
    LDA.B #$06                                                 ;84C536|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C538|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C53B|22328383|838332;
    RTL                                                        ;84C53F|6B      |      ;
...
CODE_84C563:
    ...
    JMP.W CODE_84C684                                          ;84C56B|4C84C6  |84C684;
...
CODE_84C57A:
    ...
    STA.W nSoundRegisterValue0                                 ;84C580|8D1401  |000114;
    LDA.B #$06                                                 ;84C583|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C585|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C588|22328383|838332;
    SEP #$20                                                   ;84C58C|E220    |      ;
    ...
    JSL.L fUnknown_8394D7                                      ;84C5AE|22D79483|8394D7;
...
CODE_84C5D1:
    ...
    STA.W nSoundRegisterValue0                                 ;84C5D7|8D1401  |000114;
    LDA.B #$06                                                 ;84C5DA|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C5DC|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C5DF|22328383|838332;
    SEP #$20                                                   ;84C5E3|E220    |      ;
    ...
    JSL.L fUnknown_8394D7                                      ;84C5F1|22D79483|8394D7;
    SEP #$20                                                   ;84C5F5|E220    |      ;
...
CODE_84C612:
    ...
    STA.W nSoundRegisterValue0                                 ;84C618|8D1401  |000114;
    LDA.B #$06                                                 ;84C61B|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C61D|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C620|22328383|838332;
    SEP #$20                                                   ;84C624|E220    |      ;
...
CODE_84C651:
    ...
    STA.W nSoundRegisterValue0                                 ;84C657|8D1401  |000114;
    LDA.B #$06                                                 ;84C65A|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C65C|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C65F|22328383|838332;
    SEP #$20                                                   ;84C663|E220    |      ;
    ...
    JSL.L fUnknown_8394D7                                      ;84C671|22D79483|8394D7;
    SEP #$20                                                   ;84C675|E220    |      ;
...
CODE_84C684:
    ...
    STA.W nSoundRegisterValue0                                 ;84C68A|8D1401  |000114;
    LDA.B #$06                                                 ;84C68D|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84C68F|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84C692|22328383|838332;
    SEP #$20                                                   ;84C696|E220    |      ;
    LDA.W $018A                                                ;84C698|AD8A01  |00018A;
    CMP.B #$0B                                                 ;84C69B|C90B    |      ;
    BCC CODE_84C6B6                                            ;84C69D|9017    |84C6B6;
    REP #$20                                                   ;84C69F|C220    |      ;
    LDA.W #$0001                                               ;84C6A1|A90100  |      ;
    JSL.L fUnknown_8394D7                                      ;84C6A4|22D79483|8394D7;
    SEP #$20                                                   ;84C6A8|E220    |      ;
...
CODE_84C6CD:
    ...
    JMP.W CODE_84C7B5                                          ;84C6D6|4CB5C7  |84C7B5;
...
CODE_84C705:
    ...
    LDA.L Table_84C7B6,X                                       ;84C709|BFB6C784|84C7B6;
...
CODE_84C804:
    ...
    JMP.W CODE_84CAA5                                          ;84C80C|4CA5CA  |84CAA5;
...
CODE_84C81A:
    ...
    JMP.W CODE_84CE7A                                          ;84C822|4C7ACE  |84CE7A;
...
CODE_84C825:
    ...
    JMP.W CODE_84CEA6                                          ;84C82D|4CA6CE  |84CEA6;
...
CODE_84C830:
    ...
    JMP.W CODE_84CE0C                                          ;84C838|4C0CCE  |84CE0C;
...
CODE_84C83B:
    ...
    JMP.W CODE_84CE43                                          ;84C843|4C43CE  |84CE43;
...
CODE_84C846:
    ...
    JMP.W CODE_84CD77                                          ;84C84E|4C77CD  |84CD77;
...
CODE_84C851:
    ...
    BEQ CODE_84C85F                                            ;84C85A|F003    |84C85F;
    JMP.W CODE_84C92B                                          ;84C85C|4C2BC9  |84C92B;
 
 
CODE_84C85F:
    LDA.W $0124                                                ;84C85F|AD2401  |000124;
    BIT.W #$0400                                               ;84C862|890004  |      ;
    BNE CODE_84C88A                                            ;84C865|D023    |84C88A;
    LDA.W $0124                                                ;84C867|AD2401  |000124;
    BIT.W #$0800                                               ;84C86A|890008  |      ;
    BNE CODE_84C8AD                                            ;84C86D|D03E    |84C8AD;
    LDA.W $0124                                                ;84C86F|AD2401  |000124;
    BIT.W #$0100                                               ;84C872|890001  |      ;
    BNE CODE_84C8D0                                            ;84C875|D059    |84C8D0;
    LDA.W $0124                                                ;84C877|AD2401  |000124;
    BIT.W #$0200                                               ;84C87A|890002  |      ;
    BEQ CODE_84C882                                            ;84C87D|F003    |84C882;
    JMP.W CODE_84C8F3                                          ;84C87F|4CF3C8  |84C8F3;
 
 
CODE_84C882:
    REP #$30                                                   ;84C882|C230    |      ;
    LDA.W #$0000                                               ;84C884|A90000  |      ;
    STA.B $D4                                                  ;84C887|85D4    |0000D4;
...
CODE_84C88A:
    ...
    BNE CODE_84C897                                            ;84C892|D003    |84C897;
    JMP.W CODE_84C917                                          ;84C894|4C17C9  |84C917;
...
CODE_84C897:
    ...
    BNE CODE_84C8A4                                            ;84C89F|D003    |84C8A4;
    JMP.W CODE_84C921                                          ;84C8A1|4C21C9  |84C921;
 
 
CODE_84C8A4:
    REP #$30                                                   ;84C8A4|C230    |      ;
    LDA.W #$0000                                               ;84C8A6|A90000  |      ;
    STA.B $D4                                                  ;84C8A9|85D4    |0000D4;
    BRA CODE_84C889                                            ;84C8AB|80DC    |84C889;
...
CODE_84C8AD:
    ...
    BNE CODE_84C8BA                                            ;84C8B5|D003    |84C8BA;
    JMP.W CODE_84C917                                          ;84C8B7|4C17C9  |84C917;
...
CODE_84C8BA:
    ...
    BNE CODE_84C8C7                                            ;84C8C2|D003    |84C8C7;
    JMP.W CODE_84C921                                          ;84C8C4|4C21C9  |84C921;
 
 
CODE_84C8C7:
    REP #$30                                                   ;84C8C7|C230    |      ;
    LDA.W #$0000                                               ;84C8C9|A90000  |      ;
    STA.B $D4                                                  ;84C8CC|85D4    |0000D4;
    BRA CODE_84C889                                            ;84C8CE|80B9    |84C889;
...
CODE_84C8D0:
    ...
    BNE CODE_84C8DD                                            ;84C8D8|D003    |84C8DD;
    JMP.W CODE_84C917                                          ;84C8DA|4C17C9  |84C917;
...
CODE_84C8DD:
    ...
    BNE CODE_84C8EA                                            ;84C8E5|D003    |84C8EA;
    JMP.W CODE_84C921                                          ;84C8E7|4C21C9  |84C921;
 
 
CODE_84C8EA:
    REP #$30                                                   ;84C8EA|C230    |      ;
    LDA.W #$0000                                               ;84C8EC|A90000  |      ;
    STA.B $D4                                                  ;84C8EF|85D4    |0000D4;
    BRA CODE_84C889                                            ;84C8F1|8096    |84C889;
...
CODE_84C8F3:
    ...
    BNE CODE_84C900                                            ;84C8FB|D003    |84C900;
    JMP.W CODE_84C917                                          ;84C8FD|4C17C9  |84C917;
...
CODE_84C900:
    ...
    BNE CODE_84C90D                                            ;84C908|D003    |84C90D;
    JMP.W CODE_84C921                                          ;84C90A|4C21C9  |84C921;
 
 
CODE_84C90D:
    REP #$30                                                   ;84C90D|C230    |      ;
    LDA.W #$0000                                               ;84C90F|A90000  |      ;
    STA.B $D4                                                  ;84C912|85D4    |0000D4;
    JMP.W CODE_84C889                                          ;84C914|4C89C8  |84C889;
 
 
CODE_84C917:
    REP #$30                                                   ;84C917|C230    |      ;
    LDA.W #$0007                                               ;84C919|A90700  |      ;
    STA.B $D4                                                  ;84C91C|85D4    |0000D4;
    JMP.W CODE_84C889                                          ;84C91E|4C89C8  |84C889;
 
 
CODE_84C921:
    REP #$30                                                   ;84C921|C230    |      ;
    LDA.W #$0006                                               ;84C923|A90600  |      ;
    STA.B $D4                                                  ;84C926|85D4    |0000D4;
    JMP.W CODE_84C889                                          ;84C928|4C89C8  |84C889;
 
 
CODE_84C92B:
    REP #$30                                                   ;84C92B|C230    |      ;
    LDA.W #$0000                                               ;84C92D|A90000  |      ;
    STA.B $D4                                                  ;84C930|85D4    |0000D4;
    JMP.W CODE_84C889                                          ;84C932|4C89C8  |84C889;
...
CODE_84C935:
    ...
    BNE CODE_84C95B                                            ;84C956|D003    |84C95B;
    JMP.W CODE_84C95E                                          ;84C958|4C5EC9  |84C95E;
 
 
CODE_84C95B:
    JMP.W CODE_84C7B5                                          ;84C95B|4CB5C7  |84C7B5;
 
 
CODE_84C95E:
    REP #$30                                                   ;84C95E|C230    |      ;
    LDA.W #$0001                                               ;84C960|A90100  |      ;
    STA.B $D4                                                  ;84C963|85D4    |0000D4;
    REP #$30                                                   ;84C965|C230    |      ;
    LDA.W #$0001                                               ;84C967|A90100  |      ;
    STA.B $DA                                                  ;84C96A|85DA    |0000DA;
    JMP.W CODE_84C7B5                                          ;84C96C|4CB5C7  |84C7B5;
...
CODE_84C96F:
    ...
    BNE CODE_84C995                                            ;84C990|D003    |84C995;
    JMP.W CODE_84C998                                          ;84C992|4C98C9  |84C998;
 
 
CODE_84C995:
    JMP.W CODE_84C740                                          ;84C995|4C40C7  |84C740;
 
 
CODE_84C998:
    REP #$30                                                   ;84C998|C230    |      ;
    LDA.W #$0001                                               ;84C99A|A90100  |      ;
    STA.B $D4                                                  ;84C99D|85D4    |0000D4;
    REP #$30                                                   ;84C99F|C230    |      ;
    LDA.W #$0000                                               ;84C9A1|A90000  |      ;
    STA.B $DA                                                  ;84C9A4|85DA    |0000DA;
    JMP.W CODE_84C7B5                                          ;84C9A6|4CB5C7  |84C7B5;
...
CODE_84C9A9:
    ...
    BNE CODE_84C9CF                                            ;84C9CA|D003    |84C9CF;
    JMP.W CODE_84C9D2                                          ;84C9CC|4CD2C9  |84C9D2;
 
 
CODE_84C9CF:
    JMP.W CODE_84C740                                          ;84C9CF|4C40C7  |84C740;
 
 
CODE_84C9D2:
    REP #$30                                                   ;84C9D2|C230    |      ;
    LDA.W #$0001                                               ;84C9D4|A90100  |      ;
    STA.B $D4                                                  ;84C9D7|85D4    |0000D4;
    REP #$30                                                   ;84C9D9|C230    |      ;
    LDA.W #$0003                                               ;84C9DB|A90300  |      ;
    STA.B $DA                                                  ;84C9DE|85DA    |0000DA;
    JMP.W CODE_84C7B5                                          ;84C9E0|4CB5C7  |84C7B5;
...
CODE_84C9E3:
    ...
    BNE CODE_84CA09                                            ;84CA04|D003    |84CA09;
    JMP.W CODE_84CA0C                                          ;84CA06|4C0CCA  |84CA0C;
 
 
CODE_84CA09:
    JMP.W CODE_84C740                                          ;84CA09|4C40C7  |84C740;
 
 
CODE_84CA0C:
    REP #$30                                                   ;84CA0C|C230    |      ;
    LDA.W #$0001                                               ;84CA0E|A90100  |      ;
    STA.B $D4                                                  ;84CA11|85D4    |0000D4;
    REP #$30                                                   ;84CA13|C230    |      ;
    LDA.W #$0002                                               ;84CA15|A90200  |      ;
    STA.B $DA                                                  ;84CA18|85DA    |0000DA;
    JMP.W CODE_84C7B5                                          ;84CA1A|4CB5C7  |84C7B5;
...
CODE_84CAB1:
    ...
    JMP.W CODE_84CC1C                                          ;84CAB8|4C1CCC  |84CC1C;
...
CODE_84CABB:
    ...
    JMP.W CODE_84CAFE                                          ;84CAC4|4CFECA  |84CAFE;
...
CODE_84CAFE:
    ...
    BNE CODE_84CB2A                                            ;84CB21|D007    |84CB2A;
    REP #$30                                                   ;84CB23|C230    |      ;
    LDA.W #$001A                                               ;84CB25|A91A00  |      ;
    STA.B $D4                                                  ;84CB28|85D4    |0000D4;
...
CODE_84CB2B:
    ...
    JMP.W CODE_84CC1B                                          ;84CB4B|4C1BCC  |84CC1B;
...
CODE_84CB4E:
    ...
    JMP.W CODE_84CC1B                                          ;84CB72|4C1BCC  |84CC1B;
...
CODE_84CBA4:
    ...
    JMP.W CODE_84CC1B                                          ;84CBA9|4C1BCC  |84CC1B;
...
CODE_84CBE3:
    ...
    BCS CODE_84CBEF                                            ;84CBEB|B002    |84CBEF;
    BRA CODE_84CC1B                                            ;84CBED|802C    |84CC1B;
...
CODE_84CC1C:
    REP #$30                                                   ;84CC1C|C230    |      ;
    LDA.B $DA                                                  ;84CC1E|A5DA    |0000DA;
    CMP.W #$0000                                               ;84CC20|C90000  |      ;
    BNE CODE_84CC28                                            ;84CC23|D003    |84CC28;
    JMP.W CODE_84CC40                                          ;84CC25|4C40CC  |84CC40;
 
 
CODE_84CC28:
    CMP.W #$0001                                               ;84CC28|C90100  |      ;
    BNE CODE_84CC30                                            ;84CC2B|D003    |84CC30;
    JMP.W CODE_84CC6F                                          ;84CC2D|4C6FCC  |84CC6F;
 
 
CODE_84CC30:
    CMP.W #$0002                                               ;84CC30|C90200  |      ;
    BNE CODE_84CC38                                            ;84CC33|D003    |84CC38;
    JMP.W CODE_84CC98                                          ;84CC35|4C98CC  |84CC98;
 
 
CODE_84CC38:
    CMP.W #$0003                                               ;84CC38|C90300  |      ;
    BNE CODE_84CC40                                            ;84CC3B|D003    |84CC40;
    JMP.W CODE_84CCC0                                          ;84CC3D|4CC0CC  |84CCC0;
...
CODE_84CC40:
    ...
    REP #$30                                                   ;84CC4C|C230    |      ;
    BNE CODE_84CC53                                            ;84CC4E|D003    |84CC53;
    JMP.W CODE_84CCE8                                          ;84CC50|4CE8CC  |84CCE8;
...
CODE_84CC53:
    ...
    REP #$30                                                   ;84CC5D|C230    |      ;
    BNE CODE_84CC64                                            ;84CC5F|D003    |84CC64;
    JMP.W CODE_84CCE8                                          ;84CC61|4CE8CC  |84CCE8;
 
 
CODE_84CC64:
    LDA.W #$0000                                               ;84CC64|A90000  |      ;
    STA.B $DA                                                  ;84CC67|85DA    |0000DA;
    STA.W $0911                                                ;84CC69|8D1109  |000911;
    JMP.W CODE_84CD15                                          ;84CC6C|4C15CD  |84CD15;
...
CODE_84CCE8:
    ...
    JSL.L fUnknown_8480F8                                      ;84CD04|22F88084|8480F8;
    REP #$20                                                   ;84CD08|C220    |      ;
...
CODE_84CD37:
    ...
    BCS CODE_84CD45                                            ;84CD40|B003    |84CD45;
    JMP.W CODE_84CD71                                          ;84CD42|4C71CD  |84CD71;
...
CODE_84CD45:
    ...
    BCS CODE_84CD53                                            ;84CD4E|B003    |84CD53;
    JMP.W CODE_84CD71                                          ;84CD50|4C71CD  |84CD71;
...
CODE_84CD53:
    ...
    JMP.W CODE_84CD71                                          ;84CD68|4C71CD  |84CD71;
...
CODE_84CD83:
    ...
    JMP.W CODE_84CDDC                                          ;84CD8C|4CDCCD  |84CDDC;
...
CODE_84CE0C:
    ...
    JMP.W CODE_84CE42                                          ;84CE15|4C42CE  |84CE42;
...
CODE_84CE18:
    ...
    JMP.W CODE_84CE42                                          ;84CE21|4C42CE  |84CE42;
...
CODE_84CE24:
    ...
    JMP.W CODE_84CE42                                          ;84CE2D|4C42CE  |84CE42;
 
 
CODE_84CE30:
    REP #$30                                                   ;84CE30|C230    |      ;
    LDA.L nPlayerFlags+2                                       ;84CE32|AF681F7F|7F1F68;
...
CODE_84CE43:
    ...
    JMP.W CODE_84CE79                                          ;84CE4C|4C79CE  |84CE79;
...
CODE_84CE4F:
    ...
    JMP.W CODE_84CE79                                          ;84CE58|4C79CE  |84CE79;
...
CODE_84CE5B:
    ...
    JMP.W CODE_84CE79                                          ;84CE64|4C79CE  |84CE79;
 
 
CODE_84CE67:
    REP #$30                                                   ;84CE67|C230    |      ;
    LDA.L nPlayerFlags+2                                       ;84CE69|AF681F7F|7F1F68;
...
CODE_84CFB5:
    ...
    JMP.W CODE_84D0F4                                          ;84CFBD|4CF4D0  |84D0F4;
...
CODE_84CFCC:
    ...
    STA.W nSoundRegisterValue0                                 ;84CFD2|8D1401  |000114;
    LDA.B #$06                                                 ;84CFD5|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84CFD7|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84CFDA|22328383|838332;
...
CODE_84CFEA:
    ...
    STA.W nSoundRegisterValue0                                 ;84CFF0|8D1401  |000114;
    LDA.B #$06                                                 ;84CFF3|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84CFF5|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84CFF8|22328383|838332;
    REP #$30                                                   ;84CFFC|C230    |      ;
    ...
    BEQ CODE_84D030                                            ;84D014|F01A    |84D030;
    INC A                                                      ;84D016|1A      |      ;
...
CODE_84D01C:
    ...
    BEQ CODE_84D02B                                            ;84D01F|F00A    |84D02B;
    CMP.B #$02                                                 ;84D021|C902    |      ;
    BEQ CODE_84D02B                                            ;84D023|F006    |84D02B;
    INC A                                                      ;84D025|1A      |      ;
...
CODE_84D02B:
    ...
    BRA CODE_84D036                                            ;84D02E|8006    |84D036;
 
 
CODE_84D030:
    DEC A                                                      ;84D030|3A      |      ;
    STA.W $018F                                                ;84D031|8D8F01  |00018F;
    BRA CODE_84D036                                            ;84D034|8000    |84D036;
...
CODE_84D03A:
    ...
    STA.W nSoundRegisterValue0                                 ;84D040|8D1401  |000114;
    LDA.B #$06                                                 ;84D043|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84D045|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84D048|22328383|838332;
    REP #$30                                                   ;84D04C|C230    |      ;
    ...
    BEQ CODE_84D07C                                            ;84D061|F019    |84D07C;
    DEC A                                                      ;84D063|3A      |      ;
...
CODE_84D069:
    ...
    BCC CODE_84D077                                            ;84D06E|9007    |84D077;
    LDA.B #$02                                                 ;84D070|A902    |      ;
    STA.W $018F                                                ;84D072|8D8F01  |00018F;
    BRA CODE_84D08A                                            ;84D075|8013    |84D08A;
 
 
CODE_84D077:
    STA.W $018F                                                ;84D077|8D8F01  |00018F;
    BRA CODE_84D08A                                            ;84D07A|800E    |84D08A;
 
 
CODE_84D07C:
    LDA.W $018E                                                ;84D07C|AD8E01  |00018E;
    CMP.B #$03                                                 ;84D07F|C903    |      ;
    BEQ CODE_84D08A                                            ;84D081|F007    |84D08A;
...
CODE_84D08E:
    ...
    STA.W nSoundRegisterValue0                                 ;84D094|8D1401  |000114;
    LDA.B #$06                                                 ;84D097|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84D099|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84D09C|22328383|838332;
    SEP #$20                                                   ;84D0A0|E220    |      ;
...
CODE_84D0F4:
    ...
    STA.W nSoundRegisterValue0                                 ;84D0FA|8D1401  |000114;
    LDA.B #$06                                                 ;84D0FD|A906    |      ;
    STA.W nSoundRegisterValue1                                 ;84D0FF|8D1501  |000115;
    JSL.L fSoundSeSoundRegister2to0A                           ;84D102|22328383|838332;
    SEP #$20                                                   ;84D106|E220    |      ;
    LDA.W $018E                                                ;84D108|AD8E01  |00018E;
    CMP.B #$03                                                 ;84D10B|C903    |      ;
    BCC CODE_84D156                                            ;84D10D|9047    |84D156;
    LDA.W $018F                                                ;84D10F|AD8F01  |00018F;
    CMP.B #$02                                                 ;84D112|C902    |      ;
    BEQ CODE_84D156                                            ;84D114|F040    |84D156;
    REP #$30                                                   ;84D116|C230    |      ;
    ...
    BCC CODE_84D133                                            ;84D129|9008    |84D133;
    SEC                                                        ;84D12B|38      |      ;
    SBC.B #$03                                                 ;84D12C|E903    |      ;
    STA.W $018F                                                ;84D12E|8D8F01  |00018F;
    BRA CODE_84D156                                            ;84D131|8023    |84D156;
...
CODE_84D133:
    ...
    BEQ CODE_84D144                                            ;84D13A|F008    |84D144;
    CLC                                                        ;84D13C|18      |      ;
    ADC.B #$03                                                 ;84D13D|6903    |      ;
    STA.W $018F                                                ;84D13F|8D8F01  |00018F;
    BRA CODE_84D156                                            ;84D142|8012    |84D156;
...
CODE_84D144:
    ...
    BEQ CODE_84D156                                            ;84D14B|F009    |84D156;
