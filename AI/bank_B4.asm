...
DATA8_B48075:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Ellen, 0, 200, $B481EA)     ;B481C9
    %AICMD0x45_JumpIfBetween(nLove_Ellen, 201, 300, $B481F3)   ;B481D3
    %AICMD0x45_JumpIfBetween(nLove_Ellen, 301, 999, $B481FC)   ;B481DD
...
DATA8_B4820E:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Maria, 0, 200, $B4838C)     ;B4836B
    %AICMD0x45_JumpIfBetween(nLove_Maria, 201, 300, $B483A9)   ;B48375
    %AICMD0x45_JumpIfBetween(nLove_Maria, 301, 999, $B483C6)   ;B4837F
...
DATA8_B48400:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Eve, 0, 200, $B4858A)       ;B48569
    %AICMD0x45_JumpIfBetween(nLove_Eve, 201, 300, $B48599)     ;B48573
    %AICMD0x45_JumpIfBetween(nLove_Eve, 301, 999, $B485A8)     ;B4857D
...
DATA8_B485C6:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Nina, 0, 200, $B486C4)      ;B4868F
    %AICMD0x45_JumpIfBetween(nLove_Nina, 201, 300, $B486CD)    ;B48699
    %AICMD0x45_JumpIfBetween(nLove_Nina, 301, 999, $B486D6)    ;B486A3
...
DATA8_B486E8:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Ann, 0, 200, $B48794)       ;B48773
    %AICMD0x45_JumpIfBetween(nLove_Ann, 201, 300, $B4879D)     ;B4877D
    %AICMD0x45_JumpIfBetween(nLove_Ann, 301, 999, $B487A6)     ;B48787
...
DATA8_B4894A:
    ...
    %AICMD0x42(nMoney, $FFF830)                                ;B489A6
...
DATA8_B48B9B:
    ...
    %AICMD0x42(nMoney, $0003E8)                                ;B48BB9
    %AICMD0x3C()                                               ;B48BC0
...
DATA8_B49A5F:
    ...
    %AICMD0x45_JumpIfBetween(nFirstChildAge, 0, 60, $B49A89)   ;B49A7B
...
DATA8_B49C2A:
    ...
    %AICMD0x45_JumpIfBetween(nFirstChildAge, 0, 60, $B49C5E)   ;B49C50
...
DATA8_B49DD5:
    ...
    %AICMD0x45_JumpIfBetween(nFirstChildAge, 0, 60, $B49DFB)   ;B49DED
...
DATA8_B4A62D:
    ...
    %AICMD0x21(nPowerBerryEaten, $01)                          ;B4A85E
...
DATA8_B4B67E:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Ann, 0, 119, $B4B818)       ;B4B7E4
    %AICMD0x45_JumpIfBetween(nLove_Ann, 120, 999, $B4B7FB)     ;B4B7EE
    ...
    %AICMD0x45_JumpIfBetween(nLove_Nina, 0, 119, $B4B875)      ;B4B841
    %AICMD0x45_JumpIfBetween(nLove_Nina, 120, 999, $B4B858)    ;B4B84B
    ...
    %AICMD0x45_JumpIfBetween(nLove_Ellen, 0, 119, $B4B8D2)     ;B4B89E
    %AICMD0x45_JumpIfBetween(nLove_Ellen, 120, 999, $B4B8B5)   ;B4B8A8
    ...
    %AICMD0x45_JumpIfBetween(nLove_Eve, 0, 119, $B4B92F)       ;B4B8FB
    %AICMD0x45_JumpIfBetween(nLove_Eve, 120, 999, $B4B912)     ;B4B905
...
DATA8_B4B9C2:
    ...
    %AICMD0x45_JumpIfBetween(nLove_Maria, 0, 119, $B4BA80)     ;B4BA4C
    %AICMD0x45_JumpIfBetween(nLove_Maria, 120, 999, $B4BA63)   ;B4BA56
...
DATA8_B4C447:
    ...
    %AICMD0x42(nMoney, $000002)                                ;B4C492
