...
;                       sSecondChildNameLong+6 = $0008FB; !^ 4 ^!;      |        |      ;
                       ...
                       sShedItems = $7F1F00; !^ 32b ^!      ;      |        |      ;
;                       sShedItems+1 = $7F1F01               ;      |        |      ;
;                       sShedItems+2 = $7F1F02               ;      |        |      ;
;                       sShedItems+3 = $7F1F03               ;      |        |      ;
                       nMoney = $7F1F04; !^ 24b ^!          ;      |        |      ;
;                       nMoney+2 = $7F1F06                   ;      |        |      ;
                       nShippingProfit = $7F1F07; !^ 24bit value ^!;      |        |      ;
;                       nShippingProfit+2 = $7F1F09          ;      |        |      ;
                       nCurrentYearID = $7F1F18; !^ 8b, 00 - 1st Year, 01 - 2nd Year, 03 - 3rd Year ^!;      |        |      ;
                       nCurrentSeasonID = $7F1F19; !^ 8b ^! ;      |        |      ;
                       nCurrentWeekdayID = $7F1F1A; !^ 8b ^!;      |        |      ;
                       nCurrentDay = $7F1F1B; !^ 8b ^!      ;      |        |      ;
                       nCurrentTimeID = $7F1F1C; !^ 8b ^!   ;      |        |      ;
                       PowerBerryEaten = $7F1F36; !^ range 00h-0Ah, (ammount of flowers in garden) ^!;      |        |      ;
                       nFirstChildAge = $7F1F37; !^ 16b ^!  ;      |        |      ;
                       nSecondChildAge = $7F1F39; !^ 16b ^! ;      |        |      ;
                       PrengacyFlag = $7F1F3B               ;      |        |      ;
                       sFirstChildNameShort = $7F1F3D; !^ 4 * 16b ^!;      |        |      ;
;                       sFirstChildNameShort+1 = $7F1F3E; !^ 2 ^!;      |        |      ;
;                       sFirstChildNameShort+2 = $7F1F3F; !^ 3 ^!;      |        |      ;
;                       sFirstChildNameShort+3 = $7F1F40; !^ 4 ^!;      |        |      ;
                       sSecondChildNameShort = $7F1F41; !^ 8b * 4 ^!;      |        |      ;
;                       sSecondChildNameShort+1 = $7F1F42; !^ 2 ^!;      |        |      ;
;                       sSecondChildNameShort+2 = $7F1F43; !^ 3 ^!;      |        |      ;
;                       sSecondChildNameShort+3 = $7F1F44; !^ 4 ^!;      |        |      ;
                       nStatShippedCorns = $7F1F4A; !^ 16b ^!;      |        |      ;
                       nStatShippedTomatoes = $7F1F4C; !^ 16b ^!;      |        |      ;
                       nStatShippedTurnips = $7F1F4E; !^ 16b ^!;      |        |      ;
                       nStatShippedPotatoes = $7F1F50; !^ 16b ^!;      |        |      ;
