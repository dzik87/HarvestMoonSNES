          ...
          CODE_80809B:
                       ...
                       JSL.L LOOSE_OP_828000                ;8080A3|22008082|828000;
          ...
          CODE_80815F:
                       ...
                       JSL.L CODE_80880A                    ;80816F|220A8880|80880A;
                       JSL.L CODE_808E0F                    ;808173|220F8E80|808E0F;
                       JSL.L CODE_808846                    ;808177|22468880|808846;
                       JSL.L CODE_808980                    ;80817B|22808980|808980;
                       REP #$20                             ;80817F|C220    |      ;
                       LDA.W #$0000                         ;808181|A90000  |      ;
                       JSL.L CODE_83C8DC                    ;808184|22DCC883|83C8DC;
                       SEP #$20                             ;808188|E220    |      ;
                       REP #$10                             ;80818A|C210    |      ;
                       LDY.W #$000C                         ;80818C|A00C00  |      ;
                       LDA.W $0885                          ;80818F|AD8508  |000885;
                       STA.B [$72],Y                        ;808192|9772    |000072;
                       LDY.W #$000D                         ;808194|A00D00  |      ;
                       LDA.W $0886                          ;808197|AD8608  |000886;
                       STA.B [$72],Y                        ;80819A|9772    |000072;
                       LDY.W #$000E                         ;80819C|A00E00  |      ;
                       LDA.W $0887                          ;80819F|AD8708  |000887;
                       STA.B [$72],Y                        ;8081A2|9772    |000072;
                       LDY.W #$000F                         ;8081A4|A00F00  |      ;
                       LDA.W $0888                          ;8081A7|AD8808  |000888;
                       STA.B [$72],Y                        ;8081AA|9772    |000072;
                       REP #$20                             ;8081AC|C220    |      ;
                       ...
                       JMP.W CODE_808083                    ;8081CF|4C8380  |808083;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_8081D2:
                       SEP #$20                             ;8081D2|E220    |      ;
                       ...
                       JSL.L CODE_80880A                    ;8081E2|220A8880|80880A;
                       JSL.L CODE_808E0F                    ;8081E6|220F8E80|808E0F;
                       JSL.L CODE_808846                    ;8081EA|22468880|808846;
                       JSL.L CODE_808980                    ;8081EE|22808980|808980;
                       REP #$20                             ;8081F2|C220    |      ;
                       LDA.W #$0001                         ;8081F4|A90100  |      ;
                       JSL.L CODE_83C8DC                    ;8081F7|22DCC883|83C8DC;
                       SEP #$20                             ;8081FB|E220    |      ;
                       REP #$10                             ;8081FD|C210    |      ;
                       LDY.W #$000C                         ;8081FF|A00C00  |      ;
                       LDA.W $0885                          ;808202|AD8508  |000885;
                       STA.B [$72],Y                        ;808205|9772    |000072;
                       LDY.W #$000D                         ;808207|A00D00  |      ;
                       LDA.W $0886                          ;80820A|AD8608  |000886;
                       STA.B [$72],Y                        ;80820D|9772    |000072;
                       LDY.W #$000E                         ;80820F|A00E00  |      ;
                       LDA.W $0887                          ;808212|AD8708  |000887;
                       STA.B [$72],Y                        ;808215|9772    |000072;
                       LDY.W #$000F                         ;808217|A00F00  |      ;
                       LDA.W $0888                          ;80821A|AD8808  |000888;
                       STA.B [$72],Y                        ;80821D|9772    |000072;
                       REP #$20                             ;80821F|C220    |      ;
                       ...
                       JMP.W CODE_808083                    ;808251|4C8380  |808083;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_808254:
                       SEP #$20                             ;808254|E220    |      ;
          ...
          CODE_808338:
                       ...
                       JSL.L CODE_80880A                    ;808348|220A8880|80880A;
                       JSL.L CODE_808E0F                    ;80834C|220F8E80|808E0F;
                       JSL.L CODE_808846                    ;808350|22468880|808846;
                       JSL.L CODE_808980                    ;808354|22808980|808980;
                       SEP #$20                             ;808358|E220    |      ;
                       LDA.B #$00                           ;80835A|A900    |      ;
                       XBA                                  ;80835C|EB      |      ;
                       LDA.W $0885                          ;80835D|AD8508  |000885;
                       STA.L $7F1F3D                        ;808360|8F3D1F7F|7F1F3D;
                       REP #$20                             ;808364|C220    |      ;
                       STA.W $08ED                          ;808366|8DED08  |0008ED;
                       SEP #$20                             ;808369|E220    |      ;
                       LDA.W $0886                          ;80836B|AD8608  |000886;
                       STA.L $7F1F3E                        ;80836E|8F3E1F7F|7F1F3E;
                       REP #$20                             ;808372|C220    |      ;
                       STA.W $08EF                          ;808374|8DEF08  |0008EF;
                       SEP #$20                             ;808377|E220    |      ;
                       LDA.W $0887                          ;808379|AD8708  |000887;
                       STA.L $7F1F3F                        ;80837C|8F3F1F7F|7F1F3F;
                       REP #$20                             ;808380|C220    |      ;
                       STA.W $08F1                          ;808382|8DF108  |0008F1;
                       SEP #$20                             ;808385|E220    |      ;
                       LDA.W $0888                          ;808387|AD8808  |000888;
                       STA.L $7F1F40                        ;80838A|8F401F7F|7F1F40;
                       REP #$20                             ;80838E|C220    |      ;
                       STA.W $08F3                          ;808390|8DF308  |0008F3;
                       REP #$20                             ;808393|C220    |      ;
                       ...
                       JMP.W CODE_808083                    ;8083AB|4C8380  |808083;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_8083AE:
                       SEP #$20                             ;8083AE|E220    |      ;
                       ...
                       JSL.L CODE_80880A                    ;8083BE|220A8880|80880A;
                       JSL.L CODE_808E0F                    ;8083C2|220F8E80|808E0F;
                       JSL.L CODE_808846                    ;8083C6|22468880|808846;
                       JSL.L CODE_808980                    ;8083CA|22808980|808980;
                       SEP #$20                             ;8083CE|E220    |      ;
                       LDA.B #$00                           ;8083D0|A900    |      ;
                       XBA                                  ;8083D2|EB      |      ;
                       LDA.W $0885                          ;8083D3|AD8508  |000885;
                       STA.L $7F1F41                        ;8083D6|8F411F7F|7F1F41;
                       REP #$20                             ;8083DA|C220    |      ;
                       STA.W $08F5                          ;8083DC|8DF508  |0008F5;
                       SEP #$20                             ;8083DF|E220    |      ;
                       LDA.W $0886                          ;8083E1|AD8608  |000886;
                       STA.L $7F1F42                        ;8083E4|8F421F7F|7F1F42;
                       REP #$20                             ;8083E8|C220    |      ;
                       STA.W $08F7                          ;8083EA|8DF708  |0008F7;
                       SEP #$20                             ;8083ED|E220    |      ;
                       LDA.W $0887                          ;8083EF|AD8708  |000887;
                       STA.L $7F1F43                        ;8083F2|8F431F7F|7F1F43;
                       REP #$20                             ;8083F6|C220    |      ;
                       STA.W $08F9                          ;8083F8|8DF908  |0008F9;
                       SEP #$20                             ;8083FB|E220    |      ;
                       LDA.W $0888                          ;8083FD|AD8808  |000888;
                       STA.L $7F1F44                        ;808400|8F441F7F|7F1F44;
                       REP #$20                             ;808404|C220    |      ;
                       STA.W $08FB                          ;808406|8DFB08  |0008FB;
                       REP #$20                             ;808409|C220    |      ;
                       ...
                       JMP.W CODE_808083                    ;808421|4C8380  |808083;
                                                            ;      |        |      ;
                       db $00,$00,$F0,$00                   ;808424|        |      ;
                       SEI                                  ;808428|78      |      ;
                       CLC                                  ;808429|18      |      ;
                       XCE                                  ;80842A|FB      |      ;
                       REP #$30                             ;80842B|C230    |      ;
         ...
         DATA8_808C41:
          ...
          CODE_808F62:
                       ...
                       TAX                                  ;808F8A|AA      |      ;
                       STZ.B $42,X                          ;808F8B|7442    |000042;
                       SEP #$20                             ;808F8D|E220    |      ;
                       STZ.B $44,X                          ;808F8F|7444    |000044;
                       RTL                                  ;808F91|6B      |      ;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_808F92:
          ...
          CODE_80916F:
                       ...
                       BNE CODE_809194                      ;809188|D00A    |809194;
                       REP #$20                             ;80918A|C220    |      ;
          ...
          CODE_809194:
                       ...
                       STA.L $7F0B00,X                      ;809198|9F000B7F|7F0B00;
                                                            ;      |        |      ;
          CODE_80919C:
                       RTL                                  ;80919C|6B      |      ;
                                                            ;      |        |      ;
          ...
          CODE_80936E:
                       ...
                       JSL.L CODE_809208                    ;809373|22089280|809208;
                       SEP #$20                             ;809377|E220    |      ;
                       STZ.B $92                            ;809379|6492    |000092;
                       JSL.L CODE_8093A4                    ;80937B|22A49380|8093A4;
                       RTL                                  ;80937F|6B      |      ;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809380:
                       ...
                       JSL.L CODE_809208                    ;809385|22089280|809208;
                       SEP #$20                             ;809389|E220    |      ;
                       STZ.B $92                            ;80938B|6492    |000092;
                       JSL.L CODE_8093A4                    ;80938D|22A49380|8093A4;
                       RTL                                  ;809391|6B      |      ;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809392:
                       ...
                       JSL.L CODE_809208                    ;809397|22089280|809208;
                       SEP #$20                             ;80939B|E220    |      ;
                       STZ.B $92                            ;80939D|6492    |000092;
                       JSL.L CODE_8093A4                    ;80939F|22A49380|8093A4;
                       RTL                                  ;8093A3|6B      |      ;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_8093A4:
          ...
          CODE_8094A1:
                       ...
                       BRA CODE_8094BD                      ;8094A6|8015    |8094BD;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_8094A8:
                       REP #$30                             ;8094A8|C230    |      ;
                       LDA.W #$0003                         ;8094AA|A90300  |      ;
                       BRA CODE_8094BD                      ;8094AD|800E    |8094BD;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_8094AF:
                       REP #$30                             ;8094AF|C230    |      ;
                       LDA.W #$0004                         ;8094B1|A90400  |      ;
                       BRA CODE_8094BD                      ;8094B4|8007    |8094BD;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_8094B6:
                       REP #$30                             ;8094B6|C230    |      ;
          ...
          CODE_8094BD:
                       ...
                       TAX                                  ;8094C9|AA      |      ;
                       PHX                                  ;8094CA|DA      |      ;
                       LDA.L DATA8_80BDFC,X                 ;8094CB|BFFCBD80|80BDFC;
                       ...
                       INX                                  ;8094DD|E8      |      ;
                       PHX                                  ;8094DE|DA      |      ;
                       LDA.L DATA8_80BDFC,X                 ;8094DF|BFFCBD80|80BDFC;
                       ...
                       INX                                  ;8094F0|E8      |      ;
                       INX                                  ;8094F1|E8      |      ;
                       LDA.L DATA8_80BDFC,X                 ;8094F2|BFFCBD80|80BDFC;
          ...
          CODE_8095B3:
                       ...
                       BPL CODE_8095DD                      ;8095D8|1003    |8095DD;
          ...
          CODE_809775:
                       ...
                       JMP.W CODE_8098A8                    ;809780|4CA898  |8098A8;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809783:
                       REP #$20                             ;809783|C220    |      ;
          ...
          CODE_809828:
                       ...
                       STA.B $22                            ;809836|8522    |000022;
                       JSL.L CODE_80A7C6                    ;809838|22C6A780|80A7C6;
                       REP #$20                             ;80983C|C220    |      ;
                       SEP #$10                             ;80983E|E210    |      ;
                       LDA.W #$B9EA                         ;809840|A9EAB9  |      ;
                       STA.B $72                            ;809843|8572    |000072;
                       SEP #$20                             ;809845|E220    |      ;
                       LDA.B #$80                           ;809847|A980    |      ;
                       STA.B $74                            ;809849|8574    |000074;
                       SEP #$20                             ;80984B|E220    |      ;
                       LDA.B #$0C                           ;80984D|A90C    |      ;
                       LDX.B #$00                           ;80984F|A200    |      ;
                       LDY.B #$00                           ;809851|A000    |      ;
                       JSL.L CODE_808E48                    ;809853|22488E80|808E48;
                       REP #$20                             ;809857|C220    |      ;
                       SEP #$10                             ;809859|E210    |      ;
                       LDA.W #$B9EF                         ;80985B|A9EFB9  |      ;
                       STA.B $72                            ;80985E|8572    |000072;
                       SEP #$20                             ;809860|E220    |      ;
                       LDA.B #$80                           ;809862|A980    |      ;
                       STA.B $74                            ;809864|8574    |000074;
                       SEP #$20                             ;809866|E220    |      ;
                       LDA.B #$0D                           ;809868|A90D    |      ;
                       LDX.B #$01                           ;80986A|A201    |      ;
                       LDY.B #$00                           ;80986C|A000    |      ;
                       JSL.L CODE_808E48                    ;80986E|22488E80|808E48;
                       REP #$20                             ;809872|C220    |      ;
                       SEP #$10                             ;809874|E210    |      ;
                       LDA.W #$B9F2                         ;809876|A9F2B9  |      ;
                       STA.B $72                            ;809879|8572    |000072;
                       SEP #$20                             ;80987B|E220    |      ;
                       LDA.B #$80                           ;80987D|A980    |      ;
                       STA.B $74                            ;80987F|8574    |000074;
                       SEP #$20                             ;809881|E220    |      ;
                       LDA.B #$0E                           ;809883|A90E    |      ;
                       LDX.B #$02                           ;809885|A202    |      ;
                       LDY.B #$00                           ;809887|A000    |      ;
                       JSL.L CODE_808E48                    ;809889|22488E80|808E48;
                       REP #$20                             ;80988D|C220    |      ;
                       SEP #$10                             ;80988F|E210    |      ;
                       LDA.W #$B9F5                         ;809891|A9F5B9  |      ;
                       STA.B $72                            ;809894|8572    |000072;
                       SEP #$20                             ;809896|E220    |      ;
                       LDA.B #$80                           ;809898|A980    |      ;
                       STA.B $74                            ;80989A|8574    |000074;
                       SEP #$20                             ;80989C|E220    |      ;
                       LDA.B #$0F                           ;80989E|A90F    |      ;
                       LDX.B #$03                           ;8098A0|A203    |      ;
                       LDY.B #$00                           ;8098A2|A000    |      ;
                       JSL.L CODE_808E48                    ;8098A4|22488E80|808E48;
                                                            ;      |        |      ;
          CODE_8098A8:
          ...
          CODE_809A79:
                       ...
                       JMP.W CODE_809D0A                    ;809A81|4C0A9D  |809D0A;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809A84:
          ...
          CODE_809A8C:
                       ...
                       JMP.W CODE_809D0A                    ;809A95|4C0A9D  |809D0A;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809A98:
                       REP #$20                             ;809A98|C220    |      ;
                       ...
                       JMP.W CODE_809D0A                    ;809AA3|4C0A9D  |809D0A;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809AA6:
                       REP #$20                             ;809AA6|C220    |      ;
                       ...
                       TAX                                  ;809AC5|AA      |      ;
                       SEP #$20                             ;809AC6|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809AC8|BFF5B680|80B6F5;
                       CMP.B #$1C                           ;809ACC|C91C    |      ;
                       BNE CODE_809AD3                      ;809ACE|D003    |809AD3;
                       JMP.W CODE_809D0A                    ;809AD0|4C0A9D  |809D0A;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809AD3:
                       REP #$30                             ;809AD3|C230    |      ;
          ...
          CODE_809AF6:
                       ...
                       TAX                                  ;809B0E|AA      |      ;
                       SEP #$20                             ;809B0F|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809B11|BFF5B680|80B6F5;
                       STA.W $098B                          ;809B15|8D8B09  |00098B;
                       INX                                  ;809B18|E8      |      ;
                       INX                                  ;809B19|E8      |      ;
                       SEP #$20                             ;809B1A|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809B1C|BFF5B680|80B6F5;
                       STA.B $92                            ;809B20|8592    |000092;
                       INX                                  ;809B22|E8      |      ;
                       LDA.L Table_80B6F5,X                 ;809B23|BFF5B680|80B6F5;
          ...
          CODE_809B36:
                       SEP #$20                             ;809B36|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809B38|BFF5B680|80B6F5;
                       AND.B #$40                           ;809B3C|2940    |      ;
                       BEQ CODE_809B7D                      ;809B3E|F03D    |809B7D;
                       LDA.L CurrentDay                     ;809B40|AF1B1F7F|7F1F1B;
                       CMP.B #$01                           ;809B44|C901    |      ;
                       BEQ CODE_809B5F                      ;809B46|F017    |809B5F;
                       CMP.B #$18                           ;809B48|C918    |      ;
                       BEQ CODE_809B6E                      ;809B4A|F022    |809B6E;
                       CMP.B #$0A                           ;809B4C|C90A    |      ;
                       BCC CODE_809B7D                      ;809B4E|902D    |809B7D;
                       CMP.B #$0D                           ;809B50|C90D    |      ;
                       BCS CODE_809B7D                      ;809B52|B029    |809B7D;
                       LDA.W $098B                          ;809B54|AD8B09  |00098B;
                       CLC                                  ;809B57|18      |      ;
                       ADC.B #$04                           ;809B58|6904    |      ;
                       STA.W $098B                          ;809B5A|8D8B09  |00098B;
                       BRA CODE_809B7D                      ;809B5D|801E    |809B7D;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809B5F:
                       SEP #$20                             ;809B5F|E220    |      ;
                       LDA.L CurrentSeasonID                ;809B61|AF191F7F|7F1F19;
                       BNE CODE_809B7D                      ;809B65|D016    |809B7D;
                       LDA.B #$3A                           ;809B67|A93A    |      ;
                       STA.W $098B                          ;809B69|8D8B09  |00098B;
                       BRA CODE_809B7D                      ;809B6C|800F    |809B7D;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809B6E:
                       SEP #$20                             ;809B6E|E220    |      ;
                       LDA.L CurrentSeasonID                ;809B70|AF191F7F|7F1F19;
                       CMP.B #$03                           ;809B74|C903    |      ;
                       BNE CODE_809B7D                      ;809B76|D005    |809B7D;
          ...
          CODE_809B7D:
                       ...
                       JMP.W CODE_809C14                    ;809B85|4C149C  |809C14;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809B88:
                       LDA.L Table_80B6F5,X                 ;809B88|BFF5B680|80B6F5;
          ...
          CODE_809B9A:
                       SEP #$20                             ;809B9A|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809B9C|BFF5B680|80B6F5;
          ...
          CODE_809BAE:
                       SEP #$20                             ;809BAE|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809BB0|BFF5B680|80B6F5;
                       AND.B #$08                           ;809BB4|2908    |      ;
                       BEQ CODE_809BC4                      ;809BB6|F00C    |809BC4;
                       LDA.L CurrentWeekdayID               ;809BB8|AF1A1F7F|7F1F1A;
                       BEQ CODE_809BC4                      ;809BBC|F006    |809BC4;
                       CMP.B #$06                           ;809BBE|C906    |      ;
                       BEQ CODE_809BC4                      ;809BC0|F002    |809BC4;
                       BRA CODE_809C14                      ;809BC2|8050    |809C14;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809BC4:
                       SEP #$20                             ;809BC4|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809BC6|BFF5B680|80B6F5;
                       ...
                       LDA.L CurrentDay                     ;809BD6|AF1B1F7F|7F1F1B;
                       CMP.B #$0A                           ;809BDA|C90A    |      ;
                       BNE CODE_809BE0                      ;809BDC|D002    |809BE0;
                       BRA CODE_809C14                      ;809BDE|8034    |809C14;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809BE0:
                       SEP #$20                             ;809BE0|E220    |      ;
          ...
          CODE_809BEC:
                       SEP #$20                             ;809BEC|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809BEE|BFF5B680|80B6F5;
          ...
          CODE_809BFE:
                       SEP #$20                             ;809BFE|E220    |      ;
                       LDA.L Table_80B6F5,X                 ;809C00|BFF5B680|80B6F5;
                       ...
                       BRA CODE_809C14                      ;809C12|8000    |809C14;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809C14:
                       REP #$30                             ;809C14|C230    |      ;
          ...
          CODE_809C30:
                       ...
                       INX                                  ;809C35|E8      |      ;
                       REP #$20                             ;809C36|C220    |      ;
                       LDA.L Table_80B6F5,X                 ;809C38|BFF5B680|80B6F5;
                       STA.W $017D                          ;809C3C|8D7D01  |00017D;
                       INX                                  ;809C3F|E8      |      ;
                       INX                                  ;809C40|E8      |      ;
                       LDA.L Table_80B6F5,X                 ;809C41|BFF5B680|80B6F5;
          ...
          CODE_809D42:
                       ...
                       JMP.W CODE_809DFD                    ;809D4A|4CFD9D  |809DFD;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809D4D:
          ...
          CODE_809D58:
                       ...
                       JMP.W CODE_809E3F                    ;809D60|4C3F9E  |809E3F;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809D63:
          ...
          CODE_809D6E:
                       ...
                       JMP.W CODE_809E7D                    ;809D76|4C7D9E  |809E7D;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809D79:
                       REP #$20                             ;809D79|C220    |      ;
          ...
          CODE_809D93:
                       ...
                       JMP.W CODE_809EBB                    ;809D9C|4CBB9E  |809EBB;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809D9F:
                       REP #$30                             ;809D9F|C230    |      ;
                       ...
                       JMP.W CODE_809EBB                    ;809DA8|4CBB9E  |809EBB;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809DAB:
                       REP #$20                             ;809DAB|C220    |      ;
          ...
          CODE_809E3F:
                       ...
                       JSL.L CODE_8089F9                    ;809E4D|22F98980|8089F9;
                       BEQ CODE_809E56                      ;809E51|F003    |809E56;
                       JMP.W CODE_809EBB                    ;809E53|4CBB9E  |809EBB;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809E56:
                       REP #$20                             ;809E56|C220    |      ;
                       ...
                       BNE CODE_809EBB                      ;809E5F|D05A    |809EBB;
                       ...
                       JSL.L CODE_848097                    ;809E77|22978084|848097;
                       BRA CODE_809EBB                      ;809E7B|803E    |809EBB;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_809E7D:
                       SEP #$20                             ;809E7D|E220    |      ;
          ...
          CODE_80A18D:
                       ...
                       BRA CODE_80A21A                      ;80A1AF|8069    |80A21A;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_80A1B1:
          ...
          CODE_80A308:
                       ...
                       BRA CODE_80A395                      ;80A32A|8069    |80A395;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_80A32C:
          ...
          CODE_80A481:
                       ...
                       JMP.W CODE_80A529                    ;80A4A3|4C29A5  |80A529;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_80A4A6:
          ...
          CODE_80A617:
                       ...
                       JMP.W CODE_80A6BE                    ;80A639|4CBEA6  |80A6BE;
                                                            ;      |        |      ;
                                                            ;      |        |      ;
          CODE_80A63C:
         ...
         Table_80B6F5:
                       ...
                       db $15,$01,$0D,$00,$80,$00,$C8,$00   ;80B6FD|        |      ;
                       db $16,$01,$0D,$00,$80,$00,$C8,$00   ;80B705|        |      ;
                       db $17,$01,$0D,$00,$80,$00,$C8,$00   ;80B70D|        |      ;
                       db $27,$01,$0E,$00,$80,$00,$68,$01   ;80B715|        |      ;
                       db $28,$01,$0F,$00,$80,$00,$C8,$00   ;80B71D|        |      ;
                       db $26,$01,$10,$00,$80,$00,$C8,$00   ;80B725|        |      ;
                       db $2A,$00,$00,$00,$90,$00,$90,$02   ;80B72D|        |      ;
                       db $2A,$00,$00,$00,$B0,$00,$60,$01   ;80B735|        |      ;
                       db $00,$00,$00,$81,$88,$00,$58,$01   ;80B73D|        |      ;
                       db $00,$00,$00,$01,$A8,$01,$E8,$01   ;80B745|        |      ;
                       db $2A,$00,$23,$00,$60,$00,$98,$00   ;80B74D|        |      ;
                       db $00,$00,$00,$01,$48,$01,$68,$01   ;80B755|        |      ;
                       db $00,$00,$00,$01,$C8,$01,$68,$01   ;80B75D|        |      ;
                       db $00,$02,$00,$01,$18,$00,$C0,$01   ;80B765|        |      ;
                       db $04,$03,$00,$01,$E8,$02,$A8,$01   ;80B76D|        |      ;
                       db $10,$01,$00,$01,$48,$01,$D8,$02   ;80B775|        |      ;
                       db $0C,$02,$00,$01,$18,$00,$80,$00   ;80B77D|        |      ;
                       db $18,$01,$14,$22,$80,$00,$A8,$00   ;80B785|        |      ;
                       db $1B,$01,$15,$02,$80,$00,$C8,$01   ;80B78D|        |      ;
                       db $1C,$01,$16,$32,$90,$00,$C8,$01   ;80B795|        |      ;
                       db $1E,$01,$17,$24,$90,$00,$C8,$01   ;80B79D|        |      ;
                       db $20,$01,$18,$32,$90,$00,$C8,$01   ;80B7A5|        |      ;
                       db $22,$01,$19,$32,$90,$00,$C8,$01   ;80B7AD|        |      ;
                       db $24,$01,$1A,$32,$80,$00,$C8,$00   ;80B7B5|        |      ;
                       db $24,$00,$00,$32,$58,$00,$48,$00   ;80B7BD|        |      ;
                       db $25,$01,$1B,$32,$80,$00,$C8,$00   ;80B7C5|        |      ;
                       db $0C,$00,$00,$01,$80,$00,$18,$00   ;80B7CD|        |      ;
                       db $2B,$01,$13,$32,$80,$00,$C8,$00   ;80B7D5|        |      ;
                       db $29,$01,$00,$00,$78,$01,$80,$00   ;80B7DD|        |      ;
                       db $29,$05,$00,$00,$C8,$00,$88,$01   ;80B7E5|        |      ;
                       db $31,$01,$00,$41,$80,$00,$C8,$01   ;80B7ED|        |      ;
                       db $10,$00,$00,$01,$A8,$00,$A8,$01   ;80B7F5|        |      ;
                       db $10,$00,$00,$01,$88,$01,$18,$00   ;80B7FD|        |      ;
                       db $10,$00,$00,$01,$08,$02,$28,$02   ;80B805|        |      ;
                       db $04,$00,$00,$01,$98,$00,$98,$00   ;80B80D|        |      ;
                       db $19,$01,$1C,$00,$B0,$01,$98,$01   ;80B815|        |      ;
                       db $18,$00,$00,$00,$98,$00,$48,$00   ;80B81D|        |      ;
                       db $1A,$00,$00,$00,$98,$00,$58,$01   ;80B825|        |      ;
                       db $19,$01,$1D,$00,$50,$01,$98,$01   ;80B82D|        |      ;
                       db $04,$00,$00,$01,$70,$01,$98,$00   ;80B835|        |      ;
                       db $04,$00,$00,$01,$58,$02,$E8,$00   ;80B83D|        |      ;
                       db $1D,$01,$1E,$00,$68,$00,$B8,$00   ;80B845|        |      ;
                       db $1C,$00,$00,$00,$68,$00,$48,$01   ;80B84D|        |      ;
                       db $04,$00,$00,$01,$58,$02,$78,$03   ;80B855|        |      ;
                       db $04,$01,$1F,$01,$48,$02,$28,$03   ;80B85D|        |      ;
                       db $04,$00,$00,$01,$18,$01,$68,$03   ;80B865|        |      ;
                       db $21,$01,$20,$00,$68,$00,$C8,$00   ;80B86D|        |      ;
                       db $20,$00,$00,$00,$68,$00,$48,$01   ;80B875|        |      ;
                       db $04,$00,$00,$01,$98,$01,$68,$03   ;80B87D|        |      ;
                       db $23,$01,$21,$00,$68,$00,$B8,$00   ;80B885|        |      ;
                       db $22,$00,$00,$00,$68,$00,$48,$01   ;80B88D|        |      ;
                       db $04,$00,$00,$01,$98,$00,$68,$03   ;80B895|        |      ;
                       db $1F,$01,$22,$00,$88,$00,$C8,$00   ;80B89D|        |      ;
                       db $1E,$00,$00,$00,$88,$00,$48,$01   ;80B8A5|        |      ;
                       db $04,$00,$00,$01,$48,$02,$68,$02   ;80B8AD|        |      ;
                       db $26,$00,$00,$00,$78,$00,$48,$00   ;80B8B5|        |      ;
                       db $00,$00,$00,$01,$28,$03,$58,$03   ;80B8BD|        |      ;
                       db $04,$03,$00,$01,$68,$02,$68,$01   ;80B8C5|        |      ;
                                                            ;      |        |      ;
         DATA8_80B8CD:
                       db $00,$04,$02,$05,$03,$03,$03,$04   ;80B8CD|        |      ;
                       db $03,$01,$02,$03,$03,$03,$01,$04   ;80B8D5|        |      ;
                       db $03,$03,$04,$01,$01,$03,$01,$01   ;80B8DD|        |      ;
                       db $01,$02                           ;80B8E5|        |      ;
                                                            ;      |        |      ;
         DATA8_80B8E7:
                       db $A7,$B9,$A7,$B9,$A7,$B9,$A7,$B9   ;80B8E7|        |      ;
                       db $AB,$B9,$AB,$B9,$AB,$B9,$AB,$B9   ;80B8EF|        |      ;
                       db $B3,$B9,$B3,$B9,$B7,$B9,$BB,$B9   ;80B8F7|        |      ;
                       db $A7,$B9,$A7,$B9,$A7,$B9,$A7,$B9   ;80B8FF|        |      ;
                       db $AF,$B9,$AF,$B9,$AF,$B9,$AF,$B9   ;80B907|        |      ;
                       db $AF,$B9,$A7,$B9,$A7,$B9,$A7,$B9   ;80B90F|        |      ;
                       db $AB,$B9,$AB,$B9,$AB,$B9,$BF,$B9   ;80B917|        |      ;
                       db $AB,$B9,$AB,$B9,$D3,$B9,$AB,$B9   ;80B91F|        |      ;
                       db $AB,$B9,$AB,$B9,$AB,$B9,$AB,$B9   ;80B927|        |      ;
                       db $AB,$B9,$AB,$B9,$A7,$B9,$A7,$B9   ;80B92F|        |      ;
                       db $A7,$B9,$FF,$FF,$C3,$B9,$AF,$B9   ;80B937|        |      ;
                       db $C7,$B9,$A7,$B9,$A7,$B9,$A7,$B9   ;80B93F|        |      ;
                       db $A7,$B9,$AF,$B9,$AF,$B9,$AF,$B9   ;80B947|        |      ;
                       db $AF,$B9,$AF,$B9,$AF,$B9,$AF,$B9   ;80B94F|        |      ;
                       db $AF,$B9,$AF,$B9,$AF,$B9,$AF,$B9   ;80B957|        |      ;
                       db $CF,$B9,$FF,$FF,$FF,$FF,$FF,$FF   ;80B95F|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80B967|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80B96F|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80B977|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80B97F|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80B987|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80B98F|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$CF,$B9   ;80B997|        |      ;
                       db $CB,$B9,$FF,$FF,$C7,$B9,$C7,$B9   ;80B99F|        |      ;
                       db $01,$02,$07,$04,$05,$05,$05,$05   ;80B9A7|        |      ;
                       db $06,$06,$06,$06,$03,$03,$03,$03   ;80B9AF|        |      ;
                       db $0E,$0E,$0E,$0E,$0D,$0D,$0D,$0D   ;80B9B7|        |      ;
                       db $09,$09,$09,$09,$0F,$0F,$0F,$0F   ;80B9BF|        |      ;
                       db $0A,$0A,$0A,$0A,$0B,$0B,$0B,$0B   ;80B9C7|        |      ;
                       db $12,$12,$12,$12,$08,$08,$08,$08   ;80B9CF|        |      ;
                       db $68,$49,$08,$FF,$FF,$68,$49,$08   ;80B9D7|        |      ;
                       db $17,$7F,$08,$71,$72,$08,$FE,$FF   ;80B9DF|        |      ;
                       db $DC,$B9,$80,$10,$52,$28,$FF,$FF   ;80B9E7|        |      ;
         ...
         DATA8_80BB5C:
                       ...
                       db $FF,$12,$13,$14,$15,$FF,$FF,$16   ;80BB74|        |      ;
                       db $17,$18,$19,$FF,$FF,$1A,$1B,$1C   ;80BB7C|        |      ;
                       db $1D,$FF,$FF,$1E,$1F,$20,$21,$FF   ;80BB84|        |      ;
                       db $FF,$22,$22,$FF,$FF,$FF,$FF,$23   ;80BB8C|        |      ;
                       db $23,$FF,$FF,$FF,$FF,$FF,$FF,$24   ;80BB94|        |      ;
                       db $25,$FF,$FF,$26,$FF,$FF,$FF,$FF   ;80BB9C|        |      ;
                       db $27,$28,$29,$2A,$2B,$FF,$2C,$2D   ;80BBA4|        |      ;
                       db $2E,$2F,$30,$FF,$31,$32,$33,$34   ;80BBAC|        |      ;
                       db $35,$FF,$36,$37,$38,$39,$3A,$FF   ;80BBB4|        |      ;
                       db $FF,$3B,$3C,$3D,$3E,$FF,$FF,$3F   ;80BBBC|        |      ;
                       db $40,$41,$42,$FF,$FF,$43,$44,$45   ;80BBC4|        |      ;
                       db $46,$FF,$FF,$47,$48,$49,$4A,$FF   ;80BBCC|        |      ;
                       db $FF,$FF,$FF,$FF,$4A,$FF,$4B,$4B   ;80BBD4|        |      ;
                       db $4B,$4B,$4B,$4C,$4B,$4B,$4B,$4B   ;80BBDC|        |      ;
                       db $4B,$4C,$4B,$4B,$4B,$4B,$4B,$4C   ;80BBE4|        |      ;
                       db $FF,$4D,$4D,$FF,$FF,$FF,$FF,$4D   ;80BBEC|        |      ;
                       db $4D,$FF,$FF,$FF,$FF,$4D,$4D,$FF   ;80BBF4|        |      ;
                       db $FF,$FF,$FF,$4E,$4E,$FF,$FF,$FF   ;80BBFC|        |      ;
                       db $FF,$4F,$4F,$FF,$FF,$FF,$FF,$4F   ;80BC04|        |      ;
                       db $4F,$FF,$FF,$FF,$FF,$FF,$FF,$50   ;80BC0C|        |      ;
                       db $50,$FF,$FF,$FF,$FF,$50,$50,$FF   ;80BC14|        |      ;
                       db $FF,$51,$51,$FF,$FF,$FF,$FF,$51   ;80BC1C|        |      ;
                       db $51,$FF,$FF,$FF,$FF,$52,$52,$FF   ;80BC24|        |      ;
                       db $FF,$FF,$FF,$52,$52,$FF,$FF,$FF   ;80BC2C|        |      ;
                       db $FF,$53,$53,$FF,$FF,$FF,$FF,$54   ;80BC34|        |      ;
                       db $54,$FF,$FF,$FF,$55,$55,$55,$55   ;80BC3C|        |      ;
                       db $55,$FF,$56,$56,$56,$56,$56,$FF   ;80BC44|        |      ;
                       db $56,$56,$56,$56,$56,$FF,$FF,$57   ;80BC4C|        |      ;
                       db $57,$57,$57,$FF,$57,$57,$57,$57   ;80BC54|        |      ;
                       db $57,$FF,$FF,$58,$58,$FF,$FF,$FF   ;80BC5C|        |      ;
                       db $FF,$59,$FF,$FF,$FF,$FF,$FF,$12   ;80BC64|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$16,$FF,$FF   ;80BC6C|        |      ;
                       db $FF,$FF,$FF,$1A,$FF,$FF,$FF,$FF   ;80BC74|        |      ;
                       db $FF,$1E,$FF,$FF,$FF,$FF,$FF,$5A   ;80BC7C|        |      ;
                       db $5B,$5C,$5D,$FF,$FF,$5E,$5F,$60   ;80BC84|        |      ;
                       db $61,$FF,$FF,$62,$63,$64,$65,$FF   ;80BC8C|        |      ;
                       db $FF,$66,$67,$68,$69,$FF,$FF,$5A   ;80BC94|        |      ;
                       db $5B,$5C,$5D,$FF,$FF,$5E,$5F,$60   ;80BC9C|        |      ;
                       db $61,$FF,$FF,$62,$63,$64,$65,$FF   ;80BCA4|        |      ;
                       db $FF,$66,$67,$68,$69,$FF,$FF,$FF   ;80BCAC|        |      ;
                       db $FF,$FF,$69,$FF,$69,$6A,$6A,$6A   ;80BCB4|        |      ;
                       db $6A,$FF,$FF,$5A,$5B,$5C,$5D,$FF   ;80BCBC|        |      ;
                       db $28,$FF,$FF,$FF,$FF,$FF,$04,$FF   ;80BCC4|        |      ;
                       db $FF,$FF,$FF,$FF,$04,$FF,$FF,$FF   ;80BCCC|        |      ;
                       db $FF,$FF,$04,$FF,$FF,$FF,$FF,$FF   ;80BCD4|        |      ;
                       db $04,$FF,$FF,$FF,$FF,$FF,$04,$FF   ;80BCDC|        |      ;
                       db $FF,$FF,$FF,$FF,$16,$FF,$FF,$FF   ;80BCE4|        |      ;
                       db $FF,$FF,$04,$FF,$FF,$FF,$FF,$FF   ;80BCEC|        |      ;
                       db $04,$FF,$FF,$FF,$FF,$FF,$04,$FF   ;80BCF4|        |      ;
                       db $FF,$FF,$FF,$FF,$04,$FF,$FF,$FF   ;80BCFC|        |      ;
                       db $FF,$FF,$04,$FF,$FF,$FF,$FF,$FF   ;80BD04|        |      ;
                       db $3F,$FF,$FF,$FF,$FF,$FF,$04,$FF   ;80BD0C|        |      ;
                       db $FF,$FF,$FF,$FF,$04,$FF,$FF,$FF   ;80BD14|        |      ;
                       db $FF,$FF,$70,$FF,$FF,$FF,$FF,$FF   ;80BD1C|        |      ;
                       db $70,$FF,$FF,$FF,$FF,$FF,$70,$FF   ;80BD24|        |      ;
                       db $FF,$FF,$FF,$FF,$70,$FF,$FF,$FF   ;80BD2C|        |      ;
                       db $FF,$FF,$70,$FF,$FF,$FF,$FF,$FF   ;80BD34|        |      ;
                       db $70,$FF,$FF,$FF,$FF,$FF,$70,$FF   ;80BD3C|        |      ;
                       db $FF,$FF,$FF,$FF,$70,$FF,$FF,$FF   ;80BD44|        |      ;
                       db $FF,$FF,$70,$FF,$FF,$FF,$FF,$FF   ;80BD4C|        |      ;
                       db $70,$FF,$FF,$FF,$FF,$FF,$70,$FF   ;80BD54|        |      ;
                       db $FF,$FF,$FF,$FF,$70,$FF,$FF,$FF   ;80BD5C|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD64|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD6C|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD74|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD7C|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD84|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD8C|        |      ;
                       db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF   ;80BD94|        |      ;
                                                            ;      |        |      ;
         DATA8_80BD9C:
                       ...
                       db $A8,$08,$76,$3B,$92,$2A,$07,$11   ;80BDDC|        |      ;
                       db $CE,$19,$2A,$11,$85,$08,$CF,$1D   ;80BDE4|        |      ;
                       db $2B,$0D,$66,$00,$70,$01,$CC,$04   ;80BDEC|        |      ;
                       db $24,$00,$CE,$19,$2A,$11,$85,$08   ;80BDF4|        |      ;
                                                            ;      |        |      ;
         DATA8_80BDFC:
                       db $00,$00,$00,$00,$00,$00,$29,$7A   ;80BDFC|        |      ;
                       db $A0,$5D,$00,$41,$1F,$03,$DF,$01   ;80BE04|        |      ;
                       db $F8,$00,$1F,$73,$5E,$62,$B9,$41   ;80BE0C|        |      ;
                       db $56,$1A,$B0,$0D,$2D,$1D,$FF,$53   ;80BE14|        |      ;
                       db $FE,$02,$16,$02,$00,$00,$00,$00   ;80BE1C|        |      ;
                       db $00,$00,$EA,$61,$80,$51,$20,$45   ;80BE24|        |      ;
                       db $DB,$1D,$78,$01,$B5,$00,$7D,$6A   ;80BE2C|        |      ;
                       db $F9,$55,$14,$31,$8F,$09,$2B,$1D   ;80BE34|        |      ;
                       db $09,$15,$FC,$0A,$7B,$02,$92,$01   ;80BE3C|        |      ;
                                                            ;      |        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BE44|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BE4C|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6C,$6B,$6B   ;80BE54|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BE5C|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BE64|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6B,$6B,$6B   ;80BE6C|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6B,$6B,$6B   ;80BE74|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6B,$6B,$6B   ;80BE7C|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6B,$6B,$6B   ;80BE84|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6B,$6B,$6B   ;80BE8C|        |      ;
                       db $6B,$6B,$6C,$6C,$6C,$6C,$6B,$6B   ;80BE94|        |      ;
                       db $6B,$6B,$6B,$6B,$6B,$6B,$6B,$6B   ;80BE9C|        |      ;
                       db $6B,$6B,$6B,$6C,$6B,$6C,$6B,$6C   ;80BEA4|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BEAC|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6B,$6B,$6C   ;80BEB4|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BEBC|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BEC4|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$6B,$6C   ;80BECC|        |      ;
                       db $6B,$6C,$6B,$6C,$6B,$6C,$FF,$FF   ;80BED4|        |      ;
         ...
         DATA8_80BEEC:
                       ...
                       STA.B $72                            ;80C94C|8572    |000072;
                       SEP #$20                             ;80C94E|E220    |      ;
                       LDA.B #$80                           ;80C950|A980    |      ;
                       STA.B $74                            ;80C952|8574    |000074;
                       SEP #$20                             ;80C954|E220    |      ;
                       LDA.B #$08                           ;80C956|A908    |      ;
                       LDX.B #$04                           ;80C958|A204    |      ;
                       LDY.B #$01                           ;80C95A|A001    |      ;
                       JSL.L CODE_808E48                    ;80C95C|22488E80|808E48;
                       REP #$20                             ;80C960|C220    |      ;
                       SEP #$10                             ;80C962|E210    |      ;
                       LDA.W #$E25D                         ;80C964|A95DE2  |      ;
                       STA.B $72                            ;80C967|8572    |000072;
                       SEP #$20                             ;80C969|E220    |      ;
                       LDA.B #$80                           ;80C96B|A980    |      ;
                       STA.B $74                            ;80C96D|8574    |000074;
                       SEP #$20                             ;80C96F|E220    |      ;
                       LDA.B #$0B                           ;80C971|A90B    |      ;
                       LDX.B #$05                           ;80C973|A205    |      ;
                       LDY.B #$01                           ;80C975|A001    |      ;
                       JSL.L CODE_808E48                    ;80C977|22488E80|808E48;
                       REP #$20                             ;80C97B|C220    |      ;
                       SEP #$10                             ;80C97D|E210    |      ;
                       LDA.W #$E268                         ;80C97F|A968E2  |      ;
                       STA.B $72                            ;80C982|8572    |000072;
                       SEP #$20                             ;80C984|E220    |      ;
                       LDA.B #$80                           ;80C986|A980    |      ;
                       STA.B $74                            ;80C988|8574    |000074;
                       SEP #$20                             ;80C98A|E220    |      ;
                       LDA.B #$0C                           ;80C98C|A90C    |      ;
                       LDX.B #$06                           ;80C98E|A206    |      ;
                       LDY.B #$01                           ;80C990|A001    |      ;
                       JSL.L CODE_808E48                    ;80C992|22488E80|808E48;
                       REP #$20                             ;80C996|C220    |      ;
                       SEP #$10                             ;80C998|E210    |      ;
                       LDA.W #$E273                         ;80C99A|A973E2  |      ;
                       STA.B $72                            ;80C99D|8572    |000072;
                       SEP #$20                             ;80C99F|E220    |      ;
                       LDA.B #$80                           ;80C9A1|A980    |      ;
                       STA.B $74                            ;80C9A3|8574    |000074;
                       SEP #$20                             ;80C9A5|E220    |      ;
                       ...
                       STA.B $72                            ;80C9B9|8572    |000072;
                       SEP #$20                             ;80C9BB|E220    |      ;
                       LDA.B #$80                           ;80C9BD|A980    |      ;
                       STA.B $74                            ;80C9BF|8574    |000074;
                       SEP #$20                             ;80C9C1|E220    |      ;
                       LDA.B #$07                           ;80C9C3|A907    |      ;
                       LDX.B #$04                           ;80C9C5|A204    |      ;
                       LDY.B #$02                           ;80C9C7|A002    |      ;
                       JSL.L CODE_808E48                    ;80C9C9|22488E80|808E48;
                       REP #$20                             ;80C9CD|C220    |      ;
                       SEP #$10                             ;80C9CF|E210    |      ;
                       LDA.W #$E289                         ;80C9D1|A989E2  |      ;
                       STA.B $72                            ;80C9D4|8572    |000072;
                       SEP #$20                             ;80C9D6|E220    |      ;
                       LDA.B #$80                           ;80C9D8|A980    |      ;
                       STA.B $74                            ;80C9DA|8574    |000074;
                       SEP #$20                             ;80C9DC|E220    |      ;
                       LDA.B #$08                           ;80C9DE|A908    |      ;
                       LDX.B #$05                           ;80C9E0|A205    |      ;
                       LDY.B #$02                           ;80C9E2|A002    |      ;
                       JSL.L CODE_808E48                    ;80C9E4|22488E80|808E48;
                       REP #$20                             ;80C9E8|C220    |      ;
                       SEP #$10                             ;80C9EA|E210    |      ;
                       LDA.W #$E294                         ;80C9EC|A994E2  |      ;
                       STA.B $72                            ;80C9EF|8572    |000072;
                       SEP #$20                             ;80C9F1|E220    |      ;
                       LDA.B #$80                           ;80C9F3|A980    |      ;
                       STA.B $74                            ;80C9F5|8574    |000074;
                       SEP #$20                             ;80C9F7|E220    |      ;
                       LDA.B #$0D                           ;80C9F9|A90D    |      ;
                       LDX.B #$06                           ;80C9FB|A206    |      ;
                       LDY.B #$02                           ;80C9FD|A002    |      ;
                       JSL.L CODE_808E48                    ;80C9FF|22488E80|808E48;
                       REP #$20                             ;80CA03|C220    |      ;
                       SEP #$10                             ;80CA05|E210    |      ;
                       LDA.W #$E29F                         ;80CA07|A99FE2  |      ;
                       STA.B $72                            ;80CA0A|8572    |000072;
                       SEP #$20                             ;80CA0C|E220    |      ;
                       LDA.B #$80                           ;80CA0E|A980    |      ;
                       STA.B $74                            ;80CA10|8574    |000074;
                       SEP #$20                             ;80CA12|E220    |      ;
                       ...
                       STA.B $72                            ;80CA26|8572    |000072;
                       SEP #$20                             ;80CA28|E220    |      ;
                       LDA.B #$80                           ;80CA2A|A980    |      ;
                       STA.B $74                            ;80CA2C|8574    |000074;
                       SEP #$20                             ;80CA2E|E220    |      ;
                       LDA.B #$0A                           ;80CA30|A90A    |      ;
                       LDX.B #$04                           ;80CA32|A204    |      ;
                       LDY.B #$01                           ;80CA34|A001    |      ;
                       JSL.L CODE_808E48                    ;80CA36|22488E80|808E48;
                       REP #$20                             ;80CA3A|C220    |      ;
                       SEP #$10                             ;80CA3C|E210    |      ;
                       LDA.W #$E2B5                         ;80CA3E|A9B5E2  |      ;
                       STA.B $72                            ;80CA41|8572    |000072;
                       SEP #$20                             ;80CA43|E220    |      ;
                       LDA.B #$80                           ;80CA45|A980    |      ;
                       STA.B $74                            ;80CA47|8574    |000074;
                       SEP #$20                             ;80CA49|E220    |      ;
                       LDA.B #$0B                           ;80CA4B|A90B    |      ;
                       LDX.B #$05                           ;80CA4D|A205    |      ;
                       LDY.B #$01                           ;80CA4F|A001    |      ;
                       JSL.L CODE_808E48                    ;80CA51|22488E80|808E48;
                       REP #$20                             ;80CA55|C220    |      ;
                       SEP #$10                             ;80CA57|E210    |      ;
                       LDA.W #$E2C0                         ;80CA59|A9C0E2  |      ;
                       STA.B $72                            ;80CA5C|8572    |000072;
                       SEP #$20                             ;80CA5E|E220    |      ;
                       LDA.B #$80                           ;80CA60|A980    |      ;
                       STA.B $74                            ;80CA62|8574    |000074;
                       SEP #$20                             ;80CA64|E220    |      ;
                       LDA.B #$0C                           ;80CA66|A90C    |      ;
                       LDX.B #$06                           ;80CA68|A206    |      ;
                       LDY.B #$01                           ;80CA6A|A001    |      ;
                       JSL.L CODE_808E48                    ;80CA6C|22488E80|808E48;
                       REP #$20                             ;80CA70|C220    |      ;
                       SEP #$10                             ;80CA72|E210    |      ;
                       LDA.W #$E2CB                         ;80CA74|A9CBE2  |      ;
                       STA.B $72                            ;80CA77|8572    |000072;
                       SEP #$20                             ;80CA79|E220    |      ;
                       LDA.B #$80                           ;80CA7B|A980    |      ;
                       STA.B $74                            ;80CA7D|8574    |000074;
                       SEP #$20                             ;80CA7F|E220    |      ;
                       ...
                       STA.B $72                            ;80CCEB|8572    |000072;
                       SEP #$20                             ;80CCED|E220    |      ;
                       LDA.B #$80                           ;80CCEF|A980    |      ;
                       STA.B $74                            ;80CCF1|8574    |000074;
                       SEP #$20                             ;80CCF3|E220    |      ;
                       LDA.B #$06                           ;80CCF5|A906    |      ;
                       LDX.B #$04                           ;80CCF7|A204    |      ;
                       LDY.B #$02                           ;80CCF9|A002    |      ;
                       JSL.L CODE_808E48                    ;80CCFB|22488E80|808E48;
                       REP #$20                             ;80CCFF|C220    |      ;
                       SEP #$10                             ;80CD01|E210    |      ;
                       LDA.W #$E3D7                         ;80CD03|A9D7E3  |      ;
                       STA.B $72                            ;80CD06|8572    |000072;
                       SEP #$20                             ;80CD08|E220    |      ;
                       LDA.B #$80                           ;80CD0A|A980    |      ;
                       STA.B $74                            ;80CD0C|8574    |000074;
                       SEP #$20                             ;80CD0E|E220    |      ;
                       LDA.B #$0E                           ;80CD10|A90E    |      ;
                       LDX.B #$05                           ;80CD12|A205    |      ;
                       LDY.B #$02                           ;80CD14|A002    |      ;
                       JSL.L CODE_808E48                    ;80CD16|22488E80|808E48;
                       REP #$20                             ;80CD1A|C220    |      ;
                       SEP #$10                             ;80CD1C|E210    |      ;
                       LDA.W #$E3E5                         ;80CD1E|A9E5E3  |      ;
                       STA.B $72                            ;80CD21|8572    |000072;
                       SEP #$20                             ;80CD23|E220    |      ;
                       LDA.B #$80                           ;80CD25|A980    |      ;
                       STA.B $74                            ;80CD27|8574    |000074;
                       SEP #$20                             ;80CD29|E220    |      ;
                       ...
                       STA.B $72                            ;80CD3D|8572    |000072;
                       SEP #$20                             ;80CD3F|E220    |      ;
                       LDA.B #$80                           ;80CD41|A980    |      ;
                       STA.B $74                            ;80CD43|8574    |000074;
                       SEP #$20                             ;80CD45|E220    |      ;
                       LDA.B #$06                           ;80CD47|A906    |      ;
                       LDX.B #$04                           ;80CD49|A204    |      ;
                       LDY.B #$02                           ;80CD4B|A002    |      ;
                       JSL.L CODE_808E48                    ;80CD4D|22488E80|808E48;
                       REP #$20                             ;80CD51|C220    |      ;
                       SEP #$10                             ;80CD53|E210    |      ;
                       LDA.W #$E401                         ;80CD55|A901E4  |      ;
                       STA.B $72                            ;80CD58|8572    |000072;
                       SEP #$20                             ;80CD5A|E220    |      ;
                       LDA.B #$80                           ;80CD5C|A980    |      ;
                       STA.B $74                            ;80CD5E|8574    |000074;
                       SEP #$20                             ;80CD60|E220    |      ;
                       LDA.B #$0E                           ;80CD62|A90E    |      ;
                       LDX.B #$05                           ;80CD64|A205    |      ;
                       LDY.B #$02                           ;80CD66|A002    |      ;
                       JSL.L CODE_808E48                    ;80CD68|22488E80|808E48;
                       REP #$20                             ;80CD6C|C220    |      ;
                       SEP #$10                             ;80CD6E|E210    |      ;
                       LDA.W #$E40F                         ;80CD70|A90FE4  |      ;
                       STA.B $72                            ;80CD73|8572    |000072;
                       SEP #$20                             ;80CD75|E220    |      ;
                       LDA.B #$80                           ;80CD77|A980    |      ;
                       STA.B $74                            ;80CD79|8574    |000074;
                       SEP #$20                             ;80CD7B|E220    |      ;
                       ...
                       STA.B $72                            ;80D001|8572    |000072;
                       SEP #$20                             ;80D003|E220    |      ;
                       LDA.B #$80                           ;80D005|A980    |      ;
                       STA.B $74                            ;80D007|8574    |000074;
                       SEP #$20                             ;80D009|E220    |      ;
                       LDA.B #$03                           ;80D00B|A903    |      ;
                       LDX.B #$04                           ;80D00D|A204    |      ;
                       LDY.B #$02                           ;80D00F|A002    |      ;
                       JSL.L CODE_808E48                    ;80D011|22488E80|808E48;
                       REP #$20                             ;80D015|C220    |      ;
                       SEP #$10                             ;80D017|E210    |      ;
                       LDA.W #$E5CC                         ;80D019|A9CCE5  |      ;
                       STA.B $72                            ;80D01C|8572    |000072;
                       SEP #$20                             ;80D01E|E220    |      ;
                       LDA.B #$80                           ;80D020|A980    |      ;
                       STA.B $74                            ;80D022|8574    |000074;
                       SEP #$20                             ;80D024|E220    |      ;
                       LDA.B #$04                           ;80D026|A904    |      ;
                       LDX.B #$05                           ;80D028|A205    |      ;
                       LDY.B #$02                           ;80D02A|A002    |      ;
                       JSL.L CODE_808E48                    ;80D02C|22488E80|808E48;
                       REP #$20                             ;80D030|C220    |      ;
                       SEP #$10                             ;80D032|E210    |      ;
                       LDA.W #$E5DD                         ;80D034|A9DDE5  |      ;
                       STA.B $72                            ;80D037|8572    |000072;
                       SEP #$20                             ;80D039|E220    |      ;
                       LDA.B #$80                           ;80D03B|A980    |      ;
                       STA.B $74                            ;80D03D|8574    |000074;
                       SEP #$20                             ;80D03F|E220    |      ;
                       LDA.B #$05                           ;80D041|A905    |      ;
                       LDX.B #$06                           ;80D043|A206    |      ;
                       LDY.B #$02                           ;80D045|A002    |      ;
                       JSL.L CODE_808E48                    ;80D047|22488E80|808E48;
                       REP #$20                             ;80D04B|C220    |      ;
                       SEP #$10                             ;80D04D|E210    |      ;
                       LDA.W #$E5EE                         ;80D04F|A9EEE5  |      ;
                       STA.B $72                            ;80D052|8572    |000072;
                       SEP #$20                             ;80D054|E220    |      ;
                       LDA.B #$80                           ;80D056|A980    |      ;
                       STA.B $74                            ;80D058|8574    |000074;
                       SEP #$20                             ;80D05A|E220    |      ;
                       ...
                       STA.B $72                            ;80D972|8572    |000072;
                       SEP #$20                             ;80D974|E220    |      ;
                       LDA.B #$80                           ;80D976|A980    |      ;
                       STA.B $74                            ;80D978|8574    |000074;
                       SEP #$20                             ;80D97A|E220    |      ;
                       LDA.B #$0A                           ;80D97C|A90A    |      ;
                       LDX.B #$04                           ;80D97E|A204    |      ;
                       LDY.B #$04                           ;80D980|A004    |      ;
                       JSL.L CODE_808E48                    ;80D982|22488E80|808E48;
                       REP #$20                             ;80D986|C220    |      ;
                       SEP #$10                             ;80D988|E210    |      ;
                       LDA.W #$ED17                         ;80D98A|A917ED  |      ;
                       STA.B $72                            ;80D98D|8572    |000072;
                       SEP #$20                             ;80D98F|E220    |      ;
                       LDA.B #$80                           ;80D991|A980    |      ;
                       STA.B $74                            ;80D993|8574    |000074;
                       SEP #$20                             ;80D995|E220    |      ;
                       ...
                       STA.B $72                            ;80D9A9|8572    |000072;
                       SEP #$20                             ;80D9AB|E220    |      ;
                       LDA.B #$80                           ;80D9AD|A980    |      ;
                       STA.B $74                            ;80D9AF|8574    |000074;
                       SEP #$20                             ;80D9B1|E220    |      ;
                       LDA.B #$0A                           ;80D9B3|A90A    |      ;
                       LDX.B #$04                           ;80D9B5|A204    |      ;
                       LDY.B #$04                           ;80D9B7|A004    |      ;
                       JSL.L CODE_808E48                    ;80D9B9|22488E80|808E48;
                       REP #$20                             ;80D9BD|C220    |      ;
                       SEP #$10                             ;80D9BF|E210    |      ;
                       LDA.W #$ED39                         ;80D9C1|A939ED  |      ;
                       STA.B $72                            ;80D9C4|8572    |000072;
                       SEP #$20                             ;80D9C6|E220    |      ;
                       LDA.B #$80                           ;80D9C8|A980    |      ;
                       STA.B $74                            ;80D9CA|8574    |000074;
                       SEP #$20                             ;80D9CC|E220    |      ;
                       ...
                       STA.B $72                            ;80D9E0|8572    |000072;
                       SEP #$20                             ;80D9E2|E220    |      ;
                       LDA.B #$80                           ;80D9E4|A980    |      ;
                       STA.B $74                            ;80D9E6|8574    |000074;
                       SEP #$20                             ;80D9E8|E220    |      ;
                       LDA.B #$0A                           ;80D9EA|A90A    |      ;
                       LDX.B #$04                           ;80D9EC|A204    |      ;
                       LDY.B #$04                           ;80D9EE|A004    |      ;
                       JSL.L CODE_808E48                    ;80D9F0|22488E80|808E48;
                       REP #$20                             ;80D9F4|C220    |      ;
                       SEP #$10                             ;80D9F6|E210    |      ;
                       LDA.W #$ED5B                         ;80D9F8|A95BED  |      ;
                       STA.B $72                            ;80D9FB|8572    |000072;
                       SEP #$20                             ;80D9FD|E220    |      ;
                       LDA.B #$80                           ;80D9FF|A980    |      ;
                       STA.B $74                            ;80DA01|8574    |000074;
                       SEP #$20                             ;80DA03|E220    |      ;
                       ...
                       STA.B $72                            ;80DA4E|8572    |000072;
                       SEP #$20                             ;80DA50|E220    |      ;
                       LDA.B #$80                           ;80DA52|A980    |      ;
                       STA.B $74                            ;80DA54|8574    |000074;
                       SEP #$20                             ;80DA56|E220    |      ;
                       LDA.B #$0B                           ;80DA58|A90B    |      ;
                       LDX.B #$04                           ;80DA5A|A204    |      ;
                       LDY.B #$04                           ;80DA5C|A004    |      ;
                       JSL.L CODE_808E48                    ;80DA5E|22488E80|808E48;
                       REP #$20                             ;80DA62|C220    |      ;
                       SEP #$10                             ;80DA64|E210    |      ;
                       LDA.W #$EDAB                         ;80DA66|A9ABED  |      ;
                       STA.B $72                            ;80DA69|8572    |000072;
                       SEP #$20                             ;80DA6B|E220    |      ;
                       LDA.B #$80                           ;80DA6D|A980    |      ;
                       STA.B $74                            ;80DA6F|8574    |000074;
                       SEP #$20                             ;80DA71|E220    |      ;
                       LDA.B #$0C                           ;80DA73|A90C    |      ;
                       LDX.B #$05                           ;80DA75|A205    |      ;
                       LDY.B #$04                           ;80DA77|A004    |      ;
                       JSL.L CODE_808E48                    ;80DA79|22488E80|808E48;
                       REP #$20                             ;80DA7D|C220    |      ;
                       SEP #$10                             ;80DA7F|E210    |      ;
                       LDA.W #$EDBC                         ;80DA81|A9BCED  |      ;
                       STA.B $72                            ;80DA84|8572    |000072;
                       SEP #$20                             ;80DA86|E220    |      ;
                       LDA.B #$80                           ;80DA88|A980    |      ;
                       STA.B $74                            ;80DA8A|8574    |000074;
                       SEP #$20                             ;80DA8C|E220    |      ;
                       LDA.B #$0D                           ;80DA8E|A90D    |      ;
                       LDX.B #$06                           ;80DA90|A206    |      ;
                       LDY.B #$04                           ;80DA92|A004    |      ;
                       JSL.L CODE_808E48                    ;80DA94|22488E80|808E48;
                       REP #$20                             ;80DA98|C220    |      ;
                       SEP #$10                             ;80DA9A|E210    |      ;
                       LDA.W #$EDCD                         ;80DA9C|A9CDED  |      ;
                       STA.B $72                            ;80DA9F|8572    |000072;
                       SEP #$20                             ;80DAA1|E220    |      ;
                       LDA.B #$80                           ;80DAA3|A980    |      ;
                       STA.B $74                            ;80DAA5|8574    |000074;
                       SEP #$20                             ;80DAA7|E220    |      ;
                       ...
                       STA.B $72                            ;80DABB|8572    |000072;
                       SEP #$20                             ;80DABD|E220    |      ;
                       LDA.B #$80                           ;80DABF|A980    |      ;
                       STA.B $74                            ;80DAC1|8574    |000074;
                       SEP #$20                             ;80DAC3|E220    |      ;
                       LDA.B #$0C                           ;80DAC5|A90C    |      ;
                       LDX.B #$04                           ;80DAC7|A204    |      ;
                       LDY.B #$04                           ;80DAC9|A004    |      ;
                       JSL.L CODE_808E48                    ;80DACB|22488E80|808E48;
                       REP #$20                             ;80DACF|C220    |      ;
                       SEP #$10                             ;80DAD1|E210    |      ;
                       LDA.W #$EDEC                         ;80DAD3|A9ECED  |      ;
                       STA.B $72                            ;80DAD6|8572    |000072;
                       SEP #$20                             ;80DAD8|E220    |      ;
                       LDA.B #$80                           ;80DADA|A980    |      ;
                       STA.B $74                            ;80DADC|8574    |000074;
                       SEP #$20                             ;80DADE|E220    |      ;
                       LDA.B #$0D                           ;80DAE0|A90D    |      ;
                       LDX.B #$05                           ;80DAE2|A205    |      ;
                       LDY.B #$04                           ;80DAE4|A004    |      ;
                       JSL.L CODE_808E48                    ;80DAE6|22488E80|808E48;
                       REP #$20                             ;80DAEA|C220    |      ;
                       SEP #$10                             ;80DAEC|E210    |      ;
                       LDA.W #$EDFA                         ;80DAEE|A9FAED  |      ;
                       STA.B $72                            ;80DAF1|8572    |000072;
                       SEP #$20                             ;80DAF3|E220    |      ;
                       LDA.B #$80                           ;80DAF5|A980    |      ;
                       STA.B $74                            ;80DAF7|8574    |000074;
                       SEP #$20                             ;80DAF9|E220    |      ;
                       ...
                       db $93,$E1,$80,$4C,$00,$08,$52,$00   ;80E19B|        |      ;
                       db $08,$FE,$FF,$9E,$E1,$80,$BF,$02   ;80E1A3|        |      ;
                       db $08,$7F,$01,$08,$FE,$FF,$A9,$E1   ;80E1AB|        |      ;
                       db $80,$9F,$00,$08,$5F,$03,$08,$FE   ;80E1B3|        |      ;
                       db $FF,$B4,$E1,$80,$9F,$02,$08,$9F   ;80E1BB|        |      ;
                       db $03,$08,$FE,$FF,$BF,$E1,$80,$8D   ;80E1C3|        |      ;
                       db $21,$08,$10,$2E,$08,$10,$2E,$08   ;80E1CB|        |      ;
                       db $10,$2E,$08,$FE,$FF,$CA,$E1,$80   ;80E1D3|        |      ;
                       db $9C,$5F,$08,$7B,$5F,$08,$F9,$4A   ;80E1DB|        |      ;
                       db $08,$7B,$5F,$08,$FE,$FF,$DB,$E1   ;80E1E3|        |      ;
                       db $80,$F9,$4A,$08,$F9,$4A,$08,$1F   ;80E1EB|        |      ;
                       db $26,$08,$F9,$4A,$08,$FE,$FF,$EC   ;80E1F3|        |      ;
                       db $E1,$80,$1F,$26,$08,$1F,$26,$08   ;80E1FB|        |      ;
                       db $3E,$05,$08,$1F,$26,$08,$FE,$FF   ;80E203|        |      ;
                       db $FD,$E1,$80,$3E,$05,$08,$1F,$26   ;80E20B|        |      ;
                       db $08,$F9,$4A,$08,$1F,$26,$08,$FE   ;80E213|        |      ;
                       db $FF,$0E,$E2,$80,$1F,$26,$08,$F9   ;80E21B|        |      ;
                       db $4A,$08,$F9,$4A,$08,$F9,$4A,$08   ;80E223|        |      ;
                       db $FE,$FF,$1F,$E2,$80,$BF,$03,$08   ;80E22B|        |      ;
                       db $1F,$26,$08,$BF,$03,$08,$1F,$26   ;80E233|        |      ;
                       db $08,$FE,$FF,$30,$E2,$80,$BF,$03   ;80E23B|        |      ;
                       db $08,$1F,$26,$08,$3E,$05,$08,$1F   ;80E243|        |      ;
                       db $26,$08,$FE,$FF,$41,$E2,$80,$3F   ;80E24B|        |      ;
                       db $12,$08,$BF,$06,$08,$FE,$FF,$52   ;80E253|        |      ;
                       db $E2,$80,$48,$00,$08,$4D,$00,$08   ;80E25B|        |      ;
                       db $FE,$FF,$5D,$E2,$80,$1F,$02,$08   ;80E263|        |      ;
                       db $3A,$01,$08,$FE,$FF,$68,$E2,$80   ;80E26B|        |      ;
                       db $FA,$00,$08,$3F,$03,$08,$FE,$FF   ;80E273|        |      ;
                       db $73,$E2,$80,$48,$00,$08,$4F,$00   ;80E27B|        |      ;
                       db $08,$FE,$FF,$7E,$E2,$80,$9A,$1E   ;80E283|        |      ;
                       db $08,$1F,$1F,$08,$FE,$FF,$89,$E2   ;80E28B|        |      ;
                       db $80,$1F,$02,$08,$37,$00,$08,$FE   ;80E293|        |      ;
                       db $FF,$94,$E2,$80,$19,$00,$08,$25   ;80E29B|        |      ;
                       db $00,$08,$FE,$FF,$9F,$E2,$80,$7F   ;80E2A3|        |      ;
                       db $2E,$08,$3F,$23,$08,$FE,$FF,$AA   ;80E2AB|        |      ;
                       db $E2,$80,$88,$00,$08,$8C,$00,$08   ;80E2B3|        |      ;
                       db $FE,$FF,$B5,$E2,$80,$9D,$00,$08   ;80E2BB|        |      ;
                       db $9F,$02,$08,$FE,$FF,$C0,$E2,$80   ;80E2C3|        |      ;
                       db $1F,$02,$08,$1F,$01,$08,$FE,$FF   ;80E2CB|        |      ;
                       db $CB,$E2,$80,$90,$00,$08,$9C,$00   ;80E2D3|        |      ;
                       db $08,$FE,$FF,$D6,$E2,$80,$DE,$01   ;80E2DB|        |      ;
                       db $08,$BF,$02,$08,$FE,$FF,$E1,$E2   ;80E2E3|        |      ;
                       db $80,$4F,$00,$08,$D0,$00,$08,$FE   ;80E2EB|        |      ;
                       db $FF,$EC,$E2,$80,$0F,$5E,$10,$54   ;80E2F3|        |      ;
                       db $4A,$10,$17,$7F,$10,$FE,$FF,$F7   ;80E2FB|        |      ;
                       db $E2,$80,$54,$4A,$10,$17,$7F,$10   ;80E303|        |      ;
                       db $0F,$5E,$10,$FE,$FF,$05,$E3,$80   ;80E30B|        |      ;
                       db $17,$7F,$10,$0F,$5E,$10,$54,$4A   ;80E313|        |      ;
                       db $10,$FE,$FF,$13,$E3,$80,$13,$42   ;80E31B|        |      ;
                       db $10,$57,$42,$10,$FC,$56,$10,$FE   ;80E323|        |      ;
                       db $FF,$21,$E3,$80,$57,$42,$10,$FC   ;80E32B|        |      ;
                       db $56,$10,$13,$42,$10,$FE,$FF,$2F   ;80E333|        |      ;
                       db $E3,$80,$FC,$56,$10,$13,$42,$10   ;80E33B|        |      ;
                       db $57,$42,$10,$FE,$FF,$3D,$E3,$80   ;80E343|        |      ;
                       db $4A,$3D,$10,$4A,$3D,$10,$8C,$45   ;80E34B|        |      ;
                       db $10,$FE,$FF,$4B,$E3,$80,$4A,$3D   ;80E353|        |      ;
                       db $10,$8C,$45,$10,$4A,$3D,$10,$FE   ;80E35B|        |      ;
                       db $FF,$59,$E3,$80,$8C,$45,$10,$4A   ;80E363|        |      ;
                       db $3D,$10,$4A,$3D,$10,$FE,$FF,$67   ;80E36B|        |      ;
                       db $E3,$80,$29,$31,$10,$08,$29,$10   ;80E373|        |      ;
                       db $6B,$31,$10,$FE,$FF,$75,$E3,$80   ;80E37B|        |      ;
                       db $08,$29,$10,$6B,$31,$10,$29,$31   ;80E383|        |      ;
                       db $10,$FE,$FF,$83,$E3,$80,$6B,$31   ;80E38B|        |      ;
                       db $10,$29,$31,$10,$08,$29,$10,$FE   ;80E393|        |      ;
                       db $FF,$91,$E3,$80,$50,$62,$10,$71   ;80E39B|        |      ;
                       db $72,$10,$79,$7F,$10,$FE,$FF,$9F   ;80E3A3|        |      ;
                       db $E3,$80,$71,$72,$10,$79,$7F,$10   ;80E3AB|        |      ;
                       db $50,$62,$10,$FE,$FF,$AD,$E3,$80   ;80E3B3|        |      ;
                       db $79,$7F,$10,$50,$62,$10,$71,$72   ;80E3BB|        |      ;
                       db $10,$FE,$FF,$BB,$E3,$80,$78,$5E   ;80E3C3|        |      ;
                       db $10,$54,$56,$10,$19,$7F,$10,$FE   ;80E3CB|        |      ;
                       db $FF,$C9,$E3,$80,$54,$56,$10,$19   ;80E3D3|        |      ;
                       db $7F,$10,$78,$5E,$10,$FE,$FF,$D7   ;80E3DB|        |      ;
                       db $E3,$80,$19,$7F,$10,$78,$5E,$10   ;80E3E3|        |      ;
                       db $54,$56,$10,$FE,$FF,$E5,$E3,$80   ;80E3EB|        |      ;
                       db $4A,$3D,$10,$4A,$3D,$10,$8C,$45   ;80E3F3|        |      ;
                       db $10,$FE,$FF,$F3,$E3,$80,$4A,$3D   ;80E3FB|        |      ;
                       db $10,$8C,$45,$10,$4A,$3D,$10,$FE   ;80E403|        |      ;
                       db $FF,$01,$E4,$80,$8C,$45,$10,$4A   ;80E40B|        |      ;
                       db $3D,$10,$4A,$3D,$10,$FE,$FF,$0F   ;80E413|        |      ;
                       db $E4,$80,$E7,$30,$10,$E7,$30,$10   ;80E41B|        |      ;
                       db $29,$35,$10,$FE,$FF,$1D,$E4,$80   ;80E423|        |      ;
                       db $E7,$30,$10,$29,$35,$10,$E7,$30   ;80E42B|        |      ;
                       db $10,$FE,$FF,$2B,$E4,$80,$29,$35   ;80E433|        |      ;
                       db $10,$E7,$30,$10,$E7,$30,$10,$FE   ;80E43B|        |      ;
                       db $FF,$39,$E4,$80,$91,$4A,$10,$CE   ;80E443|        |      ;
                       db $62,$10,$74,$63,$10,$FE,$FF,$47   ;80E44B|        |      ;
                       db $E4,$80,$CE,$62,$10,$74,$63,$10   ;80E453|        |      ;
                       db $91,$4A,$10,$FE,$FF,$55,$E4,$80   ;80E45B|        |      ;
                       db $74,$63,$10,$91,$4A,$10,$CE,$62   ;80E463|        |      ;
                       db $10,$FE,$FF,$63,$E4,$80,$94,$36   ;80E46B|        |      ;
                       db $10,$54,$32,$10,$FC,$3A,$10,$FE   ;80E473|        |      ;
                       db $FF,$71,$E4,$80,$54,$32,$10,$FC   ;80E47B|        |      ;
                       db $3A,$10,$94,$36,$10,$FE,$FF,$7F   ;80E483|        |      ;
                       db $E4,$80,$EC,$3A,$10,$94,$36,$10   ;80E48B|        |      ;
                       db $54,$32,$10,$FE,$FF,$8D,$E4,$80   ;80E493|        |      ;
                       db $CB,$2D,$10,$CB,$2D,$10,$0E,$36   ;80E49B|        |      ;
                       db $10,$FE,$FF,$9B,$E4,$80,$CB,$2D   ;80E4A3|        |      ;
                       db $10,$0E,$36,$10,$CB,$2D,$10,$FE   ;80E4AB|        |      ;
                       db $FF,$A9,$E4,$80,$0E,$36,$10,$CB   ;80E4B3|        |      ;
                       db $2D,$10,$CB,$2D,$10,$FE,$FF,$B7   ;80E4BB|        |      ;
                       db $E4,$80,$E7,$30,$10,$27,$31,$10   ;80E4C3|        |      ;
                       db $6A,$35,$10,$FE,$FF,$C5,$E4,$80   ;80E4CB|        |      ;
                       db $27,$31,$10,$6A,$35,$10,$E7,$30   ;80E4D3|        |      ;
                       db $10,$FE,$FF,$D3,$E4,$80,$6A,$35   ;80E4DB|        |      ;
                       db $10,$E7,$30,$10,$27,$31,$10,$FE   ;80E4E3|        |      ;
                       db $FF,$E1,$E4,$80,$62,$21,$0A,$90   ;80E4EB|        |      ;
                       db $21,$0A,$D2,$25,$10,$90,$21,$0A   ;80E4F3|        |      ;
                       db $FE,$FF,$EF,$E4,$80,$58,$0E,$0A   ;80E4FB|        |      ;
                       db $9A,$12,$0A,$DC,$16,$10,$9A,$12   ;80E503|        |      ;
                       db $0A,$FE,$FF,$00,$E5,$80,$7D,$37   ;80E50B|        |      ;
                       db $0A,$9F,$47,$0A,$DF,$53,$10,$9F   ;80E513|        |      ;
                       db $47,$0A,$FE,$FF,$11,$E5,$80,$2C   ;80E51B|        |      ;
                       db $09,$0A,$6F,$11,$0A,$B1,$11,$10   ;80E523|        |      ;
                       db $6F,$11,$0A,$FE,$FF,$22,$E5,$80   ;80E52B|        |      ;
                       db $8E,$0D,$0A,$B1,$0D,$0A,$B4,$0D   ;80E533|        |      ;
                       db $10,$B1,$0D,$0A,$FE,$FF,$33,$E5   ;80E53B|        |      ;
                       db $80,$D7,$36,$0A,$19,$37,$0A,$7F   ;80E543|        |      ;
                       db $37,$10,$19,$37,$0A,$FE,$FF,$44   ;80E54B|        |      ;
                       db $E5,$80,$DE,$27,$0A,$FF,$3F,$0A   ;80E553|        |      ;
                       db $FF,$53,$10,$FF,$3F,$0A,$FE,$FF   ;80E55B|        |      ;
                       db $55,$E5,$80,$6E,$19,$0A,$70,$19   ;80E563|        |      ;
                       db $0A,$92,$19,$10,$70,$19,$0A,$FE   ;80E56B|        |      ;
                       db $FF,$66,$E5,$80,$0A,$15,$0A,$4F   ;80E573|        |      ;
                       db $1D,$0A,$90,$1D,$10,$4F,$1D,$0A   ;80E57B|        |      ;
                       db $FE,$FF,$77,$E5,$80,$18,$0A,$0A   ;80E583|        |      ;
                       db $1C,$0A,$0A,$9F,$0A,$10,$1C,$0A   ;80E58B|        |      ;
                       db $0A,$FE,$FF,$88,$E5,$80,$7C,$2F   ;80E593|        |      ;
                       db $0A,$BE,$2F,$0A,$DF,$4B,$10,$BE   ;80E59B|        |      ;
                       db $2F,$0A,$FE,$FF,$99,$E5,$80,$0C   ;80E5A3|        |      ;
                       db $09,$0A,$6E,$11,$0A,$90,$11,$10   ;80E5AB|        |      ;
                       db $6E,$11,$0A,$FE,$FF,$AA,$E5,$80   ;80E5B3|        |      ;
                       db $E8,$1C,$0A,$0A,$21,$0A,$6F,$21   ;80E5BB|        |      ;
                       db $10,$0A,$21,$0A,$FE,$FF,$BB,$E5   ;80E5C3|        |      ;
                       db $80,$F3,$29,$0A,$19,$2A,$0A,$7B   ;80E5CB|        |      ;
                       db $32,$10,$19,$2A,$0A,$FE,$FF,$CC   ;80E5D3|        |      ;
                       db $E5,$80,$B8,$3E,$0A,$3D,$3F,$0A   ;80E5DB|        |      ;
                       db $7F,$43,$10,$3D,$3F,$0A,$FE,$FF   ;80E5E3|        |      ;
                       db $DD,$E5,$80,$6C,$1D,$0A,$8E,$21   ;80E5EB|        |      ;
                       db $0A,$AF,$25,$10,$8E,$21,$0A,$FE   ;80E5F3|        |      ;
                       db $FF,$EE,$E5,$80,$3B,$7F,$10,$B5   ;80E5FB|        |      ;
                       db $6E,$10,$2E,$5E,$0F,$F0,$51,$10   ;80E603|        |      ;
                       db $33,$52,$0C,$B7,$6E,$10,$FE,$FF   ;80E60B|        |      ;
                       db $FF,$E5,$80,$B7,$6E,$10,$2E,$5E   ;80E613|        |      ;
                       db $10,$F0,$51,$0F,$39,$7F,$10,$F0   ;80E61B|        |      ;
                       db $51,$0C,$33,$52,$10,$FE,$FF,$16   ;80E623|        |      ;
                       db $E6,$80,$2E,$5E,$10,$F0,$51,$10   ;80E62B|        |      ;
                       db $3B,$7F,$0F,$B7,$6E,$10,$39,$7F   ;80E633|        |      ;
                       db $0C,$D1,$4D,$10,$FE,$FF,$2D,$E6   ;80E63B|        |      ;
                       db $80,$F0,$51,$10,$39,$7F,$10,$B7   ;80E643|        |      ;
                       db $6E,$0F,$2E,$5E,$10,$B7,$6E,$0C   ;80E64B|        |      ;
                       db $39,$7F,$10,$FE,$FF,$44,$E6,$80   ;80E653|        |      ;
                       db $F0,$41,$10,$F1,$3D,$10,$11,$42   ;80E65B|        |      ;
                       db $0F,$F1,$41,$10,$11,$42,$0C,$F1   ;80E663|        |      ;
                       db $3D,$10,$FE,$FF,$5B,$E6,$80,$7B   ;80E66B|        |      ;
                       db $53,$10,$BB,$42,$10,$34,$32,$0F   ;80E673|        |      ;
                       db $33,$32,$10,$34,$32,$0C,$BB,$42   ;80E67B|        |      ;
                       db $10,$FE,$FF,$72,$E6,$80,$B8,$42   ;80E683|        |      ;
                       db $10,$34,$32,$10,$33,$32,$0F,$DB   ;80E68B|        |      ;
                       db $42,$10,$33,$32,$0C,$34,$32,$10   ;80E693|        |      ;
                       db $FE,$FF,$89,$E6,$80,$34,$32,$10   ;80E69B|        |      ;
                       db $33,$32,$10,$DB,$42,$0F,$B8,$32   ;80E6A3|        |      ;
                       db $10,$DB,$42,$0C,$33,$32,$10,$FE   ;80E6AB|        |      ;
                       db $FF,$A0,$E6,$80,$33,$32,$10,$DB   ;80E6B3|        |      ;
                       db $42,$10,$B8,$32,$0F,$34,$32,$10   ;80E6BB|        |      ;
                       db $B8,$32,$0C,$DB,$42,$10,$FE,$FF   ;80E6C3|        |      ;
                       db $B7,$E6,$80,$B1,$21,$10,$D1,$25   ;80E6CB|        |      ;
                       db $10,$D1,$29,$0F,$34,$32,$10,$D1   ;80E6D3|        |      ;
                       db $29,$0C,$D1,$25,$10,$FE,$FF,$CE   ;80E6DB|        |      ;
                       db $E6,$80,$13,$32,$10,$8C,$1D,$10   ;80E6E3|        |      ;
                       db $CF,$29,$0F,$11,$2E,$10,$CF,$29   ;80E6EB|        |      ;
                       db $0C,$8C,$1D,$10,$FE,$FF,$E5,$E6   ;80E6F3|        |      ;
                       db $80,$F1,$2D,$10,$33,$32,$10,$8C   ;80E6FB|        |      ;
                       db $1D,$0F,$CF,$29,$10,$8C,$1D,$0C   ;80E703|        |      ;
                       db $33,$32,$10,$FE,$FF,$FC,$E6,$80   ;80E70B|        |      ;
                       db $AF,$21,$10,$11,$2E,$10,$33,$32   ;80E713|        |      ;
                       db $0F,$8C,$1D,$10,$33,$32,$0C,$11   ;80E71B|        |      ;
                       db $2E,$10,$FE,$FF,$13,$E7,$80,$6C   ;80E723|        |      ;
                       db $1D,$10,$CF,$29,$10,$11,$2E,$0F   ;80E72B|        |      ;
                       db $33,$32,$10,$11,$2E,$0C,$CF,$29   ;80E733|        |      ;
                       db $10,$FE,$FF,$2A,$E7,$80,$4C,$1D   ;80E73B|        |      ;
                       db $10,$4C,$1D,$10,$4C,$21,$0F,$4C   ;80E743|        |      ;
                       db $21,$10,$4C,$21,$0C,$4C,$1D,$10   ;80E74B|        |      ;
                       db $FE,$FF,$41,$E7,$80,$8B,$21,$10   ;80E753|        |      ;
                       db $2A,$19,$10,$4B,$1D,$0F,$4B,$1D   ;80E75B|        |      ;
                       db $10,$4B,$1D,$0C,$2A,$19,$10,$FE   ;80E763|        |      ;
                       db $FF,$58,$E7,$80,$4B,$1D,$10,$6B   ;80E76B|        |      ;
                       db $21,$10,$2A,$19,$0F,$4B,$1D,$10   ;80E773|        |      ;
                       db $2A,$19,$0C,$6B,$21,$10,$FE,$FF   ;80E77B|        |      ;
                       db $6F,$E7,$80,$2A,$1D,$10,$48,$1D   ;80E783|        |      ;
                       db $10,$4B,$21,$0F,$2A,$19,$10,$4B   ;80E78B|        |      ;
                       db $21,$0C,$48,$1D,$10,$FE,$FF,$86   ;80E793|        |      ;
                       db $E7,$80,$28,$19,$10,$4B,$1D,$10   ;80E79B|        |      ;
                       db $4B,$1D,$0F,$6B,$1D,$10,$4B,$1D   ;80E7A3|        |      ;
                       db $0C,$4B,$1D,$10,$FE,$FF,$9D,$E7   ;80E7AB|        |      ;
                       db $80,$52,$7F,$10,$66,$5D,$10,$86   ;80E7B3|        |      ;
                       db $7D,$0F,$4B,$7E,$10,$86,$7D,$0C   ;80E7BB|        |      ;
                       db $66,$5D,$10,$FE,$FF,$B4,$E7,$80   ;80E7C3|        |      ;
                       db $4B,$7E,$10,$32,$4F,$10,$66,$5D   ;80E7CB|        |      ;
                       db $0F,$86,$7D,$10,$66,$5D,$0C,$32   ;80E7D3|        |      ;
                       db $7F,$10,$FE,$FF,$CB,$E7,$80,$86   ;80E7DB|        |      ;
                       db $7D,$10,$4B,$7E,$10,$32,$7F,$0F   ;80E7E3|        |      ;
                       db $66,$5D,$10,$32,$7F,$0C,$4B,$7E   ;80E7EB|        |      ;
                       db $10,$FE,$FF,$E2,$E7,$80,$66,$5D   ;80E7F3|        |      ;
                       db $10,$86,$7D,$10,$4B,$7E,$0F,$32   ;80E7FB|        |      ;
                       db $7F,$10,$4B,$7E,$0C,$86,$7D,$10   ;80E803|        |      ;
                       db $FE,$FF,$F9,$E7,$80,$66,$5D,$10   ;80E80B|        |      ;
                       db $86,$61,$10,$86,$65,$0F,$A6,$69   ;80E813|        |      ;
                       db $10,$86,$65,$0C,$86,$61,$10,$FE   ;80E81B|        |      ;
                       db $FF,$10,$E8,$80,$9E,$3F,$10,$9E   ;80E823|        |      ;
                       db $16,$10,$18,$12,$0F,$74,$11,$10   ;80E82B|        |      ;
                       db $18,$12,$0C,$9E,$16,$10,$FE,$FF   ;80E833|        |      ;
                       db $27,$E8,$80,$9E,$16,$10,$18,$12   ;80E83B|        |      ;
                       db $10,$74,$11,$0F,$FA,$2A,$10,$74   ;80E843|        |      ;
                       db $11,$0C,$18,$12,$10,$FE,$FF,$3E   ;80E84B|        |      ;
                       db $E8,$80,$18,$12,$10,$74,$11,$10   ;80E853|        |      ;
                       db $9E,$3F,$0F,$9E,$16,$10,$9E,$3F   ;80E85B|        |      ;
                       db $0C,$74,$11,$10,$FE,$FF,$55,$E8   ;80E863|        |      ;
                       db $80,$74,$11,$10,$7B,$26,$10,$9E   ;80E86B|        |      ;
                       db $16,$0F,$18,$12,$10,$9E,$16,$0C   ;80E873|        |      ;
                       db $7B,$26,$10,$FE,$FF,$6C,$E8,$80   ;80E87B|        |      ;
                       db $B1,$1D,$10,$B2,$1D,$10,$B3,$1D   ;80E883|        |      ;
                       db $0F,$B3,$1D,$10,$B3,$1D,$0C,$B2   ;80E88B|        |      ;
                       db $1D,$10,$FE,$FF,$83,$E8,$80,$B3   ;80E893|        |      ;
                       db $0D,$10,$B3,$09,$10,$91,$09,$0F   ;80E89B|        |      ;
                       db $72,$01,$10,$91,$09,$0C,$B3,$09   ;80E8A3|        |      ;
                       db $10,$FE,$FF,$9A,$E8,$80,$B3,$09   ;80E8AB|        |      ;
                       db $10,$91,$09,$10,$72,$01,$0F,$B3   ;80E8B3|        |      ;
                       db $0D,$10,$72,$01,$0C,$91,$09,$10   ;80E8BB|        |      ;
                       db $FE,$FF,$B1,$E8,$80,$91,$09,$10   ;80E8C3|        |      ;
                       db $72,$01,$10,$B3,$0D,$0F,$B3,$09   ;80E8CB|        |      ;
                       db $10,$B3,$0D,$0C,$72,$01,$10,$FE   ;80E8D3|        |      ;
                       db $FF,$C8,$E8,$80,$72,$01,$10,$B3   ;80E8DB|        |      ;
                       db $0D,$10,$B3,$09,$0F,$91,$09,$10   ;80E8E3|        |      ;
                       db $B3,$09,$0C,$B3,$0D,$10,$FE,$FF   ;80E8EB|        |      ;
                       db $DF,$E8,$80,$4E,$19,$10,$0C,$11   ;80E8F3|        |      ;
                       db $10,$0B,$11,$0F,$0B,$11,$10,$0B   ;80E8FB|        |      ;
                       db $11,$0C,$0C,$11,$10,$FE,$FF,$F6   ;80E903|        |      ;
                       db $E8,$80,$0C,$11,$10,$0B,$11,$10   ;80E90B|        |      ;
                       db $0B,$11,$0F,$4E,$19,$10,$0B,$11   ;80E913|        |      ;
                       db $0C,$0B,$11,$10,$FE,$FF,$0D,$E9   ;80E91B|        |      ;
                       db $80,$0B,$11,$10,$0B,$11,$10,$4E   ;80E923|        |      ;
                       db $19,$0F,$0C,$11,$10,$4E,$19,$0C   ;80E92B|        |      ;
                       db $0B,$11,$10,$FE,$FF,$24,$E9,$80   ;80E933|        |      ;
                       db $0B,$11,$10,$4E,$19,$10,$0C,$11   ;80E93B|        |      ;
                       db $0F,$0B,$11,$10,$0C,$11,$0C,$4E   ;80E943|        |      ;
                       db $19,$10,$FE,$FF,$3B,$E9,$80,$AC   ;80E94B|        |      ;
                       db $21,$10,$8B,$1D,$10,$2B,$0D,$0F   ;80E953|        |      ;
                       db $2B,$0D,$10,$2B,$0D,$0C,$8B,$1D   ;80E95B|        |      ;
                       db $10,$FE,$FF,$52,$E9,$80,$2B,$0D   ;80E963|        |      ;
                       db $10,$2B,$0D,$10,$8B,$1D,$0F,$AC   ;80E96B|        |      ;
                       db $21,$10,$8B,$1D,$0C,$2B,$0D,$10   ;80E973|        |      ;
                       db $FE,$FF,$69,$E9,$80,$FE,$32,$10   ;80E97B|        |      ;
                       db $EE,$21,$10,$D1,$29,$0F,$14,$22   ;80E983|        |      ;
                       db $10,$D1,$29,$0C,$EE,$21,$10,$FE   ;80E98B|        |      ;
                       db $FF,$80,$E9,$80,$F5,$29,$10,$76   ;80E993|        |      ;
                       db $2E,$10,$EE,$21,$0F,$D1,$29,$10   ;80E99B|        |      ;
                       db $EE,$21,$0C,$76,$2E,$10,$FE,$FF   ;80E9A3|        |      ;
                       db $97,$E9,$80,$F4,$15,$10,$14,$32   ;80E9AB|        |      ;
                       db $10,$33,$2E,$0F,$EE,$21,$10,$33   ;80E9B3|        |      ;
                       db $2E,$0C,$14,$32,$10,$FE,$FF,$AE   ;80E9BB|        |      ;
                       db $E9,$80,$D3,$1D,$10,$D1,$29,$10   ;80E9C3|        |      ;
                       db $34,$2E,$0F,$D1,$1D,$10,$34,$2E   ;80E9CB|        |      ;
                       db $0C,$D1,$29,$10,$FE,$FF,$C5,$E9   ;80E9D3|        |      ;
                       db $80,$EF,$25,$10,$CE,$25,$10,$AE   ;80E9DB|        |      ;
                       db $25,$0F,$AD,$25,$10,$AE,$25,$0C   ;80E9E3|        |      ;
                       db $CE,$25,$10,$FE,$FF,$DC,$E9,$80   ;80E9EB|        |      ;
                       db $4E,$21,$10,$4F,$1D,$10,$B4,$1D   ;80E9F3|        |      ;
                       db $0F,$B4,$1D,$10,$B4,$1D,$0C,$4F   ;80E9FB|        |      ;
                       db $1D,$10,$FE,$FF,$F3,$E9,$80,$B4   ;80EA03|        |      ;
                       db $1D,$10,$72,$1D,$10,$72,$1D,$0F   ;80EA0B|        |      ;
                       db $4F,$1D,$10,$72,$1D,$0C,$72,$1D   ;80EA13|        |      ;
                       db $10,$FE,$FF,$0A,$EA,$80,$7F,$37   ;80EA1B|        |      ;
                       db $10,$B0,$21,$10,$1C,$16,$0F,$59   ;80EA23|        |      ;
                       db $1A,$10,$1C,$16,$0C,$B0,$21,$10   ;80EA2B|        |      ;
                       db $FE,$FF,$21,$EA,$80,$59,$1A,$10   ;80EA33|        |      ;
                       db $9B,$1A,$10,$B0,$21,$0F,$1C,$16   ;80EA3B|        |      ;
                       db $10,$B0,$21,$0C,$9B,$1A,$10,$FE   ;80EA43|        |      ;
                       db $FF,$38,$EA,$80,$1C,$16,$10,$59   ;80EA4B|        |      ;
                       db $1A,$10,$1F,$1B,$0F,$B0,$21,$10   ;80EA53|        |      ;
                       db $1F,$1B,$0C,$59,$1A,$10,$FE,$FF   ;80EA5B|        |      ;
                       db $4F,$EA,$80,$94,$09,$10,$1C,$16   ;80EA63|        |      ;
                       db $10,$59,$1A,$0F,$9B,$1A,$10,$59   ;80EA6B|        |      ;
                       db $1A,$0C,$1C,$16,$10,$FE,$FF,$66   ;80EA73|        |      ;
                       db $EA,$80,$90,$21,$10,$B0,$21,$10   ;80EA7B|        |      ;
                       db $91,$21,$0F,$B1,$21,$10,$91,$21   ;80EA83|        |      ;
                       db $0C,$B0,$21,$10,$FE,$FF,$7D,$EA   ;80EA8B|        |      ;
                       db $80,$4C,$1D,$10,$8E,$21,$10,$B0   ;80EA93|        |      ;
                       db $21,$0F,$B2,$21,$10,$B0,$21,$0C   ;80EA9B|        |      ;
                       db $8E,$21,$10,$FE,$FF,$94,$EA,$80   ;80EAA3|        |      ;
                       db $B2,$21,$10,$4C,$1D,$10,$8E,$21   ;80EAAB|        |      ;
                       db $0F,$B0,$21,$10,$8E,$21,$0C,$4C   ;80EAB3|        |      ;
                       db $1D,$10,$FE,$FF,$AB,$EA,$80,$B0   ;80EABB|        |      ;
                       db $21,$10,$B2,$21,$10,$4C,$1D,$0F   ;80EAC3|        |      ;
                       db $8E,$21,$10,$4C,$1D,$0C,$B2,$21   ;80EACB|        |      ;
                       db $10,$FE,$FF,$C2,$EA,$80,$8E,$21   ;80EAD3|        |      ;
                       db $10,$B0,$21,$10,$B2,$21,$0F,$4C   ;80EADB|        |      ;
                       db $1D,$10,$B2,$21,$0C,$B0,$21,$10   ;80EAE3|        |      ;
                       db $FE,$FF,$D9,$EA,$80,$6C,$1D,$10   ;80EAEB|        |      ;
                       db $09,$15,$10,$2C,$1D,$0F,$4C,$1D   ;80EAF3|        |      ;
                       db $10,$2C,$1D,$0C,$09,$15,$10,$FE   ;80EAFB|        |      ;
                       db $FF,$F0,$EA,$80,$4C,$1D,$10,$6C   ;80EB03|        |      ;
                       db $1D,$10,$09,$15,$0F,$2C,$1D,$10   ;80EB0B|        |      ;
                       db $09,$15,$0C,$6C,$1D,$10,$FE,$FF   ;80EB13|        |      ;
                       db $07,$EB,$80,$2C,$1D,$10,$4C,$1D   ;80EB1B|        |      ;
                       db $10,$6C,$1D,$0F,$09,$15,$10,$6C   ;80EB23|        |      ;
                       db $1D,$0C,$4C,$1D,$10,$FE,$FF,$1E   ;80EB2B|        |      ;
                       db $EB,$80,$09,$15,$10,$2C,$1D,$10   ;80EB33|        |      ;
                       db $4C,$1D,$0F,$6C,$1D,$10,$4C,$1D   ;80EB3B|        |      ;
                       db $0C,$2C,$1D,$10,$FE,$FF,$35,$EB   ;80EB43|        |      ;
                       db $80,$DB,$77,$10,$98,$73,$10,$98   ;80EB4B|        |      ;
                       db $73,$10,$98,$73,$10,$FE,$FF,$4C   ;80EB53|        |      ;
                       db $EB,$80,$98,$73,$10,$98,$73,$10   ;80EB5B|        |      ;
                       db $DB,$77,$10,$98,$73,$10,$FE,$FF   ;80EB63|        |      ;
                       db $5D,$EB,$80,$7D,$5F,$10,$3B,$4B   ;80EB6B|        |      ;
                       db $10,$3B,$4B,$10,$3B,$4B,$10,$FE   ;80EB73|        |      ;
                       db $FF,$6E,$EB,$80,$3B,$4B,$10,$3B   ;80EB7B|        |      ;
                       db $4B,$10,$7D,$5F,$10,$3B,$4B,$10   ;80EB83|        |      ;
                       db $FE,$FF,$7F,$EB,$80,$95,$32,$10   ;80EB8B|        |      ;
                       db $52,$2E,$10,$52,$2E,$10,$52,$2E   ;80EB93|        |      ;
                       db $10,$FE,$FF,$90,$EB,$80,$52,$2E   ;80EB9B|        |      ;
                       db $10,$52,$2E,$10,$95,$32,$10,$52   ;80EBA3|        |      ;
                       db $2E,$10,$FE,$FF,$A1,$EB,$80,$4A   ;80EBAB|        |      ;
                       db $31,$10,$29,$2D,$10,$29,$2D,$10   ;80EBB3|        |      ;
                       db $29,$2D,$10,$FE,$FF,$B2,$EB,$80   ;80EBBB|        |      ;
                       db $29,$2D,$10,$29,$2D,$10,$4A,$31   ;80EBC3|        |      ;
                       db $10,$29,$2D,$10,$FE,$FF,$C3,$EB   ;80EBCB|        |      ;
                       db $80,$99,$77,$10,$34,$63,$10,$34   ;80EBD3|        |      ;
                       db $63,$10,$34,$63,$10,$FE,$FF,$D4   ;80EBDB|        |      ;
                       db $EB,$80,$34,$63,$10,$34,$63,$10   ;80EBE3|        |      ;
                       db $DB,$77,$10,$34,$63,$10,$FE,$FF   ;80EBEB|        |      ;
                       db $E5,$EB,$80,$7E,$67,$10,$1C,$47   ;80EBF3|        |      ;
                       db $10,$1C,$47,$10,$1C,$47,$10,$FE   ;80EBFB|        |      ;
                       db $FF,$F6,$EB,$80,$1C,$47,$10,$1C   ;80EC03|        |      ;
                       db $47,$10,$7E,$67,$10,$1C,$47,$10   ;80EC0B|        |      ;
                       db $FE,$FF,$07,$EC,$80,$94,$56,$10   ;80EC13|        |      ;
                       db $31,$4E,$10,$31,$4E,$10,$31,$4E   ;80EC1B|        |      ;
                       db $10,$FE,$FF,$18,$EC,$80,$31,$4E   ;80EC23|        |      ;
                       db $10,$31,$4E,$10,$94,$56,$10,$31   ;80EC2B|        |      ;
                       db $4E,$10,$FE,$FF,$29,$EC,$80,$8C   ;80EC33|        |      ;
                       db $49,$10,$4A,$41,$10,$4A,$41,$10   ;80EC3B|        |      ;
                       db $4A,$41,$10,$FE,$FF,$3A,$EC,$80   ;80EC43|        |      ;
                       db $4A,$41,$10,$4A,$41,$10,$8C,$49   ;80EC4B|        |      ;
                       db $10,$4A,$41,$10,$FE,$FF,$4B,$EC   ;80EC53|        |      ;
                       db $80,$76,$73,$10,$34,$63,$10,$34   ;80EC5B|        |      ;
                       db $63,$10,$34,$63,$10,$FE,$FF,$5C   ;80EC63|        |      ;
                       db $EC,$80,$34,$63,$10,$34,$63,$10   ;80EC6B|        |      ;
                       db $76,$73,$10,$34,$63,$10,$FE,$FF   ;80EC73|        |      ;
                       db $6D,$EC,$80,$7F,$53,$10,$FB,$42   ;80EC7B|        |      ;
                       db $10,$FB,$42,$10,$FB,$42,$10,$FE   ;80EC83|        |      ;
                       db $FF,$7E,$EC,$80,$FB,$42,$10,$FB   ;80EC8B|        |      ;
                       db $42,$10,$7F,$53,$10,$FB,$42,$10   ;80EC93|        |      ;
                       db $FE,$FF,$8F,$EC,$80,$71,$46,$10   ;80EC9B|        |      ;
                       db $31,$3E,$10,$31,$3E,$10,$31,$3E   ;80ECA3|        |      ;
                       db $10,$FE,$FF,$A0,$EC,$80,$31,$3E   ;80ECAB|        |      ;
                       db $10,$31,$3E,$10,$71,$46,$10,$31   ;80ECB3|        |      ;
                       db $3E,$10,$FE,$FF,$B1,$EC,$80,$6A   ;80ECBB|        |      ;
                       db $31,$10,$49,$2D,$10,$49,$2D,$10   ;80ECC3|        |      ;
                       db $49,$2D,$10,$FE,$FF,$C2,$EC,$80   ;80ECCB|        |      ;
                       db $49,$2D,$10,$49,$2D,$10,$6A,$31   ;80ECD3|        |      ;
                       db $10,$49,$2D,$10,$FE,$FF,$C2,$EC   ;80ECDB|        |      ;
                       db $80,$9B,$77,$10,$77,$73,$10,$77   ;80ECE3|        |      ;
                       db $73,$10,$77,$73,$10,$FE,$FF,$E4   ;80ECEB|        |      ;
                       db $EC,$80,$77,$73,$10,$77,$73,$10   ;80ECF3|        |      ;
                       db $9B,$77,$10,$77,$73,$10,$FE,$FF   ;80ECFB|        |      ;
                       db $F5,$EC,$80,$59,$6F,$10,$37,$6B   ;80ED03|        |      ;
                       db $10,$37,$6B,$10,$37,$6B,$10,$FE   ;80ED0B|        |      ;
                       db $FF,$06,$ED,$80,$37,$6B,$10,$37   ;80ED13|        |      ;
                       db $6B,$10,$59,$6F,$10,$37,$6B,$10   ;80ED1B|        |      ;
                       db $FE,$FF,$17,$ED,$80,$B5,$5A,$10   ;80ED23|        |      ;
                       db $73,$52,$10,$73,$52,$10,$73,$52   ;80ED2B|        |      ;
                       db $10,$FE,$FF,$28,$ED,$80,$73,$52   ;80ED33|        |      ;
                       db $10,$73,$52,$10,$B5,$5A,$10,$73   ;80ED3B|        |      ;
                       db $52,$10,$FE,$FF,$39,$ED,$80,$EE   ;80ED43|        |      ;
                       db $4D,$10,$CE,$45,$10,$CE,$45,$10   ;80ED4B|        |      ;
                       db $CE,$45,$10,$FE,$FF,$4A,$ED,$80   ;80ED53|        |      ;
                       db $CE,$45,$10,$CE,$45,$10,$EE,$4D   ;80ED5B|        |      ;
                       db $10,$CE,$45,$10,$FE,$FF,$5B,$ED   ;80ED63|        |      ;
                       db $80,$85,$51,$0C,$E8,$61,$0C,$4C   ;80ED6B|        |      ;
                       db $6E,$0C,$0C,$7F,$0C,$4C,$6E,$0C   ;80ED73|        |      ;
                       db $E8,$61,$0C,$FE,$FF,$6C,$ED,$80   ;80ED7B|        |      ;
                       db $E7,$69,$0C,$88,$79,$0C,$E7,$69   ;80ED83|        |      ;
                       db $0C,$67,$61,$0C,$E7,$69,$0C,$88   ;80ED8B|        |      ;
                       db $79,$0C,$FE,$FF,$83,$ED,$80,$2C   ;80ED93|        |      ;
                       db $7E,$0F,$97,$7F,$0F,$53,$7F,$0F   ;80ED9B|        |      ;
                       db $E7,$7E,$0F,$FE,$FF,$9A,$ED,$80   ;80EDA3|        |      ;
                       db $EF,$7E,$0F,$2C,$7E,$0F,$97,$7F   ;80EDAB|        |      ;
                       db $0F,$53,$7F,$0F,$FE,$FF,$AB,$ED   ;80EDB3|        |      ;
                       db $80,$53,$7F,$0F,$EF,$7E,$0F,$2C   ;80EDBB|        |      ;
                       db $7E,$0F,$97,$7F,$0F,$FE,$FF,$BC   ;80EDC3|        |      ;
                       db $ED,$80,$97,$7F,$0F,$53,$7F,$0F   ;80EDCB|        |      ;
                       db $E7,$7E,$0F,$2C,$7E,$0F,$FE,$FF   ;80EDD3|        |      ;
                       db $CD,$ED,$80,$70,$00,$0F,$5F,$0E   ;80EDDB|        |      ;
                       db $0F,$FF,$03,$0F,$FE,$FF,$DE,$ED   ;80EDE3|        |      ;
                       db $80,$5F,$0E,$0F,$70,$00,$0F,$FF   ;80EDEB|        |      ;
                       db $03,$0F,$FE,$FF,$EC,$ED,$80,$FF   ;80EDF3|        |      ;
                       db $03,$0F,$5F,$0E,$0F,$70,$00,$0F   ;80EDFB|        |      ;
                       db $FE,$FF,$FA,$ED,$80,$0C,$00,$08   ;80EE03|        |      ;
                       db $0A,$00,$08,$09,$00,$08,$FE,$FF   ;80EE0B|        |      ;
                       db $08,$EE,$80,$0A,$00,$08,$D8,$00   ;80EE13|        |      ;
                       db $08,$7E,$02,$08,$FE,$FF,$16,$EE   ;80EE1B|        |      ;
                       db $80,$7F,$01,$08,$9F,$02,$08,$D2   ;80EE23|        |      ;
                       db $00,$08,$FE,$FF,$24,$EE,$80,$1F   ;80EE2B|        |      ;
                       db $03,$08,$5F,$03,$08,$FF,$03,$08   ;80EE33|        |      ;
                       db $FE,$FF,$32,$EE,$80,$79,$22,$10   ;80EE3B|        |      ;
                       db $9B,$22,$10,$DC,$22,$10,$FE,$FF   ;80EE43|        |      ;
                       db $40,$EE,$80,$54,$08,$10,$DE,$08   ;80EE4B|        |      ;
                       db $10,$DC,$08,$10,$FE,$FF,$4E,$EE   ;80EE53|        |      ;
                       db $80,$9D,$08,$10,$DE,$08,$10,$1F   ;80EE5B|        |      ;
                       db $09,$10,$FE,$FF,$5C,$EE,$80,$DF   ;80EE63|        |      ;
                       db $08,$10,$DF,$08,$10,$1F,$0A,$10   ;80EE6B|        |      ;
                       db $FE,$FF,$6A,$EE,$80,$DF,$08,$10   ;80EE73|        |      ;
                       db $3F,$0A,$10,$9F,$0A,$10,$FE,$FF   ;80EE7B|        |      ;
                       db $78,$EE,$80,$9F,$02,$10,$9F,$02   ;80EE83|        |      ;
                       db $10,$1F,$03,$10,$FE,$FF,$86,$EE   ;80EE8B|        |      ;
                       db $80,$5F,$03,$10,$DF,$03,$10,$FF   ;80EE93|        |      ;
                       db $03,$10,$FE,$FF,$94,$EE,$80,$3C   ;80EE9B|        |      ;
                       db $0A,$0C,$DB,$00,$0C,$DF,$00,$0C   ;80EEA3|        |      ;
                       db $DF,$00,$0C,$FE,$FF,$A2,$EE,$80   ;80EEAB|        |      ;
                       db $B3,$09,$0C,$FF,$11,$0C,$5F,$0A   ;80EEB3|        |      ;
                       db $0C,$5F,$12,$0C,$FE,$FF,$B3,$EE   ;80EEBB|        |      ;
                       db $80,$92,$09,$0C,$15,$0A,$0C,$3A   ;80EEC3|        |      ;
                       db $02,$0C,$3F,$13,$0C,$FE,$FF,$C4   ;80EECB|        |      ;
                       db $EE,$80,$98,$2A,$10,$3D,$43,$10   ;80EED3|        |      ;
                       db $98,$2A,$10,$7F,$4F,$10,$5F,$4F   ;80EEDB|        |      ;
                       db $10,$3D,$43,$10,$FE,$FF,$D5,$EE   ;80EEE3|        |      ;
                       db $80,$FA,$42,$10,$98,$2A,$10,$FA   ;80EEEB|        |      ;
                       db $42,$10,$DB,$2A,$10,$1C,$37,$10   ;80EEF3|        |      ;
                       db $98,$2A,$10,$DB,$2A,$10,$FE,$FF   ;80EEFB|        |      ;
                       db $EC,$EE,$80,$49,$00,$08,$4C,$00   ;80EF03|        |      ;
                       db $08,$FE,$FF,$06,$EF,$80,$37,$00   ;80EF0B|        |      ;
                       db $08,$3D,$01,$08,$FE,$FF,$11,$EF   ;80EF13|        |      ;
                       db $80,$5F,$02,$08,$DF,$02,$08,$FE   ;80EF1B|        |      ;
                       db $FF,$1C,$EF,$80                   ;80EF23|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF27|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF2F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF37|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF3F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF47|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF4F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF57|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF5F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF67|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF6F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF77|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF7F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF87|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF8F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF97|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EF9F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFA7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFAF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFB7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFBF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFC7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFCF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFD7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFDF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFE7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFEF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFF7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80EFFF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F007|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F00F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F017|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F01F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F027|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F02F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F037|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F03F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F047|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F04F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F057|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F05F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F067|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F06F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F077|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F07F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F087|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F08F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F097|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F09F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0A7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0AF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0B7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0BF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0C7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0CF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0D7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0DF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0E7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0EF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0F7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F0FF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F107|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F10F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F117|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F11F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F127|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F12F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F137|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F13F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F147|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F14F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F157|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F15F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F167|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F16F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F177|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F17F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F187|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F18F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F197|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F19F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1A7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1AF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1B7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1BF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1C7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1CF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1D7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1DF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1E7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1EF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1F7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F1FF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F207|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F20F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F217|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F21F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F227|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F22F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F237|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F23F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F247|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F24F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F257|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F25F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F267|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F26F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F277|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F27F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F287|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F28F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F297|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F29F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2A7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2AF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2B7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2BF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2C7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2CF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2D7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2DF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2E7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2EF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2F7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F2FF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F307|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F30F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F317|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F31F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F327|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F32F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F337|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F33F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F347|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F34F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F357|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F35F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F367|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F36F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F377|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F37F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F387|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F38F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F397|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F39F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3A7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3AF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3B7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3BF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3C7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3CF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3D7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3DF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3E7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3EF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3F7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F3FF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F407|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F40F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F417|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F41F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F427|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F42F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F437|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F43F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F447|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F44F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F457|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F45F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F467|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F46F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F477|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F47F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F487|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F48F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F497|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F49F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4A7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4AF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4B7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4BF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4C7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4CF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4D7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4DF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4E7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4EF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4F7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F4FF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F507|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F50F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F517|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F51F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F527|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F52F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F537|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F53F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F547|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F54F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F557|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F55F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F567|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F56F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F577|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F57F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F587|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F58F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F597|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F59F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5A7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5AF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5B7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5BF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5C7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5CF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5D7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5DF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5E7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5EF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5F7|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F5FF|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F607|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F60F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F617|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F61F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F627|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F62F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F637|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F63F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F647|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F64F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F657|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F65F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F667|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F66F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F677|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F67F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F687|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F68F|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F697|        |      ;
                       db $00,$00,$00,$00,$00,$00,$00,$00   ;80F69F|        |      ;
                       ...
                       db $00,$45,$39,$41,$59,$57,$45,$00   ;80FFAF|        |      ;
                       db $00,$00,$00                       ;80FFB7|        |      ;
                       BRK #$00                             ;80FFBA|0000    |      ;
                       BRK #$00                             ;80FFBC|0000    |      ;
                       BRK #$00                             ;80FFBE|0000    |      ;
                       ...
                       db $4F,$4E,$20,$20,$20,$20,$20,$20   ;80FFCA|        |      ;
                       db $20,$20,$20,$30,$02,$0B,$03,$01   ;80FFD2|        |      ;
                       db $33,$00                           ;80FFDA|        |      ;
                                                            ;      |        |      ;
          RomChecksum:
                       dd $7E3C81C3                         ;80FFDC|        |      ;
