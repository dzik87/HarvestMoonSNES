...
fCore_GameStart:
    ...
    REP #$20                                                   ;808062|C220    |      ;
    LDA.L nEventFlags+4                                        ;808064|AF681F7F|7F1F68;
    ...
    REP #$30                                                   ;80807A|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;80807C|A5D2    |0000D2;
    ORA.W #$0004                                               ;80807E|090400  |      ;
    STA.B nPlayerStateFlags                                    ;808081|85D2    |0000D2;
...
fCore_SetBoughtCowName:
    ...
    LDA.L nDailyFlags                                          ;8081B7|AF5A1F7F|7F1F5A;
    AND.W #$FFFD                                               ;8081BB|29FDFF  |      ;
    STA.L nDailyFlags                                          ;8081BE|8F5A1F7F|7F1F5A;
...
fCore_SetBornCowName:
    ...
    REP #$20                                                   ;80821F|C220    |      ;
    LDA.L nEventFlags                                          ;808221|AF641F7F|7F1F64;
    AND.W #$FFFB                                               ;808225|29FBFF  |      ;
    STA.L nEventFlags                                          ;808228|8F641F7F|7F1F64;
    REP #$20                                                   ;80822C|C220    |      ;
    LDA.L nEventFlags                                          ;80822E|AF641F7F|7F1F64;
    AND.W #$FFF7                                               ;808232|29F7FF  |      ;
    STA.L nEventFlags                                          ;808235|8F641F7F|7F1F64;
    REP #$20                                                   ;808239|C220    |      ;
...
fCore_ScreenFadein:
 ...
 -- LDA.B $25                                                  ;8087DE|A525    |000025;
  ...
  + REP #$20                                                   ;8087FC|C220    |      ;
    LDA.L nDailyFlags                                          ;8087FE|AF5A1F7F|7F1F5A;
    ORA.W #$8000                                               ;808802|090080  |      ;
    STA.L nDailyFlags                                          ;808805|8F5A1F7F|7F1F5A;
    RTL                                                        ;808809|6B      |      ;
...
fCore_ScreenFadeout:
 ...
 -- LDA.B $25                                                  ;80881A|A525    |000025;
  ...
  + REP #$20                                                   ;808838|C220    |      ;
    LDA.L nDailyFlags                                          ;80883A|AF5A1F7F|7F1F5A;
    AND.W #$7FFF                                               ;80883E|29FF7F  |      ;
    STA.L nDailyFlags                                          ;808841|8F5A1F7F|7F1F5A;
    RTL                                                        ;808845|6B      |      ;
...
.label4:
    ...
    LSR A                                                      ;8090D4|4A      |      ;
    LSR A                                                      ;8090D5|4A      |      ;
    STA.B n16TempVar3                                          ;8090D6|8582    |000082;
    ...
    LSR A                                                      ;8090E5|4A      |      ;
    LSR A                                                      ;8090E6|4A      |      ;
    CMP.B n16TempVar3                                          ;8090E7|C582    |000082;
    BEQ .label5                                                ;8090E9|F00E    |8090F9;
    BCS .inc82                                                 ;8090EB|B004    |8090F1;
    DEC.B n16TempVar3                                          ;8090ED|C682    |000082;
    BRA .store01to92ex2                                        ;8090EF|8002    |8090F3;
 
 
.inc82:
    INC.B n16TempVar3                                          ;8090F1|E682    |000082;
...
.label5:
    ...
    ASL.B n16TempVar3                                          ;809105|0682    |000082;
    ASL.B n16TempVar3                                          ;809107|0682    |000082;
    ASL.B n16TempVar3                                          ;809109|0682    |000082;
    ASL.B n16TempVar3                                          ;80910B|0682    |000082;
    ASL.B n16TempVar3                                          ;80910D|0682    |000082;
    ASL.B n16TempVar3                                          ;80910F|0682    |000082;
    ASL.B n16TempVar3                                          ;809111|0682    |000082;
    ASL.B n16TempVar3                                          ;809113|0682    |000082;
    ASL.B n16TempVar3                                          ;809115|0682    |000082;
    ASL.B n16TempVar3                                          ;809117|0682    |000082;
    LDA.B n16TempVar1                                          ;809119|A57E    |00007E;
    ORA.B n16TempVar2                                          ;80911B|0580    |000080;
    ORA.B n16TempVar3                                          ;80911D|0582    |000082;
...
fPalette_Unknown80916F:
    ...
    STA.B n16TempVar3                                          ;809171|8582    |000082;
...
.label1:
    REP #$20                                                   ;809194|C220    |      ;
    LDA.B n16TempVar3                                          ;809196|A582    |000082;
...
fPalette_ModifyPalette:
    ...
    STA.B n16TempVar3                                          ;80919F|8582    |000082;
...
.label1:
    REP #$20                                                   ;8091C6|C220    |      ;
    LDA.B n16TempVar3                                          ;8091C8|A582    |000082;
...
fPalette_PrepareSpritePalette:
    REP #$30                                                   ;809329|C230    |      ;
    LDA.L nDailyFlags+4                                        ;80932B|AF5E1F7F|7F1F5E;
    AND.W #$0080                                               ;80932F|298000  |      ;
    BNE .notAnd0080                                            ;809332|D03A    |80936E;
    LDA.L nDailyFlags+4                                        ;809334|AF5E1F7F|7F1F5E;
    AND.W #$0100                                               ;809338|290001  |      ;
    BNE .notAnd0100                                            ;80933B|D043    |809380;
    LDA.L nDailyFlags+4                                        ;80933D|AF5E1F7F|7F1F5E;
...
.getSeasonId:
    ...
    REP #$20                                                   ;8093D9|C220    |      ;
    STA.B n16TempVar3                                          ;8093DB|8582    |000082;
...
.label3:
    ...
    STA.B n16TempVar3                                          ;8093EF|8582    |000082;
 
.loadData:
    SEP #$20                                                   ;8093F1|E220    |      ;
    LDA.B #$00                                                 ;8093F3|A900    |      ;
    XBA                                                        ;8093F5|EB      |      ;
    LDA.B n16TempVar3                                          ;8093F6|A582    |000082;
    CLC                                                        ;8093F8|18      |      ;
...
fAudioEngine_MapChangeHandler:
  ...
  + LDA.L nDailyFlags+4                                        ;80967E|AF5E1F7F|7F1F5E;
    AND.W #$8000                                               ;809682|290080  |      ;
    BNE .label2                                                ;809685|D024    |8096AB;
    LDA.L nDailyFlags+6                                        ;809687|AF601F7F|7F1F60;
    AND.W #$0100                                               ;80968B|290001  |      ;
    BNE .label1                                                ;80968E|D00C    |80969C;
    LDA.L nDailyFlags+6                                        ;809690|AF601F7F|7F1F60;
...
.label2:
    REP #$20                                                   ;8096AB|C220    |      ;
    LDA.L nDailyFlags+6                                        ;8096AD|AF601F7F|7F1F60;
...
fUnknown_8096D3:
    ...
    LDA.L nDailyFlags+2                                        ;8096DE|AF5C1F7F|7F1F5C;
    AND.W #$FFF0                                               ;8096E2|29F0FF  |      ;
    STA.L nDailyFlags+2                                        ;8096E5|8F5C1F7F|7F1F5C;
    REP #$30                                                   ;8096E9|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;8096EB|A5D2    |0000D2;
    ORA.W #$4000                                               ;8096ED|090040  |      ;
    STA.B nPlayerStateFlags                                    ;8096F0|85D2    |0000D2;
    REP #$20                                                   ;8096F2|C220    |      ;
...
fUnknown_80972C:
    ...
    REP #$20                                                   ;809748|C220    |      ;
    LDA.L nDailyFlags+2                                        ;80974A|AF5C1F7F|7F1F5C;
...
.label3:
    REP #$20                                                   ;809775|C220    |      ;
    LDA.L nDailyFlags+2                                        ;809777|AF5C1F7F|7F1F5C;
...
.label9:
    ...
    REP #$20                                                   ;809917|C220    |      ;
    LDA.L nDailyFlags                                          ;809919|AF5A1F7F|7F1F5A;
    AND.W #$FDFF                                               ;80991D|29FFFD  |      ;
    STA.L nDailyFlags                                          ;809920|8F5A1F7F|7F1F5A;
    ...
    AND.B nPlayerStateFlags                                    ;809948|25D2    |0000D2;
    STA.B nPlayerStateFlags                                    ;80994A|85D2    |0000D2;
    REP #$20                                                   ;80994C|C220    |      ;
    ...
    AND.B nPlayerStateFlags                                    ;80995C|25D2    |0000D2;
    STA.B nPlayerStateFlags                                    ;80995E|85D2    |0000D2;
    SEP #$20                                                   ;809960|E220    |      ;
...
.label11:
    ...
    AND.B nPlayerStateFlags                                    ;8099C9|25D2    |0000D2;
    STA.B nPlayerStateFlags                                    ;8099CB|85D2    |0000D2;
 
.label12:
    JSL.L fUnknown_81CFA0                                      ;8099CD|22A0CF81|81CFA0;
    JSL.L fUnknownSubrutineHandler_81BFB7                      ;8099D1|22B7BF81|81BFB7;
    REP #$30                                                   ;8099D5|C230    |      ;
    LDA.L nDailyFlags+4                                        ;8099D7|AF5E1F7F|7F1F5E;
...
.label13:
    ...
    JSL.L fToolUsed_SoundUnknown828FF3                         ;8099F7|22F38F82|828FF3;
    SEP #$20                                                   ;8099FB|E220    |      ;
...
.label4:
    REP #$30                                                   ;809A8C|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;809A8E|A5D2    |0000D2;
...
.label5:
    REP #$20                                                   ;809A98|C220    |      ;
    LDA.L nDailyFlags+6                                        ;809A9A|AF601F7F|7F1F60;
...
.label6:
    REP #$20                                                   ;809AA6|C220    |      ;
    LDA.L nEventFlags+8                                        ;809AA8|AF6C1F7F|7F1F6C;
...
.label7:
    ...
    REP #$30                                                   ;809ADA|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;809ADC|A5D2    |0000D2;
    ORA.W #$0080                                               ;809ADE|098000  |      ;
    STA.B nPlayerStateFlags                                    ;809AE1|85D2    |0000D2;
    SEP #$20                                                   ;809AE3|E220    |      ;
...
.label21:
    ...
    AND.B nPlayerStateFlags                                    ;809C1C|25D2    |0000D2;
    STA.B nPlayerStateFlags                                    ;809C1E|85D2    |0000D2;
    REP #$20                                                   ;809C20|C220    |      ;
...
.label42:
    REP #$20                                                   ;809D79|C220    |      ;
    LDA.L nDailyFlags                                          ;809D7B|AF5A1F7F|7F1F5A;
...
.label43:
    REP #$30                                                   ;809D87|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;809D89|A5D2    |0000D2;
...
.label44:
    REP #$30                                                   ;809D93|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;809D95|A5D2    |0000D2;
...
.label45:
    REP #$30                                                   ;809D9F|C230    |      ;
    LDA.B nPlayerStateFlags                                    ;809DA1|A5D2    |0000D2;
...
.label55:
    REP #$20                                                   ;809E15|C220    |      ;
    LDA.L nDailyFlags+2                                        ;809E17|AF5C1F7F|7F1F5C;
...
.label56:
    LDA.L nDailyFlags+2                                        ;809E23|AF5C1F7F|7F1F5C;
    ORA.W #$2000                                               ;809E27|090020  |      ;
    STA.L nDailyFlags+2                                        ;809E2A|8F5C1F7F|7F1F5C;
    REP #$30                                                   ;809E2E|C230    |      ;
...
.label58:
    REP #$20                                                   ;809E56|C220    |      ;
    LDA.L nDailyFlags+2                                        ;809E58|AF5C1F7F|7F1F5C;
    AND.W #$4000                                               ;809E5C|290040  |      ;
    BNE .return2                                               ;809E5F|D05A    |809EBB;
    LDA.L nDailyFlags+2                                        ;809E61|AF5C1F7F|7F1F5C;
    ORA.W #$4000                                               ;809E65|090040  |      ;
    STA.L nDailyFlags+2                                        ;809E68|8F5C1F7F|7F1F5C;
    REP #$30                                                   ;809E6C|C230    |      ;
...
.label60:
    REP #$20                                                   ;809E94|C220    |      ;
    LDA.L nDailyFlags+2                                        ;809E96|AF5C1F7F|7F1F5C;
    AND.W #$8000                                               ;809E9A|290080  |      ;
    BNE .return2                                               ;809E9D|D01C    |809EBB;
    LDA.L nDailyFlags+2                                        ;809E9F|AF5C1F7F|7F1F5C;
    ORA.W #$8000                                               ;809EA3|090080  |      ;
    STA.L nDailyFlags+2                                        ;809EA6|8F5C1F7F|7F1F5C;
    REP #$30                                                   ;809EAA|C230    |      ;
...
.label2:
    ...
    STA.B n16TempVar3                                          ;80A261|8582    |000082;
...
.label2:
    ...
    STA.B n16TempVar3                                          ;80A3DA|8582    |000082;
...
.label2:
    ...
    STA.B n16TempVar3                                          ;80A567|8582    |000082;
...
.label3:
    ...
    LDA.B n16TempVar3                                          ;80A587|A582    |000082;
    CLC                                                        ;80A589|18      |      ;
...
.label2:
    ...
    STA.B n16TempVar3                                          ;80A6FE|8582    |000082;
...
.label3:
    ...
    LDA.B n16TempVar3                                          ;80A71E|A582    |000082;
    CLC                                                        ;80A720|18      |      ;
...
fTileMap_MapChangeHandler:
    ...
    REP #$20                                                   ;80A7F8|C220    |      ;
    LDA.L nDailyFlags+2                                        ;80A7FA|AF5C1F7F|7F1F5C;
...
.label10:
    ...
    REP #$30                                                   ;80A915|C230    |      ;
    LDA.L nDailyFlags+4                                        ;80A917|AF5E1F7F|7F1F5E;
...
RomChecksum:
    dw $81C3,$7E3C                                             ;80FFDC|        |      ;
    dw fCore_InterruptReturn                                   ;80FFE0|        |808698;
    dw fCore_InterruptReturn                                   ;80FFE2|        |808698;
 
Native_COP:
    dw fCore_InterruptReturn                                   ;80FFE4|        |808698;
 
Native_BRK:
    dw fCore_InterruptReturn                                   ;80FFE6|        |808698;
    dw fCore_InterruptReturn                                   ;80FFE8|        |808698;
 
Native_NMI:
    dw fCore_Interrupt80867B                                   ;80FFEA|        |80867B;
    dw fCore_InterruptReturn                                   ;80FFEC|        |808698;
    dw fCore_Interrupt808699                                   ;80FFEE|        |808699;
    dw fCore_InterruptReturn                                   ;80FFF0|        |808698;
    dw fCore_InterruptReturn                                   ;80FFF2|        |808698;
 
Native_IRQ:
    dw fCore_InterruptReturn                                   ;80FFF4|        |808698;
    dw fCore_InterruptReturn                                   ;80FFF6|        |808698;
    dw fCore_InterruptReturn                                   ;80FFF8|        |808698;
    dw fCore_InterruptReturn                                   ;80FFFA|        |808698;
    dw fCore_Interrupt808428                                   ;80FFFC|        |808428;
 
Emulation_RESET:
    dw fCore_InterruptReturn                                   ;80FFFE|        |808698;
